export const ELEVENLABS_SETTINGS_SECTION = Object.freeze({
  ...
  fields: Object.freeze([
    ...
    Object.freeze({
      kind: 'nullable_boolean' as const,
      path: 'tts.voiceSettings.useSpeakerBoost',
      titleKey: 'settingsVoice.byo.speakerBoostTitle',
      subtitleKey: 'settingsVoice.byo.speakerBoostSubtitle',
    }),
    ...
    Object.freeze({ kind: 'number' as const, path: 'tts.voiceSettings.style', min: 0, max: 1,
      titleKey: 'settingsVoice.byo.realtime.voiceSettings.style.title', subtitleKey: 'settingsVoice.byo.realtime.voiceSettings.style.subtitle',
      promptTitleKey: 'settingsVoice.byo.realtime.voiceSettings.style.promptTitle', promptBodyKey: 'settingsVoice.byo.realtime.voiceSettings.style.promptBody' }),
    ...
    Object.freeze({
      kind: 'autoprovision' as const,
      path: 'byo.agentId',
      ttsPath: 'tts',
      titleKey: 'settingsVoice.byo.autoprovCreate',
      subtitleKey: 'settingsVoice.byo.autoprovCreateSubtitle',
    }),
  ]),
});
