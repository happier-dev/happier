 ...
 *
 * This is the page a person actually uses to put Azure DevOps into PRs & Issues. It
...
const SOURCE_DISPLAY_NAME = AZURE_DEVOPS_TRIAGE_DESCRIPTOR.displayName;
...
function AzureDevOpsTriageSettingsSurface(): React.ReactElement {
  const listInstances = React.useMemo(
    () => ({ pluginId: AZURE_DEVOPS_PLUGIN_ID, localId: AZURE_DEVOPS_TRIAGE_ACTION_IDS.listInstances }),
    [],
  );
...
export const renderSurface = defineUiSurface(AzureDevOpsTriageSettingsSurface);
