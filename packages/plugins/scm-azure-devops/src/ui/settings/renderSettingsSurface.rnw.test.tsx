...
/**
 * What Azure DevOps contributes to the shared PRs & Issues settings page.
 *
...
async function executeAction(
  ...
  if (ref.localId === AZURE_DEVOPS_TRIAGE_ACTION_IDS.listInstances) {
...
describe('the mounted Azure DevOps PRs & Issues settings page', () => {
  ...
  it('names this source the way its own descriptor spells it', async () => {
    ...
    const heading = `${AZURE_DEVOPS_TRIAGE_DESCRIPTOR.displayName} in PRs & Issues`;
