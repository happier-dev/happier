 ...
 *
 * This is the page a person actually uses to put GitLab into PRs & Issues. It
...
const SOURCE_DISPLAY_NAME = GITLAB_TRIAGE_SOURCE_DESCRIPTOR_V1.displayName;
...
function GitlabTriageSettingsSurface(): React.ReactElement {
  const listInstances = React.useMemo(
    () => ({ pluginId: GITLAB_PLUGIN_ID, localId: GITLAB_TRIAGE_ACTION_IDS.listInstances }),
    [],
  );
...
export const renderSurface = defineUiSurface(GitlabTriageSettingsSurface);
