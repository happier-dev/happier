...
/**
 * What Bitbucket Cloud contributes to the shared PRs & Issues settings page.
 *
...
async function executeAction(
  ...
  if (ref.localId === BITBUCKET_TRIAGE_ACTION_IDS.listInstances) {
...
describe('the mounted Bitbucket Cloud PRs & Issues settings page', () => {
  ...
  it('names this source the way its own descriptor spells it', async () => {
    ...
    const heading = `${BITBUCKET_TRIAGE_DESCRIPTOR.displayName} in PRs & Issues`;
