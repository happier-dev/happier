 ...
 *
 * This is the page a person actually uses to put Bitbucket Cloud into PRs & Issues. It
...
const SOURCE_DISPLAY_NAME = BITBUCKET_TRIAGE_DESCRIPTOR.displayName;
...
function BitbucketTriageSettingsSurface(): React.ReactElement {
  const listInstances = React.useMemo(
    () => ({ pluginId: BITBUCKET_PLUGIN_ID, localId: BITBUCKET_TRIAGE_ACTION_IDS.listInstances }),
    [],
  );
...
export const renderSurface = defineUiSurface(BitbucketTriageSettingsSurface);
