...
export type OpenCodeProviderActivitySource = 'history' | 'live' | 'session-next';
...
export type OpenCodeProviderActivityTracker = ReturnType<typeof createOpenCodeProviderActivityTracker>;
