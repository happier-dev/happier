 ...
 *
 * This is the page a person actually uses to put Sentry into PRs & Issues. It
...
const SOURCE_DISPLAY_NAME = SENTRY_SOURCE_DISPLAY_NAME;
...
function SentryTriageSettingsSurface(): React.ReactElement {
  const listInstances = React.useMemo(
    () => ({ pluginId: SENTRY_PLUGIN_ID, localId: SENTRY_ACTION_IDS.listInstances }),
    [],
  );
...
export const renderSurface = defineUiSurface(SentryTriageSettingsSurface);
