...
function createManagedLibrary() {
  return {
    entry: "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/scm-github/src/ui/renderSurface.tsx",
    formats: ['es'],
    fileName: () => 'entry.mjs',
  };
}
...
const managedConfig = {
  root: "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/scm-github/.happier-plugin-ui-build-KnbziR",
  plugins: [react({ jsxRuntime: 'classic' }), ...createReactNativeWebVitePlugins()],
  resolve: {
    alias: [{ find: 'react-native', replacement: 'react-native-web' }],
  },
  build: {
    outDir: "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/scm-github/node_modules/.cache/happier-plugin-ui/react-native-web/github-detail-native",
    minify: false,
    sourcemap: false,
    emptyOutDir: true,
    lib: {
...
function applyManagedReactNativeWebBuildOptions(build) {
  build.outDir = "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/scm-github/node_modules/.cache/happier-plugin-ui/react-native-web/github-detail-native";
...
const managedConfigGuard = {
  ...
  config: {
    order: 'post',
    handler(config) {
      config.root = "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/scm-github/.happier-plugin-ui-build-KnbziR";
      config.build ??= {};
