...
const projectRoot = "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/scm-github";
const managedOperationRoot = "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/scm-github/.happier-plugin-ui-build-KnbziR";
const managedOperationSourceRoot = '.happier-plugin-ui-build';
const expectedPlatform = "android";
const moduleIdentity = Object.freeze({"containerName":"happier_github_github_detail_native","modulePath":"./renderSurface","exportName":"renderSurface"});
...
export default function config(env = {}) {
  ...
  return {
    ...
    output: {
      ...
      path: "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/scm-github/node_modules/.cache/happier-plugin-ui/react-native/github-detail-native/android",
      publicPath: 'noop:///',
