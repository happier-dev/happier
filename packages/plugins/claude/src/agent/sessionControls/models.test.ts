...
import { resolveClaudeSessionModelsState } from './models.js';
...
describe('resolveClaudeSessionModelsState', () => {
    ...
    it('publishes a dynamic session model list with Thinking options and context windows when --effort is supported', async () => {
        const res = await resolveClaudeSessionModelsState({
            cwd: '/',
            timeoutMs: 250,
            currentModelId: 'claude-sonnet-4-6',
