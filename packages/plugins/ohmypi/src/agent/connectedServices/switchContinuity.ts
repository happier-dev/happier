...
const SUPPORTED_OH_MY_PI_CONNECTED_SERVICE_IDS = new Set([
  'openai-codex',
  'openai',
  'claude-subscription',
  'anthropic',
...
function supportsService(serviceId: string): boolean {
  return SUPPORTED_OH_MY_PI_CONNECTED_SERVICE_IDS.has(serviceId);
}
...
function restartRematerialize(): ConnectedServiceSwitchContinuityResult {
  return {
