 ...
 *
 * This is the page a person actually uses to put PostHog into PRs & Issues. It
...
const SOURCE_DISPLAY_NAME = POSTHOG_SOURCE_DISPLAY_NAME;
...
function PosthogTriageSettingsSurface(): React.ReactElement {
...
export const renderSurface = defineUiSurface(PosthogTriageSettingsSurface);
