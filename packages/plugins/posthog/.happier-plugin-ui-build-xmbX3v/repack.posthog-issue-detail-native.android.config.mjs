...
export default function config(env = {}) {
  ...
  return {
    ...
    output: {
      ...
      path: "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/posthog/node_modules/.cache/happier-plugin-ui/react-native/posthog-issue-detail-native/android",
      publicPath: 'noop:///',
