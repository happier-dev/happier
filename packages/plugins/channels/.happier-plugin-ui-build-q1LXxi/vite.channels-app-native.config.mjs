...
const managedConfig = {
  root: "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/channels/.happier-plugin-ui-build-q1LXxi",
...
const managedConfigGuard = {
  ...
  config: {
    order: 'post',
    handler(config) {
      config.root = "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/channels/.happier-plugin-ui-build-q1LXxi";
      config.build ??= {};
