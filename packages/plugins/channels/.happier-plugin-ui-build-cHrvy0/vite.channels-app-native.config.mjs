...
function createManagedLibrary() {
  return {
    entry: "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/channels/src/ui/renderSurface.tsx",
    formats: ['es'],
    fileName: () => 'entry.mjs',
  };
}
...
const managedConfig = {
  root: "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/channels/.happier-plugin-ui-build-cHrvy0",
  plugins: [react({ jsxRuntime: 'classic' }), ...createReactNativeWebVitePlugins()],
  resolve: {
    alias: [{ find: 'react-native', replacement: 'react-native-web' }],
  },
  build: {
    outDir: "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/channels/node_modules/.cache/happier-plugin-ui/react-native-web/channels-app-native",
    minify: false,
    sourcemap: false,
    emptyOutDir: true,
    lib: {
...
function applyManagedReactNativeWebBuildOptions(build) {
  build.outDir = "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/channels/node_modules/.cache/happier-plugin-ui/react-native-web/channels-app-native";
...
const managedConfigGuard = {
  ...
  config: {
    order: 'post',
    handler(config) {
      config.root = "/Users/leeroy/Documents/Development/happier/dev/packages/plugins/channels/.happier-plugin-ui-build-cHrvy0";
      config.build ??= {};
