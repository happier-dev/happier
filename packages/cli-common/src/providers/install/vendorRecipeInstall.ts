...
import { resolveProviderCliCommandForRuntime, type ProviderCliRuntimeDescriptor } from '../resolution.js';
...
function buildVendorRecipePath(runtimeSpec: ProviderCliRuntimeDescriptor, env: NodeJS.ProcessEnv): string {
