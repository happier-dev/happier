# Plugin UI package instructions

- `*.public.ts` files and the package `exports` map own public exports. Do not add public exports through ad hoc barrels or plugin-sdk internals.
