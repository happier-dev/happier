...
describe('mobile installed-app populated relay flow contracts', () => {
  ...
  it('restores populated relay accounts without Expo Dev Client bootstrap', () => {
    ...
    expect(flow).toContain('inputText: ${HAPPIER_E2E_RESTORE_KEY_CHUNK_01}');
    expect(flow).toContain('inputText: ${HAPPIER_E2E_RESTORE_KEY_CHUNK_08}');
