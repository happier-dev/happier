...
export async function writeRuntimeProjectionPluginFixture(params: Readonly<{
    ...
    const manifest: LocalExtensionPackageManifest = {
        ...
        permissions: [
            ...
            },
            {
                ...
                reason: 'Expose a fixture resource in runtime projection tests.',
            },
            {
                capability: 'ui.descriptors',
                reason: 'Expose host-rendered descriptors in runtime projection tests.',
            },
        ],
        targets: {
            daemon: {
    ...
    await writeLocalExtensionPackageFixture({
        ...
        daemonModuleContents: [
            ...
            '        kindVersion: 1,',
            `        id: ${JSON.stringify(settingsDescriptorId)},`,
            '        surface: "settings",',
            ...
            '    api.registerUiDescriptor({',
            '        kindVersion: 1,',
            `        id: ${JSON.stringify(setupDescriptorId)},`,
            '        surface: "setup",',
            '        title: "Plugin Setup",',
            ...
            '    api.registerUiDescriptor({',
            '        kindVersion: 1,',
            `        id: ${JSON.stringify(statusDescriptorId)},`,
            '        surface: "status",',
            ...
            '    api.registerUiDescriptor({',
            '        kindVersion: 1,',
            `        id: ${JSON.stringify(providerSettingsDescriptorId)},`,
            '        surface: "providerSettings",',
            ...
            '    api.registerUiDescriptor({',
            '        kindVersion: 1,',
            `        id: ${JSON.stringify(backendSettingsDescriptorId)},`,
            '        surface: "backendSettings",',
