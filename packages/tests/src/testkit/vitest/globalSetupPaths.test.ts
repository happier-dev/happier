...
describe('resolveVitestGlobalSetupPaths', () => {
  it('keeps core e2e global setup artifacts under the e2e logs dir when provided', () => {
    ...
    expect(paths.lockPath).toBe(resolve('/tmp/happier-e2e', 'vitest-global-setup', 'core-slow', 'cli-dist-build.lock'));
  });
