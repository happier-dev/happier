...
describe('providers harness: fatal agent error extraction', () => {
  it('fails the current provider phase on the first primary turn_failed observation', () => {
    const failure = extractProviderTerminalFailure({
      afterSeq: 10,
      messages: [
        {
          seq: 9,
          value: {
            ...
            content: {
              type: 'acp',
              agentId: 'pi',
              data: { type: 'turn_failed', id: 'historical-turn' },
            },
          },
        },
        {
          ...
          value: {
            ...
            content: {
              type: 'acp',
              agentId: 'pi',
              data: { type: 'message', message: 'recoverable progress' },
            },
          },
        },
        {
          ...
          value: {
            ...
            value: {
              ...
              content: {
                type: 'acp',
                agentId: 'pi',
                data: { type: 'turn_failed', id: 'current-turn' },
              },
            },
          },
        },
    ...
    expect(formatProviderTerminalFailure({
      providerId: 'pi',
      scenarioId: 'pi_read_known_file_smoke',
      failure: failure!,
    })).toBe(
      'Terminal provider failure (pi.pi_read_known_file_smoke): ' +
      'code=provider_turn_failed summary=Provider reported a terminal turn failure',
    );
  });

  it('does not fail early for nonterminal progress, cancellation, or sidechain failure', () => {
    expect(extractProviderTerminalFailure({
      afterSeq: 0,
      messages: [
        {
          seq: 1,
          value: {
            ...
            content: {
              type: 'acp',
              agentId: 'pi',
              data: { type: 'message', message: 'still working' },
            },
          },
        },
        {
          ...
          value: {
            ...
            content: {
              type: 'acp',
              agentId: 'pi',
              data: { type: 'turn_cancelled', id: 'cancelled-turn' },
            },
          },
        },
        {
          ...
          value: {
            ...
            content: {
              type: 'acp',
              agentId: 'pi',
              data: { type: 'turn_failed', id: 'sidechain-turn', sidechainId: 'tool-child' },
            },
          },
        },
      ],
