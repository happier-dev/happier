...
Add these to your main stack env file (`~/.happy/stacks/main/env`) (or `~/.happier-stack/env.local` for global overrides) so you don’t have to prefix every command:
...
HAPPIER_STACK_IOS_APP_NAME="Happy Local"
```
...
- a stack pinned to that worktree (`hapsta stack wt <stack> -- use happy ...`)
