...
export const pl: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        expVoiceAuthFlowSubtitle: 'Use authenticated voice token flow (paywall-aware)',
            ...
            expCodexAcpSubtitle: 'Użyj Codex przez ACP (codex-acp) zamiast MCP (eksperymentalne)',
    ...
    newSession: {
        ...
        resume: {
            ...
            cannotApplyBody: 'Nie można teraz zastosować tego ID wznowienia. Happy uruchomi zamiast tego nową sesję.',
        },
        codexResumeBanner: {
            title: 'Codex resume',
    ...
    session: {
        ...
        resumeSupportNoteChecking: 'Uwaga: Happy wciąż sprawdza, czy ta maszyna może wznowić sesję dostawcy.',
        resumeSupportNoteUnverified: 'Uwaga: Happy nie mógł zweryfikować obsługi wznawiania na tej maszynie.',
