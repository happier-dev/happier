...
export const ru: TranslationStructure = {
    ...
    newSession: {
        ...
        resume: {
            ...
            cannotApplyBody: 'Этот ID возобновления сейчас нельзя применить. Happy вместо этого начнёт новую сессию.',
        },
        codexResumeBanner: {
            title: 'Codex resume',
    ...
    session: {
        ...
        resumeSupportNoteChecking: 'Примечание: Happy всё ещё проверяет, может ли эта машина возобновить сессию провайдера.',
        resumeSupportNoteUnverified: 'Примечание: Happy не смог проверить поддержку возобновления на этой машине.',
