...
export const ca: TranslationStructure = {
    ...
    newSession: {
        ...
        resume: {
            ...
            cannotApplyBody: 'Aquest ID de represa no es pot aplicar ara mateix. Happy iniciarà una sessió nova.',
        },
        codexResumeBanner: {
            title: 'Codex resume',
    ...
    session: {
        ...
        resumeSupportNoteChecking: 'Nota: Happy encara està comprovant si aquesta màquina pot reprendre la sessió del proveïdor.',
        resumeSupportNoteUnverified: 'Nota: Happy no ha pogut verificar la compatibilitat de represa en aquesta màquina.',
