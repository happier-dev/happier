...
export const pt: TranslationStructure = {
    ...
    newSession: {
        ...
        resume: {
            ...
            cannotApplyBody: 'Este ID de retomada não pode ser aplicado agora. O Happy iniciará uma nova sessão em vez disso.',
        },
        codexResumeBanner: {
            title: 'Codex resume',
    ...
    session: {
        ...
        resumeSupportNoteChecking: 'Nota: o Happy ainda está verificando se esta máquina pode retomar a sessão do provedor.',
        resumeSupportNoteUnverified: 'Nota: o Happy não conseguiu verificar o suporte de retomada para esta máquina.',
