...
export const it: TranslationStructure = {
    ...
    newSession: {
        ...
        resume: {
            ...
            cannotApplyBody: 'Questo ID di ripresa non può essere applicato ora. Happy avvierà invece una nuova sessione.',
        },
        codexResumeBanner: {
            title: 'Codex resume',
    ...
    session: {
        ...
        resumeSupportNoteChecking: 'Nota: Happy sta ancora verificando se questa macchina può riprendere la sessione del provider.',
        resumeSupportNoteUnverified: 'Nota: Happy non è riuscito a verificare il supporto alla ripresa su questa macchina.',
