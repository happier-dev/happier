...
const featureProtocolFixture = {
    ...
    sources: {
        ...
        'src/v1/provider/declarations.ts': [
            ...
            "import { AgentPermissionIntentV1Schema, SessionAuthoringCheckoutCreationDraftV1Schema, SessionIdSchema, SessionSpawnNewInputV2Schema } from '@happier-dev/plugin-sdk/sessions';",
            ...
            "import type { AgentPermissionIntentV1, SessionAuthoringCheckoutCreationDraftV1, SessionId, SessionSpawnNewInputV2 } from '@happier-dev/plugin-sdk/sessions';",
            ...
            '    checkoutCreationDraftSchema: SessionAuthoringCheckoutCreationDraftV1Schema,',
