...
export type PluginActionContributionV2 = {
    ...
    surfaces: ('plugin' | 'cli' | 'agent' | 'mcp' | 'ui')[];
...
export type PluginActionInputById = {
    ...
    readonly "plugins.permissions.grants.list": {
        limit?: number | undefined;
        capability?: 'network' | 'filesystem.read' | 'filesystem.write' | 'env' | 'network.intercept' | 'process.spawn' | 'reviews.comments.write.direct' | 'credentials.materialize.raw' | undefined;
        targetScope?: {
            kind: 'account';
        } | {
            kind: 'project';
    ...
    readonly "plugins.permissions.grants.request": {
        reason: string;
        capability: 'network' | 'filesystem.read' | 'filesystem.write' | 'env' | 'network.intercept' | 'process.spawn' | 'reviews.comments.write.direct' | 'credentials.materialize.raw';
        targetScope: {
            kind: 'account';
        } | {
            kind: 'project';
...
export type PluginActionResultById = {
    ...
    readonly "automation.conversation.target.verify": {
        ...
        kind: 'notVerified';
        reason: 'notFound' | 'notConversation' | 'templateVersionMismatch' | 'resultDeliveryUnsupported';
    };
    readonly "automation.conversation.admit": {
        kind: 'admitted';
        runId: string;
