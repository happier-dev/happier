...
export const CAPABILITY_MATRIX_DECLARATIONS_V1 = Object.freeze({
  manifestFamilies: Object.freeze({
    ...
    pluginContributionPoints: available('packages/plugin-sdk/examples/action-contract-producer/src/index.ts'),
    targetedPluginContributions: available('packages/plugin-sdk/examples/action-contract-consumer/src/index.ts'),
