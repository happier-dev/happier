 ...
 * repository must resolve in the other. remote-dev owns the same derivation at
 * `packages/protocol/src/sessionWorkState/skillCatalogItemIdentityV1.ts` and asserts this identical table; if the
