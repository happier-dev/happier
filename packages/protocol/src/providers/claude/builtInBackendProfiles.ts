...
export const CLAUDE_BUILT_IN_BACKEND_PROFILES: ReadonlyArray<AIBackendProfile> = [
  ...
  },
  {
    ...
    environmentVariables: [
      ...
      { name: 'ANTHROPIC_SMALL_FAST_MODEL', value: '${MINIMAX_SMALL_FAST_MODEL:-MiniMax-M2.7}' },
      { name: 'OPENAI_BASE_URL', value: '${MINIMAX_OPENAI_BASE_URL:-https://api.minimax.io/v1}' },
      { name: 'OPENAI_API_KEY', value: '${MINIMAX_AUTH_TOKEN}' },
      { name: 'OPENAI_MODEL', value: '${MINIMAX_MODEL:-MiniMax-M3}' },
      { name: 'OPENAI_SMALL_FAST_MODEL', value: '${MINIMAX_SMALL_FAST_MODEL:-MiniMax-M2.7}' },
      { name: 'CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC', value: '${MINIMAX_CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC:-1}' },
    ],
    defaultPermissionModeByTargetKey: { 'agent:claude': 'default', 'agent:codex': 'default' },
    defaultPermissionModeByAgent: {},
    defaultPersistenceModeByTargetKey: {},
    defaultPersistenceModeByAgent: {},
    compatibilityByTargetKey: { 'agent:claude': true, 'agent:codex': true, 'agent:gemini': false },
    compatibility: {},
    isBuiltIn: true,
    defaultEnabled: true,
    createdAt: 0,
  ...
  },
  {
    ...
    environmentVariables: [
      ...
      { name: 'ANTHROPIC_SMALL_FAST_MODEL', value: '${MINIMAX_CN_SMALL_FAST_MODEL:-MiniMax-M2.7}' },
      { name: 'OPENAI_BASE_URL', value: '${MINIMAX_CN_OPENAI_BASE_URL:-https://api.minimaxi.com/v1}' },
      { name: 'OPENAI_API_KEY', value: '${MINIMAX_CN_AUTH_TOKEN}' },
      { name: 'OPENAI_MODEL', value: '${MINIMAX_CN_MODEL:-MiniMax-M3}' },
      { name: 'OPENAI_SMALL_FAST_MODEL', value: '${MINIMAX_CN_SMALL_FAST_MODEL:-MiniMax-M2.7}' },
