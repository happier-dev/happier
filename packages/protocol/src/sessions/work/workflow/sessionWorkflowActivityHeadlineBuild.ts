 ...
 * "progress timestamps never touch the active side" rule live in `../activityHeadlineOrdering.ts`,
 * which the agent-activity headline also calls — this module contributes only the workflow
 * vocabulary's terminality, priority and projection.
 */
