...
const INITIAL_INPUT_TEXT_MEMBER_OVERHEAD_UTF8_BYTES_V1 = textEncoder.encode(
  '"initialInput":{"text":',
).byteLength + 3;
...
const INITIAL_INPUT_TEXT_JSON_STRING_MAX_UTF8_BYTES_V1 = 2
...
export const AUTOMATION_SESSION_START_REQUEST_MAX_RAW_UTF8_BYTES_V1 =
  ...
  + INITIAL_INPUT_TEXT_MEMBER_OVERHEAD_UTF8_BYTES_V1
  + INITIAL_INPUT_TEXT_JSON_STRING_MAX_UTF8_BYTES_V1;
