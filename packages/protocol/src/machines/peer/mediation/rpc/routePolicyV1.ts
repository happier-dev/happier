...
export const MACHINE_RPC_ROUTE_POLICIES = Object.freeze([
  ...
  actionSpecServerRequired(RPC_METHODS.DAEMON_DIRECT_SESSION_ATTACH_LEGACY, 'destructive_or_recovery_mutation', 'Legacy direct-session alias for external-session attach stays server-routed.', 'sessions.external.attach'),
  actionSpecServerRequired(RPC_METHODS.DAEMON_DIRECT_SESSION_DETACH_LEGACY, 'destructive_or_recovery_mutation', 'Legacy direct-session alias for external-session detach stays server-routed.', 'sessions.external.detach'),
