...
const ACTION_SPEC_RPC_METHOD_IDS = Object.freeze({
  ...
  [RPC_METHODS.REVIEW_COMMENTS_CLAIM_PUBLICATION_DISPATCH]: 'reviews.comments.claimPublicationDispatch',
  ...
  [RPC_METHODS.DAEMON_SESSION_HANDOFF_PREPARE_TARGET_RESUME_V3]: 'session.handoff.prepare_target.resume',
...
// These raw machine lifecycle transports have a distinct request/result
// contract owned by the daemon spawn handler. They are not the public V2
// session.spawn_new Action surface.
const SESSION_SPAWN_PRIVATE_INTERNAL_METHODS = new Set<string>([
...
const PMS5_DIRECT_INTERNAL_METHODS = new Set<string>([
  ...
  RPC_METHODS.DAEMON_SESSION_RUNNER_STATUS_V2_GET,
