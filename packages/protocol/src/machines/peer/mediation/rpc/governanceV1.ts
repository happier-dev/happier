...
const ACTION_SPEC_RPC_METHOD_IDS = Object.freeze({
  ...
  [RPC_METHODS.DAEMON_EXTERNAL_SESSION_ATTACH]: 'sessions.external.attach',
  [RPC_METHODS.DAEMON_EXTERNAL_SESSION_DETACH]: 'sessions.external.detach',
  ...
  [RPC_METHODS.DAEMON_DIRECT_SESSION_ATTACH_LEGACY]: 'sessions.external.attach',
  [RPC_METHODS.DAEMON_DIRECT_SESSION_DETACH_LEGACY]: 'sessions.external.detach',
