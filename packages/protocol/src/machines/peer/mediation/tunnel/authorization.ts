...
export const PeerTcpTunnelRelayAuthorizationPayloadV1Schema = z
  .object({
    v: z.literal(1),
...
export type PeerTcpTunnelRelayAuthorizationPayloadV1 = z.infer<
  typeof PeerTcpTunnelRelayAuthorizationPayloadV1Schema
>;
...
export const PeerTcpTunnelRelayAuthorizationV1Schema = z
  .object({
    payload: PeerTcpTunnelRelayAuthorizationPayloadV1Schema,
    signature: PeerTcpTunnelRelayAuthorizationSignatureV1Schema,
  })
  .passthrough();
export type PeerTcpTunnelRelayAuthorizationV1 = z.infer<typeof PeerTcpTunnelRelayAuthorizationV1Schema>;
...
export const PeerTcpTunnelRelayAuthorizationSchema = z.union([
...
export type VerifyPeerTcpTunnelRelayAuthorizationV1Result =
  | Readonly<{ valid: true; payload: PeerTcpTunnelRelayAuthorizationPayloadV1 }>
  | Readonly<{
      valid: false;
      reasonCode:
...
export function createPeerTcpTunnelRelayAuthorizationSigningInputV1(
  payload: PeerTcpTunnelRelayAuthorizationPayloadV1,
): string {
  return createCanonicalJsonSigningInput(PeerTcpTunnelRelayAuthorizationPayloadV1Schema.parse(payload));
}
...
export function verifyPeerTcpTunnelRelayAuthorizationV1(input: Readonly<{
  authorization: unknown;
  nowMs: number;
  trustRoots: readonly PeerTcpTunnelRelayAuthorizationTrustRootV1[];
}>): VerifyPeerTcpTunnelRelayAuthorizationV1Result {
  const parsed = PeerTcpTunnelRelayAuthorizationV1Schema.safeParse(input.authorization);
  ...
  const signingInput = new TextEncoder().encode(
    createPeerTcpTunnelRelayAuthorizationSigningInputV1(authorization.payload),
  );
