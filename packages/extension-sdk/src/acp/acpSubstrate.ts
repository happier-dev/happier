import type { RuntimeBindings } from '@happier-dev/agents';
...
export const ACP_BACKEND_MARKER: typeof acpBackendMarkerSymbol = Symbol.for(
    'happier.extension-sdk.acp.backend.v1',
...
const unsupportedBindings: RuntimeBindings<unknown, unknown, unknown, unknown> = Object.freeze({
