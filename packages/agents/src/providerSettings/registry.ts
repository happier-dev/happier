...
import type { ProviderSettingsDefinition, ProviderSettingsDescriptor } from './types.js';
...
export function assertProviderSettingsRegistryValid(definitions: readonly ProviderSettingsDescriptor[] = ALL_DEFINITIONS): void {
  assertProviderSettingsRegistryValidFor(definitions);
}

export function assertProviderSettingsRegistryValidFor(definitions: readonly ProviderSettingsDescriptor[]): void {
