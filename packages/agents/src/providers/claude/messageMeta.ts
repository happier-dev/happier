...
} from '../../providerSettings/definitions/claudeRemote.js';
import type {
  ProviderMessageMetaEnricher,
  ProviderMessageMetaRegistration,
} from '../../runtime/adjunctAdapters/types.js';
import { registerProviderMessageMetaEnricher } from '../../runtime/adjunctAdapters/messageMetaRegistry.js';
...
export const CLAUDE_MESSAGE_META_ENRICHER = {
  buildOutgoingMessageMetaExtras: buildClaudeRemoteOutgoingMessageMetaExtras,
} satisfies ProviderMessageMetaEnricher;

export const CLAUDE_MESSAGE_META_REGISTRATION = {
  agentId: 'claude',
  enricher: CLAUDE_MESSAGE_META_ENRICHER,
} satisfies ProviderMessageMetaRegistration;

registerProviderMessageMetaEnricher(CLAUDE_MESSAGE_META_REGISTRATION);
