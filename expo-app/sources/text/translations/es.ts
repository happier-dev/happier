...
export const es: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        expFileViewerSubtitle: 'Habilitar el punto de entrada del visor de archivos de la sesión',
    ...
    newSession: {
        ...
        resume: {
            ...
            cannotApplyBody: 'Este ID de reanudación no se puede aplicar ahora. Happy iniciará una nueva sesión en su lugar.',
        },
        codexResumeBanner: {
            title: 'Codex resume',
    ...
    session: {
        ...
        resumeSupportNoteChecking: 'Nota: Happy todavía está comprobando si esta máquina puede reanudar la sesión del proveedor.',
        resumeSupportNoteUnverified: 'Nota: Happy no pudo verificar la compatibilidad de reanudación para esta máquina.',
