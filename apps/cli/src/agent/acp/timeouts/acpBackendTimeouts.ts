...
export function resolvePostPromptNoUpdatesTimeoutMs(transport: TransportHandler): number {
...
export function resolvePromptLivenessTimeoutMs(transport: TransportHandler): number {
