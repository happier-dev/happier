...
vi.mock('@/agent/executionRuns/runtime/runEphemeralExecutionRunTextPrompt', () => ({
  runEphemeralExecutionRunTextPrompt: (...args: unknown[]) => runEphemeralExecutionRunTextPromptMock(...args),
}));

import { runEphemeralExecutionRunTextPromptWithRunnerConfig } from './runEphemeralExecutionRunTextPromptWithRunnerConfig';
