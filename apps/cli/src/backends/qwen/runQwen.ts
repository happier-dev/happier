...
import { QwenPermissionHandler } from './utils/permissionHandler';
...
export async function runQwen(opts: {
  ...
  let permissionHandler: QwenPermissionHandler;
  ...
  permissionHandler = new QwenPermissionHandler(session, {
