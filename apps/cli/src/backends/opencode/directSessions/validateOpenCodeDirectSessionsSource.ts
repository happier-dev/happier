...
} from '@/backends/directSessions/sourceValidation';
...
export function validateOpenCodeDirectSessionsSource(params: Readonly<{
  ...
  const requestedBaseUrl =
    requestedBaseUrlRaw
      ? tryNormalizeDirectSessionsUrl(requestedBaseUrlRaw)
      : null;
  ...
  const configuredBaseUrl =
    configuredBaseUrlRaw
      ? tryNormalizeDirectSessionsUrl(configuredBaseUrlRaw)
      : null;
