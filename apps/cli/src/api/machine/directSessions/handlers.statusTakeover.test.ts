...
vi.mock('@/api/directSessions/backgroundFollow/createManagedDirectSessionFollowLease', async () => {
  const actual = await vi.importActual<typeof import('@/api/directSessions/backgroundFollow/createManagedDirectSessionFollowLease')>(
    '@/api/directSessions/backgroundFollow/createManagedDirectSessionFollowLease',
  );
  return {
    ...actual,
