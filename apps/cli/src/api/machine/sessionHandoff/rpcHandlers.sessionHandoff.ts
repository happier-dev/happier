...
import { registerSessionHandoffStartRpcHandler } from './rpcHandlers.sessionHandoff.start';
import {
  prepareStartedHandoffState as prepareStartedHandoffStateCore,
  type PrepareStartedHandoffStateCallInput,
} from './rpcHandlers.sessionHandoff.prepareStartedHandoffState';
import { registerSessionHandoffPrepareTargetRpcHandler } from './rpcHandlers.sessionHandoff.prepareTarget';
import { registerSessionHandoffCommitRpcHandler } from './rpcHandlers.sessionHandoff.commit';
import { registerSessionHandoffAbortRpcHandler } from './rpcHandlers.sessionHandoff.abort';
import { registerSessionHandoffStatusGetRpcHandler } from './rpcHandlers.sessionHandoff.statusGet';
import { registerSessionHandoffPrepareTargetResultGetRpcHandler } from './rpcHandlers.sessionHandoff.prepareTargetResultGet';
import {
...
export type { SessionHandoffDirectPeerTransferHandle } from './rpcHandlers.sessionHandoff.prepareTransportResolution';
...
export function registerMachineSessionHandoffRpcHandlers(params: Readonly<{
  ...
  const prepareStartedHandoffState = async (
    callInput: PrepareStartedHandoffStateCallInput,
  ) => {
    return await prepareStartedHandoffStateCore({
      callInput,
      activeServerDir: configuration.activeServerDir,
      exportSessionBundle,
      sourceExportStore,
