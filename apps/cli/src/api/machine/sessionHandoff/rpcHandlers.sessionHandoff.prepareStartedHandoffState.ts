...
import {
  type createSessionHandoffWorkspaceReplicationAdapter,
...
import { buildSessionHandoffWorkspaceManifestTransferId } from '../../../workspace/handoff/workspaceReplicationAdapter/sessionHandoffWorkspaceReplicationServerRouted';

import type { SessionHandoffDirectPeerTransferHandle } from './rpcHandlers.sessionHandoff.prepareTransportResolution';
import type { DeferredDirectPeerPreExportedProviderBundle } from './rpcHandlers.sessionHandoff.startDeferredDirectPeer';

export type PrepareStartedHandoffStateCallInput = Readonly<{
  handoffId: string;
...
export type PrepareStartedHandoffStateResult = Readonly<{
  targetPath: string;
...
export async function prepareStartedHandoffState(input: Readonly<{
...
}>): Promise<PrepareStartedHandoffStateResult> {
