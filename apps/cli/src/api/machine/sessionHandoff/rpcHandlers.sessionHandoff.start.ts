...
} from './rpcHandlers.sessionHandoff.startDeferredDirectPeer';
import { startDeferredHandoffWork } from './rpcHandlers.sessionHandoff.startDeferredHandoffWork';
...
type PrepareStartedHandoffStateResult = Readonly<{
  nextState: Readonly<{
    status: SessionHandoffStatus;
    handoffMetadataV2?: SessionHandoffMetadataV2;
  }>;
...
export type RegisterSessionHandoffStartRpcHandlerInput = Readonly<{
  ...
  prepareStartedHandoffState: (params: Readonly<{
    handoffId: string;
