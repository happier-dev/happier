 ...
 * the crash-loop via the platform service manager (launchd/systemd/etc.)
 * and surface the last error line from owned logs/journal output so the
 * user can see WHY it's failing without having to grep the log themselves.
 */
