...
export async function resolveProbeBackendContext(params?: Record<string, unknown>): Promise<{
  ...
  const hasConnectedServices = Object.prototype.hasOwnProperty.call(params ?? {}, 'connectedServices')
  ...
  const shouldLoadAccountSettings = backendTarget?.kind === 'configuredAcpBackend' || needsAccountSettingsForProbes || hasConnectedServices;
