...
import type { PromptRegistryAdapter } from '@/prompts/registries/types';
import { fetchGitPromptRegistryItem, scanGitPromptRegistrySource } from '@/prompts/registries/shared/gitPromptRegistrySource';
