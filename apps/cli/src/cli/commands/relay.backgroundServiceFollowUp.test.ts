...
describe('happier relay background service reconciliation', () => {
    ...
    it('restarts the running background service so it follows the relay it just switched to', { timeout: 120_000 }, async () => {
        ...
        expect(spawnedCliActions).toContainEqual(['service', 'restart']);
    });
