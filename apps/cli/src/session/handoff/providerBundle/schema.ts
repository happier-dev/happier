...
import { SESSION_HANDOFF_PROVIDER_BUNDLE_IDS_V1 } from '../types';
...
export const SessionHandoffProviderBundleSchema = z.discriminatedUnion('providerId', [
  z
    .object({
      providerId: z.literal(SESSION_HANDOFF_PROVIDER_BUNDLE_IDS_V1.claude),
  ...
  z
    .object({
      providerId: z.literal(SESSION_HANDOFF_PROVIDER_BUNDLE_IDS_V1.codex),
      remoteSessionId: z.string().min(1),
  ...
  z
    .object({
      providerId: z.literal(SESSION_HANDOFF_PROVIDER_BUNDLE_IDS_V1.opencode),
      remoteSessionId: z.string().min(1),
