 ...
 *
 * The caller remains the queue owner. This observer emits at most one slow record and one
 * recovery record for a continuous incident; normal work remains silent and payloads are never
 * retained.
 */
