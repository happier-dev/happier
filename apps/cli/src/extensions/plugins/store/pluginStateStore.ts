...
import { ExtensionSourceSpecV1Schema } from '@happier-dev/protocol';

import { writeJsonAtomic } from '@/utils/fs/writeJsonAtomic';

import { PluginCompatibilityDiagnosticSchema } from '../shared/pluginDiagnostics';
import { ensurePluginStoreDirectories, resolvePluginStorePaths, type PluginStorePaths } from './pluginPaths';
...
export const PluginStateSourceRecordSchema = ExtensionSourceSpecV1Schema.extend({
...
export { resolvePluginStorePaths } from './pluginPaths';
