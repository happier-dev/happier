...
describe('getResolvedContributionRegistry', () => {
  ...
  it('keeps the built-in snapshot isolated after priming merged contributions', async () => {
  ...
  it('indexes action contributions in deterministic order on an immutable snapshot', () => {
  ...
  it('indexes tool, command, and lifecycle-handler definitions alongside action contributions', () => {
    const registry = createResolvedContributionRegistry({
      providers: Object.freeze([
        {
          id: 'acme.provider',
