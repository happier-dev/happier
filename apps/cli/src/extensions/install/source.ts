...
import { createPluginStateStore, type PluginStateRecord } from '../store/state';
import { resolveInstalledPluginCurrentPath } from '../store/installPaths';
import { resolveLocalPathPluginSource } from '../sources/localPath';
...
export async function installPluginFromSource(params: Readonly<{
  ...
  locator: string;
  sourceKind?: PluginInstallKind;
  sourceSpecOverride?: ExtensionSourceSpecV1;
