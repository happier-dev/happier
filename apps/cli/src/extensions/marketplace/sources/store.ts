...
import { MARKETPLACE_SOURCE_REGISTRY_LOCK_NAME, withPluginStoreLock } from '../../store/lock';
import { ensurePluginStoreDirectories, resolvePluginStorePaths, type PluginStorePaths } from '../../store/paths';
