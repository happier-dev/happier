...
test('flags an agent that ships in the app with no page', () => {
  // A missing page breaks no link, so every other check here is blind to it.
  const definitions = join(
    fixture({
      'defs.ts': '  "claude": Object.freeze(({\n  "cursor": Object.freeze(({\n',
    }),
    'defs.ts',
  );
