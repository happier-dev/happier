...
A session is attached to a folder on one of your machines, and Happier gives you
...
<Callout type="info">
  ...
  though if the session is inactive and the machine is still online, Happier can
