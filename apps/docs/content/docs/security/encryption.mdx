...
For the concrete QR/button flows, see [Features → Device linking & restore](/docs/features/device-linking-and-restore).
...
For the user-facing sharing model, see [Session sharing](/docs/features/session-sharing).
