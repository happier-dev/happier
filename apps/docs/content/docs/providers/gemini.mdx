...
If you use hstack, you can install Gemini with its legacy-named `providers` installer:
...
For cross-Agent model behavior, live model lists, and favorites, see [Model and engine selection](/features/model-and-engine-selection).
