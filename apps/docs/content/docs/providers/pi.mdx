...
If you use hstack, you can install Pi with its legacy-named `providers` installer:
...
Pi does not currently expose a native interactive login flow through Happier Agent settings.
