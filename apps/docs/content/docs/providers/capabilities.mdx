...
| --- | --- | --- | --- | --- | --- |
| **Claude** | Yes | Yes | Yes | `provider-native` | `staticAgentModes` |
| **Codex** | — | — | — | `metadata-gating` | `acpPolicyPresets` |
| **OpenCode** | — | Yes | — | `acp-setSessionMode` | `acpAgentModes` |
| **Gemini** | — | — | — | `none` | `none` |
| **Auggie** | — | — | — | `none` | `none` |
| **Qwen Code** | — | — | — | `none` | `none` |
| **Kimi** | — | — | — | `none` | `none` |
| **Kilo** | — | Yes | — | `acp-setSessionMode` | `acpAgentModes` |
| **Kiro** | — | Yes | — | `acp-setSessionMode` | `acpAgentModes` |
| **Custom ACP** | — | Yes | — | `acp-setSessionMode` | `acpAgentModes` |
| **Pi** | Yes | — | — | `none` | `none` |
| **Copilot** | — | Yes | — | `acp-setSessionMode` | `acpAgentModes` |
| **Cursor** | — | Yes | — | `acp-config-option` | `acpAgentModes` |
| **Grok** | — | — | — | `none` | `none` |
...
| **OpenCode** | Experimental | Yes | — | Yes (`native_mcp`) | `openai-codex`, `openai`, `claude-subscription`, `anthropic` |
| **Gemini** | Yes | — | — | Yes (`native_mcp`) | `gemini` |
| **Auggie** | Experimental | Experimental | — | — | — |
| **Qwen Code** | Experimental | Yes | — | — | — |
| **Kimi** | Experimental | Yes | — | — | — |
| **Kilo** | Experimental | Yes | — | — | — |
| **Kiro** | Experimental | Yes | — | Yes (`native_mcp`) | — |
| **Custom ACP** | Experimental | Yes | — | Yes (`native_mcp`) | — |
| **Pi** | Experimental | Experimental | — | — | `openai-codex`, `openai`, `claude-subscription`, `anthropic` |
| **Copilot** | Experimental | Yes | — | — | — |
| **Cursor** | — | Yes | Yes | — | — |
| **Grok** | — | — | — | — | — |
