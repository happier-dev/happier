...
Use **Login with secret key instead** when:
...
- a LAN URL such as `http://192.168.x.x:53288`
...
- **I cannot scan right now** → **Enter URL manually** or **Login with secret key instead**
