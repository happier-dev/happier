...
- **Resume ID** starts a new Happier session by resuming an existing provider session id. See [Resume a provider session (Resume ID)](/sessions/resume-provider-sessions).
...
- [Browse and import provider sessions](/sessions/browse-and-import-sessions)
