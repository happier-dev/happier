...
2. Use the official Happier app and set its **Server URL** to your instance.

In this setup, you do **not** need to configure APNs/FCM yourself. The official app already includes the required push notification credentials; your server just stores the user’s Expo push tokens.
...
1. Deploy the server.
2. In the official Happier app, set **Server URL** to your server.
