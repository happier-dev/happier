...
If you want a guided “do the right thing” setup flow from the terminal (Relay selection, sign-in if needed, daemon service install), use:
...
Dry-run the plan (prints what would happen):
