...
- [CLI](/clients/cli) for install/auth/server selection
- [CLI sessions](/clients/cli-sessions) for create/list/send/resume/attach/manage
- [Happier MCP (external)](/clients/mcp) for editor/agent automation
- [MCP host setup](/clients/mcp-hosts) for privileged host configuration

If you’re looking specifically for background operation and service installation, see [Daemon](/clients/daemon).
