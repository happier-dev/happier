...
- inspect files or source control before starting a session
...
- selecting a worktree changes the active checkout used by Files, Source control, terminals, and new sessions
