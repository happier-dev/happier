...
If you enable **Enter to Send** in [Session settings](/docs/features/session-settings), Enter sends the current message when the composer has sendable content. On web, Shift+Enter inserts a new line. On iOS and iPadOS with a physical keyboard, Shift+Enter also continues to insert a new line while Enter sends.
