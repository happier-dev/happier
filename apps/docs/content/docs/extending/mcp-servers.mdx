...
Presentation adapts to the device:

- on desktop and larger screens, the picker stays close to the composer
- on phones and mobile web, the picker expands into a wider, easier-to-scan selection surface

This keeps the MCP override flow usable without leaving the current new-session screen.
