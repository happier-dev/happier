...
This is an opt-out: in-place Agent switching is advertised unless it is explicitly disabled. For what the feature does, see [Continue with another Agent](/docs/features/continue-with-another-agent).
