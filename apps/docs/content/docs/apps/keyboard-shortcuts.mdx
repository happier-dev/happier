...
Happier has 46 keyboard commands. Every one can be rebound, and the defaults
...
| Command | Default |
| --- | --- |
| `browser.address.focus` | `Alt+L` (web) · `Mod+L` (everywhere else) |
| `browser.back` | `Alt+[` (web) · `Mod+[` (everywhere else) |
| `browser.forward` | `Alt+]` (web) · `Mod+]` (everywhere else) |
| `browser.reload` | `Alt+R` (web) · `Mod+R` (everywhere else) |
| `splitCanvas.closeLeaf` | `Alt+Backspace` |
| `splitCanvas.focusDown` | `Alt+ArrowDown` |
| `splitCanvas.focusLeft` | `Alt+ArrowLeft` |
| `splitCanvas.focusRight` | `Alt+ArrowRight` |
| `splitCanvas.focusUp` | `Alt+ArrowUp` |
| `splitCanvas.restoreMaximize` | `Escape` |
| `splitCanvas.splitDown` | `Alt+Shift+ArrowDown` |
| `splitCanvas.splitRight` | `Alt+Shift+Enter` |
| `splitCanvas.toggleMaximize` | `Alt+M` |
