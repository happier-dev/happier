...
If you want to provision a remote machine for **CLI + daemon** usage (pairing/auth included), see: [Remote background service setup (SSH)](/hstack/remote-daemon).
...
- uses the self-host defaults (SQLite, local files, `PORT=53288`)
