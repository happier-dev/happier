...
This is optional. Most people can use the served web UI on mobile via Tailscale or point the Happier app at their self-hosted relay (see [App → Relay selection](/apps/app#relay-selection)).
