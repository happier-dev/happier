...
This is optional. Most people can use the served web UI on mobile via Tailscale or point the official Happier app to their self-hosted server (see [App → Server URL](../clients/app#server-url)).
