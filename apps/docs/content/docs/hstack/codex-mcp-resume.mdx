---
title: Codex MCP resume (experimental)
description: Notes for integrating a Codex MCP server that can resume sessions from rollout JSONL.
---
...
- **App-managed home (more isolated)**:
