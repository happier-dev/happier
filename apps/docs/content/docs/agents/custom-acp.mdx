...
- **Built-in ACP** — the generic ACP agents Happier already ships, defined in
...
- How much works depends on what your ACP CLI actually exposes — Happier can only surface capabilities the agent advertises.
