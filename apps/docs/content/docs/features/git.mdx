...
- **Git write actions** remain behind **Settings → Features → Source control operations**.
- **Review comments** remain behind **Settings → Features → File review comments**.
...
Full guide: [Review comments](/features/review-comments)
