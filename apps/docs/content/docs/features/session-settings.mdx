...
For the full workflow, see [Session handoff](/features/session-handoff).
...
For the full workflow, see [Attach to a running session](/features/attach-to-session).
...
Full guide: [Permissions](/features/permissions)
...
Full guide: [New session shortcuts](/features/new-session-shortcuts)
...
Related guide: [Tool timeline & normalization](/features/tool-timeline)
...
Full description: [Swipe between sessions](/clients/app#swipe-teleport).
