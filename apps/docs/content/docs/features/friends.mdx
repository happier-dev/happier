...
- The Friends experience is reachable at `/friends`. It does not redirect, and it is separate from the global Inbox at `/inbox` — see [Inbox and approvals](/features/inbox-and-approvals).
