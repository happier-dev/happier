...
In a new-session flow, Happier can also discover saved review comments for the selected machine and directory. If you keep the review-comments chip enabled, the matching review comments are sent with the first actionable message. Turning that chip off does not remove attachment drafts.
