...
- [Synced and direct sessions](/features/direct-sessions), which explains where the transcript lives
- [Continue with another Agent](/features/continue-with-another-agent), which changes the coding Agent in place on the machine that already hosts the session
...
See [Synced and direct sessions](/features/direct-sessions).
