...
- [Continue with another Agent](/docs/features/continue-with-another-agent), which changes the coding Agent in place on the machine that already hosts the session
...
- [Continue with another Agent](./continue-with-another-agent)
