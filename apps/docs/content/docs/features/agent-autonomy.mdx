...
Actions that need your decision surface as approval requests rather than proceeding silently — see [Inbox and approvals](/features/inbox-and-approvals).
...
- [Happier tools and actions](/features/happier-tools) — the full action surface an agent can reach
- [Permissions](/features/permissions) — what each permission mode allows
- [Inbox and approvals](/features/inbox-and-approvals) — how approval requests reach you
- [Subagents](/features/subagents) — an agent's *own* internal subagents, which is a different mechanism
