...
- **Resume ID**: starting a new session by resuming an existing provider session id (see [Resume a provider session (Resume ID)](/features/resume-provider-sessions))
