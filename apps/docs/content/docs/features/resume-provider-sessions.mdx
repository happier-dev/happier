...
- [Resume inactive sessions](/features/session-resume) (resuming an existing Happier session)
- [Browse and import provider sessions](/features/browse-and-import-sessions) (opening provider sessions as direct sessions and optionally syncing them)
