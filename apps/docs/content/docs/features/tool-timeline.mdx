...
If you want the live roster for those agents, use the dedicated [Agents & subagents](/features/subagents) surface. The transcript keeps the launch history; the Agents tab keeps the current running/recent view.
