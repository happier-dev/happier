...
| Voice: BYO ElevenLabs | Stable | App, Web | Uses your own ElevenLabs account/API key on device. |
| Voice: Local OpenAI-compatible STT/TTS | Experimental | App, Web | Supports direct mode and mediator mode. |
