...
- [New session shortcuts](/docs/features/new-session-shortcuts)
- [Session handoff](/docs/features/session-handoff)
- [Session read and unread state](/docs/features/session-read-state)
...
- [Installables](/docs/features/installables)
- [Review comments](/docs/features/review-comments)
