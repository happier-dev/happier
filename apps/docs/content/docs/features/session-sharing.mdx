...
description: Share a session with someone in Happier, or publish a read-only link — and know what gets logged when you do.
---
...
- [Friends](/features/friends) — the direct-sharing prerequisite
