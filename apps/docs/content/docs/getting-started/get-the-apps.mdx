...
<Cards>
  ...
  <Card title="Android (APK)" href="https://github.com/happier-dev/happier/releases/download/ui-mobile-preview/happier-preview.apk" description="Direct download. There is no public Play listing yet." />
</Cards>
...
| Platform | Download |
| --- | --- |
| macOS (Apple Silicon) | [Download](https://github.com/happier-dev/happier/releases/download/ui-desktop-stable/happier-ui-desktop-darwin-aarch64-v0.2.0.dmg) |
| macOS (Intel) | [Download](https://github.com/happier-dev/happier/releases/download/ui-desktop-stable/happier-ui-desktop-darwin-x86_64-v0.2.0.dmg) |
| Windows (x64) | [Download](https://github.com/happier-dev/happier/releases/download/ui-desktop-stable/happier-ui-desktop-windows-x86_64-v0.2.0.exe) |
| Linux (x64, AppImage) | [Download](https://github.com/happier-dev/happier/releases/download/ui-desktop-stable/happier-ui-desktop-linux-x86_64-v0.2.0.AppImage) |

Current desktop build: **v0.2.0**. Every build is listed on the
[releases page](https://github.com/happier-dev/happier/releases/tag/ui-desktop-stable) if you need an older one or a different
