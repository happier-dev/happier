...
vi.mock("@/utils/randomKeyNaked", () => ({ randomKeyNaked: () => "k" }));

vi.mock("@/app/sessionPending/sessionPendingService", async (importOriginal) => {
    const actual = await importOriginal<typeof import("@/app/sessionPending/sessionPendingService")>();
    return {
        ...actual,
