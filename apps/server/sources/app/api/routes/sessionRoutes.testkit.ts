...
export const sessionFindMany = vi.fn(async () => []);
export const sessionFindFirst = vi.fn(async () => null);
export const sessionMessageFindMany = vi.fn(async () => []);
...
vi.mock("@/app/events/eventRouter", () => ({
    ...
    buildNewMessageUpdate: (...args: any[]) => buildNewMessageUpdate(...args),
    buildNewSessionUpdate: (...args: any[]) => buildNewSessionUpdate(...args),
    buildUpdateSessionUpdate: (...args: any[]) => buildUpdateSessionUpdate(...args),
}));
...
vi.mock("@/utils/randomKeyNaked", () => ({
    randomKeyNaked: (...args: any[]) => randomKeyNaked(...args),
}));
