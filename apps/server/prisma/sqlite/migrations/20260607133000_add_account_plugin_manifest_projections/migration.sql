CREATE TABLE "account_plugin_manifest_projections" (
    ...
    CONSTRAINT "account_plugin_manifest_projections_account_id_fkey" FOREIGN KEY ("account_id") REFERENCES "Account" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "account_plugin_manifest_projections_machine_fkey" FOREIGN KEY ("account_id", "machine_id") REFERENCES "Machine" ("accountId", "id") ON DELETE CASCADE ON UPDATE CASCADE
);
