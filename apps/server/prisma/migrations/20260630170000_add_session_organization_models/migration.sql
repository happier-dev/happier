CREATE TABLE "SessionPin" (
    ...
    CONSTRAINT "SessionPin_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SessionOrganizationFolder" (
    ...
    CONSTRAINT "SessionOrganizationFolder_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SessionOrganizationTag" (
    ...
    CONSTRAINT "SessionOrganizationTag_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SessionTagAssignment" (
    ...
    CONSTRAINT "SessionTagAssignment_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SessionOrganizationOrderEntry" (
    ...
    CONSTRAINT "SessionOrganizationOrderEntry_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SessionOrganizationLabel" (
    ...
    CONSTRAINT "SessionOrganizationLabel_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SessionOrganizationCheckpoint" (
    ...
    CONSTRAINT "SessionOrganizationCheckpoint_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "SessionPin" ADD CONSTRAINT "SessionPin_accountId_fkey"
FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SessionPin" ADD CONSTRAINT "SessionPin_sessionId_fkey"
FOREIGN KEY ("sessionId") REFERENCES "Session"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SessionOrganizationFolder" ADD CONSTRAINT "SessionOrganizationFolder_accountId_fkey"
FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SessionOrganizationTag" ADD CONSTRAINT "SessionOrganizationTag_accountId_fkey"
FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SessionTagAssignment" ADD CONSTRAINT "SessionTagAssignment_accountId_fkey"
FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SessionTagAssignment" ADD CONSTRAINT "SessionTagAssignment_sessionId_fkey"
FOREIGN KEY ("sessionId") REFERENCES "Session"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SessionTagAssignment" ADD CONSTRAINT "SessionTagAssignment_tagId_fkey"
FOREIGN KEY ("tagId") REFERENCES "SessionOrganizationTag"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SessionOrganizationOrderEntry" ADD CONSTRAINT "SessionOrganizationOrderEntry_accountId_fkey"
FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SessionOrganizationLabel" ADD CONSTRAINT "SessionOrganizationLabel_accountId_fkey"
FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SessionOrganizationCheckpoint" ADD CONSTRAINT "SessionOrganizationCheckpoint_accountId_fkey"
FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;
