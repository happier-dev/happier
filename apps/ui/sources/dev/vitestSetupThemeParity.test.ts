 ...
 * the mock consume.
 *
 * This is the guard on that arrangement. A `state.*` token added to the real theme and forgotten in
 * the mock resolves to `undefined`, which renders as "no colour" and passes silently — the vacuous
 * green this program is specifically trying not to reintroduce.
 */
