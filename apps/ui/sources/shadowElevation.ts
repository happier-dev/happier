...
export function buildDarkShadowLevels(): ShadowLevels {
    return {
        1: token(
            '0 2px 8px rgba(0, 0, 0, 0.03), 0 1px 3px rgba(0, 0, 0, 0.05)',
            '#000000',
            { width: 0, height: 1 },
            0.06,
            4,
        ...
        2: token(
            '0 2px 10px rgba(0, 0, 0, 0.06), 0 2px 6px rgba(0, 0, 0, 0.08)',
            '#000000',
            { width: 0, height: 2 },
            0.1,
            5,
        ...
        3: token(
            '0 4px 18px rgba(0, 0, 0, 0.11), 0 2px 8px rgba(0, 0, 0, 0.13)',
            '#000000',
            { width: 0, height: 3 },
            0.14,
            8,
        ...
        4: token(
            '0 8px 28px rgba(0, 0, 0, 0.15), 0 4px 14px rgba(0, 0, 0, 0.17)',
            '#000000',
            { width: 0, height: 4 },
            0.18,
            12,
        ...
        5: token(
            '0 14px 40px rgba(0, 0, 0, 0.20), 0 6px 18px rgba(0, 0, 0, 0.22)',
            '#000000',
            { width: 0, height: 8 },
            0.22,
            16,
