...
export function useDesktopOverlayTransparentDocumentBackground(enabled: boolean) {
    React.useLayoutEffect(() => {
        ...
        if (styleElement) {
            // Keep the stylesheet content up to date across fast refresh or partial reloads.
