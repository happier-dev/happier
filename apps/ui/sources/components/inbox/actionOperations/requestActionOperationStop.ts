import type { ActionOperationCancelV1Response, ActionOperationSnapshotV1 } from '@happier-dev/protocol';
...
export async function requestAcceptedActionOperationStop(operation: ActionOperationSnapshotV1): Promise<void> {
