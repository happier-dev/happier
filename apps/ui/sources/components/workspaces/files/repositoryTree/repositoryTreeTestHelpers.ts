...
const testkitMocksPath = '../../../../dev/testkit/mocks';
...
export function installRepositoryTreeCommonModuleMocks(
    ...
    vi.doMock('react-native', async () => {
        ...
        const { createReactNativeWebMock } = await import(`${testkitMocksPath}/reactNative`);
    ...
    vi.doMock('react-native-unistyles', async () => {
        ...
        const { createUnistylesMock } = await import(`${testkitMocksPath}/unistyles`);
    ...
    vi.doMock('@/modal', async () => {
        ...
        const { createModalModuleMock } = await import(`${testkitMocksPath}/modal`);
    ...
    vi.doMock('@/sync/domains/state/storage', async (importOriginal) => {
        ...
        const { createStorageModuleMock } = await import(`${testkitMocksPath}/storage`);
