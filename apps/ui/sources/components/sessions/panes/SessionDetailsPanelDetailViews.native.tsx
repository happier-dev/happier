export { SessionSubagentDetailsView as SessionSubagentDetailsViewForPanel } from '@/components/sessions/agents/details/SessionSubagentDetailsView';
export { SessionCommitDetailsView as SessionCommitDetailsViewForPanel } from '@/components/sessions/files/views/SessionCommitDetailsView';
