...
/**
 * The one launcher for the fork strategy modal. Both fork entry points — the
 * Session header and a transcript message — go through it, so neither can issue
 * a fork effect before the user has chosen a strategy.
 *
