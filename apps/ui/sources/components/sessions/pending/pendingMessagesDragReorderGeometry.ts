 ...
 * `transcriptPendingQueueReorderRowHeightPx`, default 72 — still read in this repo for an unrelated
 * web viewport floor, so it is not removed here), which is why the block painted a
