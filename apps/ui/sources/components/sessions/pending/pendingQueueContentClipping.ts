 ...
 *
 * Device basis: measured on the sibling preview repo (iPhone 17 Pro / iOS 26.5, 2026-08-18) against
 * geometry that is byte-identical here — every constant below is re-derived from THIS repo's styles.
 */
