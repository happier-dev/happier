 ...
 * which is the presentation this row has always used for files.
 *
...
const fallbackReferenceMappingHelper: FlashListCompat.FlashListMappingHelper = {
    getMappingKey: (itemKey: FlashListCompat.FlashListMappingKey) => itemKey,
};

function useReferenceMappingHelper(): FlashListCompat.FlashListMappingHelper {
    return typeof FlashListCompat.useMappingHelper === 'function'
        ? FlashListCompat.useMappingHelper()
        : fallbackReferenceMappingHelper;
}
        ...
        <View style={styles.row}>
            {props.references.map((reference, index) => {
                if (reference.kind === 'session') {
                    return (
                        <SessionReferenceChip
                            key={getMappingKey(`session:${reference.sessionId}`, index)}
                ...
                return props.fileOpenEnabled ? (
                    <Pressable
                        key={getMappingKey(`file:${path}`, index)}
