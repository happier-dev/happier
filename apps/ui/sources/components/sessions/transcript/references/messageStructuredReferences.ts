 ...
 * envelope (INV-4): it is never reinterpreted as a file or a session. That covers the
 * plugin-contributed `composerReference` kind too — it has its own presentation owner
 * and must not fall through to this one.
 */
