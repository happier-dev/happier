...
type SessionEntryRenderResetSharedEffects = Readonly<{
    ...
    nativeBottomPinCommandCacheReset: LifecycleEffectOf<'session-entry-native-bottom-pin-command-cache-reset'>;
    ...
    nativeStreamAppendRecordReset: LifecycleEffectOf<'session-entry-native-stream-append-content-version-record-reset'>;
...
export function resolveSessionEntryRenderResetEffects(params: Readonly<{
    ...
    const shared: SessionEntryRenderResetSharedEffects = {
        ...
        nativeBottomPinCommandCacheReset: findRequiredEffect(
            params.effects,
            'session-entry-native-bottom-pin-command-cache-reset',
            params.sessionId,
            'Session-entry lifecycle did not emit native bottom-pin command cache reset effect',
        ),
        ...
        nativeStreamAppendRecordReset: findRequiredEffect(
            params.effects,
            'session-entry-native-stream-append-content-version-record-reset',
            params.sessionId,
            'Session-entry lifecycle did not emit native stream-append content-version record reset effect',
        ),
