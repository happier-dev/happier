...
import { Session, Machine } from '@/sync/domains/state/storageTypes';
import { Ionicons } from '@expo/vector-icons';
import { getSessionName, useSessionStatus, getSessionAvatarId, formatPathRelativeToHome } from '@/utils/sessions/sessionUtils';
import { Avatar } from '@/components/ui/avatar/Avatar';
import { Typography } from '@/constants/Typography';
import { StatusDot } from '@/components/ui/status/StatusDot';
import { useAllMachines, useHasUnreadMessages, useSetting } from '@/sync/domains/state/storage';
...
export function ActiveSessionsGroup({ sessions, selectedSessionId, serverId }: ActiveSessionsGroupProps) {
