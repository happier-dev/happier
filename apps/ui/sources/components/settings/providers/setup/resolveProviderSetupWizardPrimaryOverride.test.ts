...
describe('buildProviderSetupWizardPrimaryOverride', () => {
    ...
    it('uses Continue/Done in queue phase depending on pending providers', async () => {
        ...
        const continueOverride = buildProviderSetupWizardPrimaryOverride({
            phase: 'queue',
            canStart: true,
        ...
        const doneOverride = buildProviderSetupWizardPrimaryOverride({
            phase: 'queue',
            canStart: true,
            hasPendingProviders: false,
            start: vi.fn(async () => undefined),
