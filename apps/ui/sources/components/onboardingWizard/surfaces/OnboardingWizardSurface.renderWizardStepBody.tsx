...
import { SecretKeyLoginEmbedded } from '@/components/onboardingWizard/restore/SecretKeyLoginEmbedded';
...
import type { RemoteSshChecklistMode } from '../remoteSshChecklist/remoteSshChecklistTypes';
...
export function renderOnboardingWizardStepBody(params: Readonly<{
                        ...
                        {params.welcomeHasAuthActions && params.allowRelaySelection ? (
                            <View style={params.styles.scanCtaBlock}>
                                <RoundButton
                                    ...
                                    onPress={params.onOpenRelaySelectionFromWelcome}
                                />
                            </View>
                        ) : null}
                    </>
    ...
    if (params.stepId === 'relay_access') {
        ...
        return <LocalRelayAccessControlSection upstreamUrl={upstreamUrl} presentation="wizard" />;
    }
