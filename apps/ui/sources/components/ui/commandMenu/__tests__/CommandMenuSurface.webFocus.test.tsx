 ...
 * `isInputFocused`), that focus shift unmounts the pressed row between
 * `mousedown` and `mouseup`, the browser then delivers no `click`, and the press
 * is silently swallowed — the reported "clicking a menu item does nothing, you
 * have to press Tab" bug.
 *
