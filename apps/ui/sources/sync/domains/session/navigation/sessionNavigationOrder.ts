...
/**
 * Structural shape of a stage-C session list row. Kept minimal so the module stays
 * usable from every list surface without importing the full view-item union.
 */
