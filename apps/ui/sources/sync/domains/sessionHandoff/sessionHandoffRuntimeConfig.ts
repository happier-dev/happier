...
export type SessionHandoffRuntimeConfig = Readonly<{
    ...
    sourceReachabilityRetryDelayMs: number;
    sourceReachabilityRetryWindowMs: number;
}>;
...
const DEFAULT_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_DELAY_MS = 1_000;
const DEFAULT_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_WINDOW_MS = 15_000;
...
const MIN_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_DELAY_MS = 250;
const MAX_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_DELAY_MS = 30_000;
const MIN_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_WINDOW_MS = 1_000;
const MAX_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_WINDOW_MS = 60_000;
...
export function resolveSessionHandoffRuntimeConfig(
    ...
    return {
        ...
        sourceReachabilityRetryDelayMs: readClampedPositiveIntEnv(
            env,
            'EXPO_PUBLIC_HAPPIER_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_DELAY_MS',
            DEFAULT_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_DELAY_MS,
            MIN_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_DELAY_MS,
            MAX_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_DELAY_MS,
        ),
        sourceReachabilityRetryWindowMs: readClampedPositiveIntEnv(
            env,
            'EXPO_PUBLIC_HAPPIER_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_WINDOW_MS',
            DEFAULT_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_WINDOW_MS,
            MIN_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_WINDOW_MS,
            MAX_SESSION_HANDOFF_SOURCE_REACHABILITY_RETRY_WINDOW_MS,
        ),
    };
}
