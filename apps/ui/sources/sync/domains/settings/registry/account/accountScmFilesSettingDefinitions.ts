...
export const ACCOUNT_SCM_FILES_SETTING_DEFINITIONS = defineSettingDefinitions({
    ...
    filesImagePreviewCacheMaxTotalBytes: {
        ...
        description: 'Maximum total raw bytes for cached image preview sources (best-effort)',
        storageScope: 'account',
    ...
    filesImagePreviewMaxBytes: {
        ...
        storageScope: 'account',
        analytics: { trackCurrentState: true, trackChanges: true, valueKind: 'bucket', privacy: 'bucketed', identityScope: 'person', serializeCurrent: serializeBytesBucket(16 * 1024 * 1024, 32 * 1024 * 1024) },
    },
    filesEditorAutoSave: {
        schema: z.boolean(),
        default: false,
