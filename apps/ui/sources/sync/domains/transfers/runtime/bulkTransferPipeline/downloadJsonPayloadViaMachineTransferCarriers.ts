...
type JsonDownloadChunkResponse =
    | Readonly<{
        success: true;
...
>(
    ...
    return await downloadJsonPayloadWithCarrierFallbacks({
        ...
        downloadViaLegacyBulk: async () => await downloadBulkJsonPayload<TPayload>({
            init: async (request): Promise<JsonDownloadInitResponse> => await callScopedMachineDownloadRpc({
                machineId: params.machineId,
                serverId: params.serverId,
                timeoutMs: params.timeoutMs,
            ...
            readChunk: async (request): Promise<JsonDownloadChunkResponse> => await callScopedMachineDownloadRpc({
                machineId: params.machineId,
                serverId: params.serverId,
                timeoutMs: params.timeoutMs,
                preferScoped: params.preferScoped,
