...
// Chunk encryption is transfer-plumbing and should stay scoped to transferRuntime/plumbing/**
// so feature code cannot bypass the canonical bulk transfer entrypoints.
