...
describe('concurrent session cache socket routing', () => {
    it('opens non-active server sockets with server-scoped credentials', async () => {
        ...
        vi.doMock('./encryption/encryption', () => ({
            Encryption: {
