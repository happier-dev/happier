...
type LocalOssVoiceSectionProps = Readonly<{
    ...
    onSetVoiceLocalUseDeviceStt: (value: boolean) => void;
    onSetVoiceLocalUseDeviceTts: (value: boolean) => void;
...
export function LocalOssVoiceSection(props: LocalOssVoiceSectionProps) {
    ...
    const hasLocalhostEndpoint = hostish.includes('localhost') || hostish.includes('127.0.0.1');
    const localhostWarning = hasLocalhostEndpoint ? `\n\n${t('settingsVoice.local.localhostWarning')}` : '';

    return (
        <>
            <ItemGroup
                title="Runtime and mediation"
                footer={`${t('settingsVoice.local.footer')}\n\nHow voice input gets turned into session messages.${localhostWarning}`}
            >
                <Item
            ...
            <ItemGroup
                ...
                footer={`Configure how your microphone audio is transcribed.${localhostWarning}`}
            >
                <Item
                    ...
                    rightElement={<Switch value={props.voiceLocalUseDeviceStt} onValueChange={props.onSetVoiceLocalUseDeviceStt} />}
                    showChevron={false}
                />
                {!props.voiceLocalUseDeviceStt ? (
                    <>
                        <Item
            ...
            <ItemGroup
                ...
                footer={`Configure how assistant replies are spoken.${localhostWarning}`}
            >
                <Item
                    ...
                    rightElement={<Switch value={props.voiceLocalUseDeviceTts} onValueChange={props.onSetVoiceLocalUseDeviceTts} />}
                    showChevron={false}
                />
                {!props.voiceLocalUseDeviceTts ? (
                    <>
                        <Item
