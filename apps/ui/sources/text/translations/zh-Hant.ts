...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
  ...
  settings: {
    ...
    settingsAppearance: {
        ...
        settingsNavSidebarDescription: '在工作階段中顯示設定側邊欄（Web/平板）',
  ...
  newSession: {
          ...
          actionsDraft: {
            ...
            pendingMessages: {
                ...
                badgeLabel: ({ count }: { count: number }) => (count > 0 ? `待傳送 (+${count})` : '待傳送'),
	                ...
	                nonSteerableNotice: '目前回合在這次模式變更後無法接受 steering。它會在下一輪執行，或使用立即傳送來中斷。',
	                actions: {
                    up: '上移',
                    down: '下移',
                    edit: '編輯',
    ...
    settingsKeyboard: {
        title: '鍵盤快捷鍵',
        entrySubtitle: '查看並控制應用程式快捷鍵',
        generalGroupTitle: '鍵盤控制',
        generalGroupFooter: '快捷鍵偏好設定會儲存在此裝置本機。',
        enableShortcutsTitle: '啟用統一快捷鍵',
        enableShortcutsSubtitle: '使用新的鍵盤命令登錄檔管理應用程式快捷鍵。',
        singleKeyTitle: '單鍵快捷鍵',
        singleKeySubtitle: '當文字輸入未聚焦時，允許使用 ? 等快捷鍵。',
        conflictsTitle: ({ count }: { count: number }) => `偵測到 ${count} 個快捷鍵衝突`,
        conflictsSubtitle: ({ count }: { count: number }) => `需要檢查 ${count} 個命令後，才能啟用所有快捷鍵。`,
        ...
        resetCommandAccessibility: ({ command }: { command: string }) => `重設 ${command} 快捷鍵`,
        commands: {
            ...
            settingsOpen: '開啟設定',
            transcriptMessageNext: '下一則轉錄訊息',
            transcriptMessagePrevious: '上一則轉錄訊息',
            transcriptScrollBottom: '捲動轉錄到底部',
            transcriptScrollPageDown: '轉錄向下捲動一頁',
            transcriptScrollPageUp: '轉錄向上捲動一頁',
            transcriptScrollTop: '捲動轉錄到頂部',
        },
    },
    ...
    commandPalette: {
        ...
        shortcutsHelpTitle: '鍵盤快捷鍵',
        shortcutsHelpBody: ({ shortcuts }: { shortcuts: string }) => `已啟用的快捷鍵:\n${shortcuts}`,
        shortcutsHelpEmpty: '此裝置上沒有啟用的快捷鍵。',
        shortcutsHelpCommandPalette: '開啟命令面板',
        shortcutsHelpHelp: '開啟鍵盤快捷鍵',
        shortcutsHelpNewSession: '新工作階段',
        commands: {
    ...
    sessionsList: {
        ...
        addFolder: '新增資料夾',
        newFolderDefaultName: '資料夾',
        folderNamePlaceholder: '資料夾名稱',
        workspaceRoot: '工作區根目錄',
        moveToFolder: '移至資料夾',
        failedToMoveSessionToFolder: '無法將工作階段移動到該資料夾。',
        newSessionInFolder: '在資料夾中新增工作階段',
        addSubfolder: '新增子資料夾',
        renameFolder: '重新命名資料夾',
        deleteFolder: '刪除資料夾',
        ...
        deleteFolderPromptDescription: '此資料夾中的工作階段會移到上層資料夾或工作區根目錄。',
    },
    ...
    files: {
        ...
        fileActions: {
            ...
            selectEntireFileForCommit: '選擇整個檔案',
            rangeSelection: '範圍',
            stageFile: '暫存檔案',
        ...
        sourceControlOperations: {
            ...
            update: {
                ...
                publishRepository: {
                    ...
                    originConflictRemediation: '發佈前請選擇如何處理現有 origin。',
                    commitRequired: '發佈前請先提交待處理變更。',
                    unsafeUrl: 'Happier 已阻止不安全的後續 URL。',
                    auth: {
                        connectedAccountReady: 'GitHub 連接已就緒。',
                        providerCliReady: 'gh CLI 已通過身分驗證。',
                    },
                    remediation: {
                        connectGitHub: '連接 GitHub',
                        installGh: '安裝 gh CLI',
                        useManagedGh: '使用託管 gh CLI',
                        authenticateGh: '驗證 gh CLI',
                        openBrowser: '在瀏覽器中開啟',
                    },
                    errors: {
    ...
    executionRuns: {
        ...
        noTargetsMatch: '沒有介面符合目前的搜尋。',
        noDescription: '尚無描述。',
        requireApproval: '需要核准',
        invalidActionTitle: '找不到動作',
        invalidActionSubtitle: '此動作在這個建置中已不再可用。',
...
settingsSession: {
	          sessionList: {
	              ...
	              orderingTitle: '工作階段列表選項',
	              orderingSubtitle: '選擇工作階段的分組與顯示方式。',
	              orderingOptions: {
	                  custom: '自訂順序',
	                  created: '建立時間',
	                  updated: '更新時間',
        ...
        subAgentGuidanceEntry: {
          ...
          sessionCreation: {
              ...
              rememberLastEngineSelectionsTitle: '記住上次引擎選擇',
              rememberLastEngineSelectionsEnabledSubtitle: '新工作階段會依伺服器和引擎重用上次的模型、模式和引擎選項。',
              rememberLastEngineSelectionsDisabledSubtitle: '除非草稿或捷徑提供選擇，否則新工作階段會從引擎預設值開始。',
    ...
    machine: {
        ...
        replacementRepair: {
            ...
            chooseReplacementSubtitle: '選擇取代此裝置的裝置。',
            pickerTitle: '選擇取代裝置',
            pickerCandidatesTitle: '可用裝置',
            confirmTitle: '將裝置標記為已取代？',
            confirmBody: ({ machine }: { machine: string }) => `此裝置未來的啟動和舊工作階段將使用 ${machine}。`,
            confirmAction: '取代',
            undo: '復原取代',
            undoSubtitle: ({ machine }: { machine: string }) => `此裝置目前已由 ${machine} 取代。`,
            undoConfirmTitle: '復原裝置取代？',
            undoConfirmBody: '如果此裝置可用，它將再次顯示為啟動目標。',
            undoAction: '復原',
            error: '無法更新裝置取代。',
        },
