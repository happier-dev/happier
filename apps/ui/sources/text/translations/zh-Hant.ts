...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
  ...
  settings: {
        ...
        github: 'GitHub',
        machines: '裝置',
        remoteHostsTitle: '遠端主機',
        remoteHostsDesktopOnlyTitle: '遠端主機僅在桌面版可用',
        remoteHostsDesktopOnlySubtitle: '在桌面版管理已儲存的 SSH 主機。',
        remoteHostsManagementDisabledTitle: '遠端主機管理已停用',
        remoteHostsManagementDisabledSubtitle: '此版本不允許管理遠端主機。',
        remoteHostsEmptyTitle: '沒有遠端主機',
        remoteHostsEmptySubtitle: '新增遠端主機以在設定中重用 SSH 憑證。',
        remoteHostsAddHost: '新增遠端主機',
        remoteHostsAddHostTitle: '新增遠端主機',
        remoteHostsEditHostTitle: '編輯遠端主機',
        remoteHostsHostGroupTitle: '主機',
        remoteHostsSshGroupTitle: 'SSH',
        remoteHostsSecretMaterialGroupTitle: '機密資料',
        remoteHostsSavePasswordLabel: '儲存密碼',
        remoteHostsPasswordSavedTitle: '密碼已儲存',
        remoteHostsPasswordSavedSubtitle: '留空以保持不變。',
        remoteHostsStorePrivateKeyLabel: '儲存私鑰（加密）',
        remoteHostsPrivateKeyLabel: '私鑰',
        remoteHostsPrivateKeySavedHint: '私鑰已儲存。留空以保持不變。',
        remoteHostsSecretMaterialDisabledTitle: '已停用儲存機密',
        remoteHostsSecretMaterialDisabledSubtitle: '此版本不允許儲存密碼或私鑰。',
        remoteHostsSetupAsMachineTitle: '設定為 Happier 機器',
        remoteHostsSetupAsMachineFailed: '無法將此主機設定為 Happier 機器。',
        remoteHostsConnectFromThisDeviceTitle: '從此裝置連線',
        remoteHostsConnectFromThisDeviceSubtitle: '僅限此裝置。為此應用程式工作階段開啟本機 SSH 通道。',
        remoteHostsConnectFromThisDeviceFailed: '無法開啟本機 SSH 通道。',
        remoteHostsNativeSshTunnelRequiresEngine: '原生 SSH 通道需要先建置原生 SSH 引擎，才能從此裝置啟動。',
        remoteHostsSshTunnelGroupTitle: '從此裝置存取遠端主機',
        remoteHostsSshTunnelActiveTitle: ({ host }: { host: string }) => `${host} 的 SSH 通道已啟用`,
        remoteHostsSshTunnelActiveSubtitle: ({ url }: { url: string }) => `僅限此裝置。本機端點：${url}`,
        remoteHostsSshTunnelStopTitle: '停止本機 SSH 通道',
        remoteHostsUseAsRelayHostTitle: '用作 Relay 主機',
        remoteHostsUseAsRelayHostSubtitle: '在此 SSH 主機上設定 Relay 存取。',
        remoteHostsConfigureAccessTitle: '設定存取',
        remoteHostsConfigureAccessSubtitle: '選擇此遠端主機的可連線方式。',
        remoteHostsOpenDetailsTitle: '主機詳細資料',
        remoteHostsRelayAccessGroupTitle: '遠端存取',
        remoteHostsRelayAccessActiveTitle: ({ host }: { host: string }) => `正在為 ${host} 設定存取`,
        remoteHostsRelayAccessActiveSubtitle: 'Relay 存取命令會透過 SSH 在遠端主機上執行。這不會建立 SSH 通道。',
        remoteHostsMissingServerUrl: '設定遠端機器前請先選擇伺服器。',
        remoteHostsRelayAccessIdentityFileRequired: '此主機上的 Relay 存取需要本機 SSH 身分檔案。',
        remoteHostsTestConnectionTitle: '測試連線',
        remoteHostsInstallOrUpdateCliTitle: '安裝或更新 CLI',
        remoteHostsDaemonServiceInstallOrUpdateTitle: '安裝或更新守護行程服務',
        remoteHostsDaemonServiceStartTitle: '啟動守護行程服務',
        remoteHostsDaemonServiceStopTitle: '停止守護行程服務',
        remoteHostsDaemonServiceRestartTitle: '重新啟動守護行程服務',
        remoteHostsRelayRuntimeStatusTitle: 'Relay 執行環境狀態',
        remoteHostsRelayRuntimeInstallOrUpdateTitle: '安裝或更新 Relay 執行環境',
        remoteHostsRelayRuntimeStartTitle: '啟動 Relay 執行環境',
        remoteHostsRelayRuntimeStopTitle: '停止 Relay 執行環境',
        remoteHostsRelayRuntimeRestartTitle: '重新啟動 Relay 執行環境',
        remoteHostsPortLine: ({ port }: { port: number }) => `連接埠: ${port}`,
        remoteHostsActiveTaskTitle: '系統任務',
        remoteHostsHostTrustTitle: '信任 SSH 主機？',
        remoteHostsReplaceHostKeyTitle: '取代 SSH 主機金鑰？',
        remoteHostsReplaceHostKeyAction: '取代主機金鑰',
        remoteHostsHostKeyCurrentFingerprintLabel: '目前信任的指紋',
        remoteHostsHostKeyNewFingerprintLabel: '新指紋',
        remoteHostsPasswordRequiredTitle: '需要 SSH 密碼',
        remoteHostsRememberHostKeyTitle: '記住此 SSH 主機金鑰？',
        remoteHostsRememberHostKeyAction: '信任並記住',
        remoteHostsTrustOnceAction: '僅信任一次',
        remoteHostsPrivateKeyPassphraseTitle: 'SSH 私密金鑰密碼',
        remoteHostsKeyboardInteractiveTitle: 'SSH 身分驗證',
        remoteHostsKeyboardInteractivePromptLabel: 'SSH 提示',
        remoteHostsTrustedHostKeysTitle: '受信任的 SSH 主機金鑰',
        remoteHostsTrustedHostKeyRemoveTitle: '移除受信任的 SSH 主機金鑰？',
        remoteHostsTrustedHostKeysClearTitle: '清除受信任的 SSH 主機金鑰',
        remoteHostsConnectionSucceeded: '連線成功。',
        remoteHostsConnectionFailed: '連線失敗。',
        sshConfiguredHostPickerTitle: '建議的 SSH 主機',
        sshConfiguredHostPickerSubtitle: '從本機 SSH 設定或 known_hosts 填入。',
        sshConfiguredHostPickerRefreshingSubtitle: '正在重新整理建議；仍顯示上次結果。',
        sshConfiguredHostPickerSourceSshConfig: 'SSH 設定',
        sshConfiguredHostPickerSourceKnownHosts: 'known_hosts',
        sshConfiguredHostPickerUnsupportedTitle: '手動輸入 SSH 詳細資料',
        sshConfiguredHostPickerUnsupportedSubtitle: '本機 SSH 偵測僅在桌面應用程式可用。',
        sshConfiguredHostPickerLoadingTitle: '正在尋找 SSH 主機…',
        sshConfiguredHostPickerLoadingSubtitle: '正在透過桌面橋接檢查本機 SSH 設定和 known_hosts。',
        sshConfiguredHostPickerEmptyTitle: '沒有建議的 SSH 主機',
        sshConfiguredHostPickerEmptySubtitle: '手動輸入 SSH 詳細資料，或更新 SSH 設定後重新整理。',
        sshConfiguredHostPickerErrorTitle: '無法載入 SSH 建議',
        sshConfiguredHostPickerRefreshTitle: '重新整理 SSH 建議',
        sshConfiguredHostPickerRefreshingTitle: '正在重新整理 SSH 建議',
        features: '功能',
        social: '社交',
        account: '帳戶',
        ...
        addMachine: '新增機器',
        machineSetupCurrentMachineTitle: '設定這台電腦',
        ...
        machineSetupStepResolveRelay: '正在檢查現有元件',
        machineSetupStepCheckAuth: '正在檢查登入狀態',
        machineSetupStepConfigureRelay: '正在連線至 Relay',
        machineSetupStepAuthRequest: '核准此電腦',
        machineSetupStepAuthWait: '等待核准',
        machineSetupStepInstallService: '正在安裝背景服務',
        machineSetupStepStartService: '正在啟動背景服務',
        machineSetupStepVerifyService: '正在驗證背景服務',
        ...
        machineSetupRemoteSshUsernameLabel: 'SSH 使用者名稱',
        machineSetupRemoteSshUsernamePlaceholder: 'ubuntu',
        machineSetupRemoteSshHostLabel: 'SSH 主機',
        machineSetupRemoteSshHostPlaceholder: 'example.test',
        machineSetupRemoteSshPortLabel: 'SSH 連接埠',
        machineSetupRemoteSshPortPlaceholder: '22',
        machineSetupRemoteSshAuthMethodLabel: '驗證方式',
        machineSetupRemoteSshAgentAuthLabel: '使用 SSH 代理程式',
        machineSetupRemoteSshKeyFileAuthLabel: '使用私鑰',
        machineSetupRemoteSshPasswordAuthLabel: '使用密碼',
        machineSetupRemoteSshIdentityFileLabel: '私鑰路徑',
        machineSetupRemoteSshPrivateKeyMaterialLabel: '貼上私鑰',
        machineSetupRemoteSshPasswordLabel: 'SSH 密碼',
        ...
        localRelayRuntime: {
            title: '本機 Relay 執行階段',
            statusTitle: '狀態',
            statusChecking: '正在檢查本機 Relay 執行階段',
            statusNotInstalled: '此電腦尚未安裝',
            statusStopped: '已安裝，但目前未執行',
            statusRunningHealthy: '正在執行並正常回應',
            statusRunningNeedsAttention: '正在執行，但健康檢查需要注意',
            versionTitle: '已安裝版本',
            relayUrlTitle: '本機 Relay URL',
            installOrUpdateAction: '安裝或更新 Relay 執行階段',
            startAction: '啟動 Relay 執行階段',
            stopAction: '停止 Relay 執行階段',
            refreshAction: '重新整理 Relay 狀態',
            footer: '在連接其他裝置之前，先管理此電腦上執行的自架 Relay。',
            progressTitle: '正在更新本機 Relay 執行階段',
            progressStepInspect: '檢查本機 Relay 執行階段',
        ...
        localTailscale: {
            title: '使用 Tailscale 的私密存取',
            statusTitle: '狀態',
            statusUnavailable: '請先啟動本機 Relay 執行階段',
            statusIdle: '尚未啟用',
            statusWorking: '正在設定安全的私密存取',
            statusReady: '可從其他 tailnet 裝置使用',
            statusInstallRequired: '請先安裝 Tailscale 以繼續',
            statusLoginRequired: '請先登入 Tailscale 以繼續',
            statusNeedsApproval: '等待 Tailscale 核准',
            shareableUrlTitle: '可分享的私密 URL',
            approvalTitle: '需要核准',
            approvalSubtitle: '完成 Tailscale 核准流程後再回到這裡。',
            installTitle: '需要安裝',
            installSubtitle: '安裝 Tailscale 後再回到這裡。',
            loginTitle: '需要登入',
            loginSubtitle: '完成 Tailscale 登入流程後再回到這裡。',
            enableAction: '啟用 Tailscale 私密存取',
            refreshAction: '重新檢查私密存取',
            openApprovalAction: '開啟 Tailscale 核准',
            openInstallAction: '開啟 Tailscale 下載',
            openLoginAction: '開啟 Tailscale 登入',
            footer: '這會讓存取僅限於 tailnet。你的手機或其他電腦也必須加入同一個 tailnet。',
            progressTitle: '正在設定 Tailscale 安全存取',
            progressStepDetect: '檢查 Tailscale 是否可用',
            progressStepInstall: '安裝 Tailscale',
            progressStepLogin: '登入 Tailscale',
            progressStepServeEnable: '啟用私密 Relay 存取',
            progressStepVerifyUrl: '驗證可分享 URL',
        },
        relayAccess: {
            title: 'Relay 存取',
            footer: '選擇你的手機如何連線到此 Relay。',
            statusTitle: '狀態',
            statusNotConfigured: '尚未設定',
            statusWorking: '正在檢查 Relay 存取',
            statusEnabled: '已啟用',
            statusDisabled: '已停用',
            statusNeedsAuth: '需要登入',
            statusError: '錯誤',
            statusUnknown: '未知',
            shareableUrlTitle: '可分享 URL',
            methodTitle: '存取方式',
            saveAction: '儲存存取方式',
            disableAction: '停用 Relay 存取',
            refreshAction: '重新整理存取狀態',
            progressStepInspect: '檢查目前設定',
            progressStepCheck: '檢查存取狀態',
            progressStepPersist: '儲存存取設定',
            progressStepApply: '套用存取設定',
            progressStepVerify: '驗證存取 URL',
            progressStepDisable: '停用 Relay 存取',
            providers: {
                localOnly: {
                    title: '僅本機',
                    subtitle: '只有此電腦可以連線到 Relay。',
                },
                lan: {
                    title: 'LAN / 自訂 URL',
                    subtitle: '使用你已有的 URL（LAN IP 或通道）。',
                },
                tailscaleServe: {
                    title: 'Tailscale Serve',
                    subtitle: 'tailnet 的私密 URL（建議）。',
                },
                tailscaleFunnel: {
                    title: 'Tailscale Funnel',
                    subtitle: '透過 Funnel 的公開 URL。',
                },
                cloudflareNamed: {
                    title: 'Cloudflare 隧道',
                    subtitle: '透過具名的 Cloudflare 隧道提供公開 URL。',
                },
            },
            fields: {
                urlLabel: 'Relay 位址',
            ...
            missingUrl: '請輸入 Relay URL 以繼續。',
            missingHostname: '請輸入主機名稱以繼續。',
            missingToken: '請輸入權杖以繼續。',
            webHandoffTitle: '在電腦上執行',
            webHandoffSubtitle: '使用 CLI 設定 relay 存取，然後回到這裡並重新整理。',
        },
        accessEndpoints: {
            status: {
                refreshing: '正在重新整理存取通道',
            },
            scope: {
                availableToOtherDevices: '可供其他裝置使用',
                thisDeviceOnly: '僅此裝置',
            },
            direction: {
                makeCurrentServerReachable: '讓此伺服器可被存取',
                reachRemoteServerFromThisDevice: '從此裝置連到遠端伺服器',
                unknown: '存取通道',
            },
            kind: {
                'relay-access-provider': 'Relay 存取',
                'ssh-tunnel-desktop': '桌面 SSH 通道',
                'ssh-tunnel-native': '原生 SSH 通道',
                'server-profile-url': '伺服器 URL',
                'peer-mediation': '點對點中介',
                'manual-url': '手動 URL',
            },
            recommendedUse: {
                'multi-device': '最適合其他裝置',
                'native-this-device': '可在此原生 App 中使用',
                'hosted-web': '可從託管 Web 使用',
                'lan-only': '僅限 LAN 或私人網路',
                diagnostic: '需要處理',
            },
            limitation: {
                'this-device-only': '僅此裝置',
                'not-hosted-web-compatible': '無法用於託管 Web',
                'not-public-share-url': '不是公開分享 URL',
                'session-scoped': '僅限目前工作階段',
                'authentication-failed': 'SSH 驗證失敗',
                'foreground-only': '需要 App 保持在前景',
                'host-key-mismatch': 'SSH 主機金鑰已變更',
                'host-key-rejected': 'SSH 主機金鑰已被拒絕',
                'host-key-untrusted': 'SSH 主機金鑰尚未受信任',
                'platform-suspended': 'App 被系統暫停時會停止',
                'loopback-bind-failed': '無法繫結本機通道連接埠',
                'network-captive-portal': '網路攔截了 SSH 連線',
                'remote-service-unreachable': '無法透過通道連線到遠端服務',
                'requires-auth': '需要 SSH 驗證',
                'requires-host-key-trust': '需要信任主機金鑰',
            },
            remediation: {
                tailscale: {
                    install: '安裝 Tailscale',
                    login: '登入 Tailscale',
                    serve: {
                        enable: '啟用 Tailscale Serve',
                        approve: '核准 Tailscale Serve',
                    },
                    funnel: {
                        approve: '核准 Tailscale Funnel',
                    },
                },
                cloudflare: {
                    configure: '設定 Cloudflare 通道',
                },
                serverProfile: {
                    configureShareableUrl: '設定可分享 URL',
                },
                remoteHost: {
                    add: '新增遠端主機',
                    setup: '設定遠端主機',
                ...
                sshTunnel: {
                    ...
                    reuse: '使用現有 SSH 通道',
                    stop: '停止 SSH 通道',
                    authenticate: '驗證 SSH 通道',
                    trustHost: '信任 SSH 主機金鑰',
                },
            },
        },
        ...
        systemTaskStepFinish: '完成設定',
	        ...
	        systemTaskOpenLogs: '打開日誌',
	        systemTaskOpenLogsFailed: '無法打開日誌資料夾。',
    ...
    settingsSourceControl: {
        ...
        remoteConfirmation: {
            ...
            confirmBeforePulling: {
                title: '拉取前確認',
                subtitle: '下載並合併遠端變更前先詢問。',
            },
            confirmBeforePushing: {
                title: '推送前確認',
                subtitle: '將本機提交上傳到遠端前先詢問。',
            },
            options: {
                always: {
        ...
        diffMode: {
		    ...
		    settingsPets: {
		        ...
		        disabledTitle: '寵物已停用',
		        disabledSubtitle: '啟用寵物實驗功能即可在此裝置使用 Blink。',
		        accountTitle: '帳戶預設值',
		        enabledTitle: '啟用寵物',
	    ...
	    settingsNotifications: {
	        activitySurfaces: {
	            title: '活動介面',
	            footer: '控制此裝置上的 Live Activities、Dynamic Island 與小工具。',
	            enabledSubtitle: '在此裝置上啟用可快速瀏覽的工作階段介面',
	            shared: {
	                title: '共享行為',
	                footer: '選擇所有活動介面的點按與預覽內容行為。',
	            },
	            tapTargetTitle: '點按目標',
	            tapTargetOpenSessionTitle: '開啟目前工作階段',
	            tapTargetOpenSessionsTitle: '開啟啟用中的工作階段',
	            privacyTitle: '隱私',
	            privacyStatusOnlyTitle: '僅狀態',
	            privacyTitleOnlyTitle: '僅標題',
	            privacyIncludePreviewTitle: '包含預覽文字',
	            liveActivities: {
	                title: 'Live Activities',
	                footer: '控制 iPhone 鎖定畫面與 Dynamic Island 的顯示方式。',
	                enabledSubtitle: '在此裝置上啟用 Live Activities',
	                strategyTitle: 'Activity strategy',
	                strategySubtitle: '選擇某個活動是跟隨最重要的工作階段，還是保持固定。',
	                focusedTitle: '聚焦工作階段',
	                attentionTitle: '注意',
	                runningTitle: '進行中的工作階段',
	                ...
	                presentationSubtitle: '選擇 Live Activities 應如何突出目前工作階段。',
	                maxConcurrentTitle: '最大同時活動數',
	                maxConcurrentOneTitle: '1 個活動',
	                maxConcurrentTwoTitle: '2 個活動',
	                maxConcurrentFourTitle: '4 個活動',
	                previewTextTitle: '預覽文字',
	                actionButtonsTitle: '動作按鈕',
	                includeReadyTitle: '包含就緒工作階段',
	                includeThinkingTitle: '包含思考中的工作階段',
	                remoteUpdates: {
	                    title: '遠端更新',
	                    footer: '用於在 App 不再位於前景後更新 Live Activities 的所選伺服器診斷。',
	                    effectiveModeTitle: '實際傳送方式',
	                    effectiveMode: {
	                        hosted_happier_relay: '託管中繼',
	                        direct_apns: '直接 APNs',
	                    ...
	                    details: {
	                        ...
	                        selected: '已選取',
	                        fallback: '備用',
	                        preferred_unavailable: '僅本機',
	                        local_only: '僅本機',
	                        disabled: '已停用',
	                        runtimeOnly: '僅執行時',
	                    },
	                    hostedRelayTitle: '託管 Happier 中繼',
	                    hostedRelayAvailableSubtitle: '此所選伺服器已設定託管中繼。',
	                    hostedRelayDisabledSubtitle: '此 self-hosted 伺服器已停用託管中繼。',
	                    hostedRelayBlockedSubtitle: '託管中繼身分與提供者支援尚未實作。',
	                    hostedRelayUnavailableSubtitle: '此所選伺服器無法使用託管中繼。',
	                    directApnsTitle: '直接 APNs',
	                    directApnsConfiguredSubtitle: '直接 APNs 憑證已設定，且不會暴露憑證材料。',
	                    directApnsMissingCredentialsSubtitle: '直接 APNs 缺少伺服器端憑證設定。',
	                    directApnsUnavailableSubtitle: '此所選伺服器無法使用直接 APNs。',
	                    backgroundWakeTitle: '背景喚醒',
	                    backgroundWakeBestEffortSubtitle: '背景喚醒可以嘗試重新整理，但 iOS 可能會延遲或捨棄它。',
	                    backgroundWakeDisabledSubtitle: '此所選伺服器已停用背景喚醒備援。',
	                    localOnlyTitle: '僅本機更新',
	                    localOnlyRuntimeSubtitle: '僅本機更新會在 App 執行時可執行時運作；不保證 App 被結束後仍會更新。',
	                },
            },
	            widgets: {
	                title: '主畫面小工具',
	                footer: '控制顯示在裝置主畫面的按鈕式小工具總覽。',
	                enabledSubtitle: '在此裝置上啟用小工具',
	                summaryTitle: '摘要',
	                attentionTitle: '注意',
	                runningTitle: '進行中的工作階段',
	                previewTextTitle: '預覽文字',
	                machinePathTitle: '機器與路徑',
	            },
	        },
	        badges: {
	            title: '此裝置的徽章',
        ...
        quietHours: {
            title: '勿擾時段',
            footer: '帳戶勿擾時段預設會套用到所有地方。裝置覆寫只會影響此裝置。',
            accountOffTitle: '無帳戶勿擾時段',
            accountOffSubtitle: '隨時傳送帳戶通知',
            accountNightlyTitle: '每天夜間 22:00 到 7:00',
            accountNightlySubtitle: '在夜間將注意力管道靜音或抑制',
            deviceAccountTitle: '此裝置跟隨帳戶時段',
            deviceAccountSubtitle: '使用已同步的帳戶勿擾時段政策',
            deviceDisabledTitle: '在此裝置上停用勿擾時段',
            deviceDisabledSubtitle: '即使帳戶勿擾時段啟用，也允許此裝置傳送',
            deviceCustomNightlyTitle: '此裝置使用夜間勿擾時段',
            deviceCustomNightlySubtitle: '在此裝置上以 22:00 到 7:00 覆寫帳戶時段',
        },
        sounds: {
            title: '聲音',
            footer: '帳戶預設聲音會在所有地方同步。此裝置可以將本機聲音靜音。',
            accountHappierTitle: 'Happier 聲音',
            accountHappierSubtitle: '更新使用柔和提示音，需要注意時使用較明亮的提示音',
            accountDefaultTitle: '系統預設',
            accountDefaultSubtitle: '使用平台通知聲音',
            accountSilentTitle: '靜音',
            accountSilentSubtitle: '無聲傳送通知',
            deviceEnabledTitle: '在此裝置上播放聲音',
            deviceEnabledSubtitle: '本機通知聲音的裝置覆寫',
            previewTitle: '預覽聲音',
            previewSubtitle: '在此裝置上傳送本機預覽通知',
            previewNotificationTitle: '通知聲音預覽',
            previewNotificationBody: '目前通知聲音會以這種方式運作。',
        },
        push: {
            title: '推播通知',
        ...
        foregroundBehavior: {
            ...
            account: '帳戶預設',
            accountDescription: '在此裝置使用帳戶層級的應用程式內通知行為',
            full: '完整',
    ...
    notifications: {
        actions: {
            ...
            answer: '回答',
            other: '其他',
            alwaysAllowTool: ({ tool }: { tool: string }) => `一律允許 ${tool}`,
        },
        activity: {
    ...
    settingsProviders: {
        ...
        setup: {
            selectionFooter: '選擇一個或多個提供者，然後在所選機器上逐一完成。',
            startTitle: '設定提供者',
            startDescription: '將所選提供者加入佇列，並在單一標準流程中完成安裝與登入。',
            queueTitle: '提供者設定佇列',
            queueDescription: ({ provider }: { provider: string }) => `Finish ${provider}, then continue to the next provider in the queue.`,
            activeDescription: '佇列中目前的提供者',
            activeStatus: '進行中',
            completedStatus: '已完成',
            skippedStatus: '已略過',
            skipAction: '略過此提供者',
            completedTitle: '提供者設定完成',
            completedDescription: '你已到達所選提供者佇列的結尾。',
        },
        cliSourcePreference: {
            title: 'CLI 來源偏好',
    ...
    settingsFeatures: {
        ...
        expLiveActivitiesSubtitle: '啟用 iOS 的 Live Activities 與 Dynamic Island 表面',
        expHomeScreenWidgets: '主畫面小工具',
        expHomeScreenWidgetsSubtitle: '啟用 iOS 主畫面小工具表面',
        expVoiceAgent: '語音代理',
        expVoiceAgentSubtitle: '啟用由守護程序支援的語音代理介面（需要執行運行）',
        expVoiceDaemonInference: '守護程序語音推論',
        expVoiceDaemonInferenceSubtitle: '啟用守護程序本機神經 TTS/STT 介面（需要語音代理）',
  ...
  newSession: {
      ...
      session: {
          ...
          toolCallsCollapsedPreviewMore: ({ count }: { count: number }) => `+${count} 更多…`,
            ...
            rollback: {
                ...
                checkpointCode: {
                    title: '回退選項',
                    conversationUnavailable: '此工作階段不支援回退對話。',
                    codeOnlyConfirmation: '我了解對話內容將保持不變。',
                    showAdvanced: '顯示進階僅程式碼選項',
                    choices: {
                        conversation_only: {
                            title: '僅回退對話',
                            description: '只回退轉錄內容，不更改檔案。',
                        },
                        conversation_and_code_with_stash: {
                            title: '回退對話和程式碼，使用 Git stash',
                            description: '建立 Happier 備份檢查點，stash 目前變更，然後套用反向 patch。',
                        },
                        conversation_and_code_without_stash: {
                            title: '回退對話和程式碼，不使用 Git stash',
                            description: '建立 Happier 備份檢查點，然後在此 worktree 中套用反向 patch。',
                        },
                        code_only_with_stash: {
                            title: '僅回退程式碼，使用 Git stash',
                            description: '進階：保持對話不變，在 stash 備份後回退檔案。',
                        },
                        code_only_without_stash: {
                            title: '僅回退程式碼，不使用 Git stash',
                            description: '進階：保持對話不變，僅使用 Happier 備份檢查點回退檔案。',
                        },
                    },
                },
            },
            ...
            actionMenu: {
                openA11y: '開啟工作階段操作',
                backgroundFollow: '背景追蹤',
            },
            detailsPanel: {
                emptyTitle: '沒有開啟的分頁',
                emptyHint: '從其他分頁開啟檔案、差異或終端。',
    ...
    server: {
        ...
        reachabilityRemediation: {
            failedToOpenInstallLink: '無法開啟 Tailscale 安裝頁面。',
            tailscale: {
                title: '此 Relay 使用 Tailscale',
                desktopBody: '這台電腦無法透過 Tailscale 連到此 Relay。這台電腦上的 Tailscale 可能尚未安裝、尚未登入，或尚未連到正確的 tailnet。',
                webBody: '此瀏覽器無法透過 Tailscale 連到此 Relay。請在此裝置上開啟 Tailscale，確認已連到正確的 tailnet，然後再試一次。',
                nativeBody: '此裝置無法透過 Tailscale 連到此 Relay。請開啟 Tailscale，確認已連到正確的 tailnet，然後再試一次。',
                installAction: '安裝 Tailscale',
                desktopPrepareAction: '準備 Tailscale',
            },
        },
        relayDrift: {
            bannerDifferentRelayTitle: '你的背景服務連線到了不同的 Relay',
            bannerDifferentRelayDescription: ({ activeRelayUrl, daemonRelayUrl }: { activeRelayUrl: string; daemonRelayUrl: string }) =>
                `App：${activeRelayUrl} · 背景服務：${daemonRelayUrl}`,
            bannerNeedsAuthTitle: '你的背景服務需要登入此 Relay',
            bannerNeedsAuthDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) =>
                `App 正在使用 ${activeRelayUrl}，但背景服務仍需要核准或登入。`,
            bannerNotConfiguredTitle: '你的背景服務尚未連線到此 Relay',
            bannerNotConfiguredDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) =>
                `App 正在使用 ${activeRelayUrl}，但此電腦尚未完成背景服務連線。`,
            bannerNotInstalledTitle: '此 Relay 尚未安裝背景服務',
            bannerNotInstalledDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) =>
                `App 正在使用 ${activeRelayUrl}，但此電腦仍需為其安裝背景服務。`,
            bannerNotRunningTitle: '背景服務已安裝但未執行',
            bannerNotRunningDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) =>
                `App 正在使用 ${activeRelayUrl}，但背景服務已停止，需要重新啟動。`,
    ...
    sourceControlWorkspace: {
        ...
        pinSession: '釘選工作階段',
        unpinSession: '取消釘選',
        openInSplitRight: '在右側分割中開啟',
        openInSplitDown: '在下方分割中開啟',
        revealInCurrentSplit: '在目前分割中顯示',
        viewMachine: '查看裝置',
    ...
    files: {
        ...
        agentReportedTurnChanges: ({ count }: { count: number }) => `代理回報的最近一輪（${count}）`,
        checkpointTurnChanges: ({ count }: { count: number }) => `檢查點最近一輪（${count}）`,
        selectedForCommitChanges: ({ count }: { count: number }) => `已選取提交（${count}）`,
        latestTurnDescription: '來自最近一次已完成輪次的提供者變更。',
        agentReportedTurnDescription: '代理/runtime 為最近一次已完成輪次回報的檔案。',
        checkpointAttributionExclusive: '檢查點內容對此輪次區間是精確的，且此 worktree 專屬於此工作階段。',
        checkpointAttributionShared: '檢查點內容對儲存庫區間是精確的。由於此 worktree 是共享的，歸因能力有限。',
        checkpointAttributionUnknown: '檢查點內容對儲存庫區間是精確的。行為者歸因未知。',
        checkpointUnavailable: '此輪次的檢查點證據不可用。',
...
settingsSession: {
          sessionList: {
              ...
              orderingTitle: '排序',
              orderingSubtitle: '選擇工作階段清單的排序方式',
              orderingOptions: {
                  custom: '自訂',
                  created: '建立時間',
                  updated: '更新時間',
        ...
        mobileWorkspaceExperience: {
            ...
            title: '行動工作區',
            subtitle: '選擇預設的行動工作階段版面。',
            options: {
                cockpitTitle: '駕駛艙',
                cockpitSubtitle: '使用底部分頁列切換聊天、檔案、Git、分頁與終端機。',
                classicTitle: '傳統',
                classicSubtitle: '使用舊版單畫面行動工作階段版面。',
            },
        },
        input: {
            title: '輸入',
        ...
        manualDisclosure: {
            ...
            subtitle: {
                ...
                connectMachine: ({ targetLabel }: { targetLabel: string }) =>
                    ...
                    `使用桌面設定流程將這台電腦連線到 ${targetLabel}。只有在你偏好終端路徑時，才打開手動步驟。`,

                startDaemon: ({ targetLabel }: { targetLabel: string }) =>

                    `使用桌面設定流程重新連線 ${targetLabel} 的背景服務。只有在你已經在那台電腦上時，才打開手動步驟。`,

                createSession: '使用應用程式中的 + 按鈕，或在終端機中建立新的工作階段。',

                selectSession: '從側邊欄選取一個工作階段即可在這裡查看。',

                loading: '正在取得你的機器和工作階段…',
            ...
            steps: {
                ...
                openSetup: {
                    ...
                    description: '這是建議路徑。它會設定中繼、安裝背景服務，並讓其餘設定留在應用程式中完成。',

                },

                startDaemonOpenSetup: {

                    description: '在改用終端命令之前，先使用桌面設定流程重新連線或修復這台電腦上的背景服務。',
                ...
                serverSetup: {
                    ...
                    description: '只需執行一次，接下來的命令就會指向正確的中繼。',
                ...
                authLogin: {
                    ...
                    description: '這會列印可將你的終端機連線到帳號的 QR Code 或連結。',
                ...
                daemonInstall: {
                    ...
                    description: '讓 Happier 在背景保持就緒，方便遠端啟動。',
                ...
                daemonStart: {
                    ...
                    description: '如果你現在只需要它先執行一次，就用這個。',
                ...
                createSession: {
                    ...
                    description: '使用應用程式中的 + 按鈕，或在終端機中執行其中一個命令。',
