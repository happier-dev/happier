...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
    ...
    settingsVoice: {
        ...
        local: {
            ...
            testTts: 'Test TTS',
            testTtsSubtitle: 'Play a short sample using your configured endpoint',
        ...
        privacy: {
            ...
            shareToolNamesSubtitle: '包含工具名稱/描述（參數一律會被隱藏）',
            sharePermissionRequests: '分享權限請求',
            sharePermissionRequestsSubtitle: '轉送權限提示（參數一律會被隱藏）',
