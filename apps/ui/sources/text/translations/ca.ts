...
export const ca: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        expVoiceAuthFlowSubtitle: 'Utilitza el flux autenticat de tokens de veu (amb paywall)',
            ...
            expCodexAcpSubtitle: 'Fer servir Codex via ACP (codex-acp) en lloc de MCP (experimental)',
...
deps: {
    ...
    settingsVoice: {
        ...
        byo: {
            ...
            notConfigured: 'Introdueix la clau API i l’ID de l’agent d’ElevenLabs per usar la veu sense subscripció.',
            ...
            agentIdDescription: 'Introdueix l’ID de l’agent al tauler d’ElevenLabs.',
            agentIdPlaceholder: 'agent_...',
            apiKey: 'Clau API',
            apiKeySet: 'Establerta',
            apiKeyNotSet: 'No establerta',
            apiKeyTitle: 'Clau API d’ElevenLabs',
            apiKeyDescription: 'Introdueix la teva clau API d’ElevenLabs. Es desa xifrada al dispositiu.',
