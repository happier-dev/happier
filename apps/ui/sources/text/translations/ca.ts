...
const settingsSessionHandoffTranslationExtensions = {
  ca: {
    ...
    directTargetMode: {
      ...
      convertToPersistedSubtitle: 'Importa la transcripcio i continua com una sessio gestionada per Happier.',
    },
  },
} as const;
...
export const ca: TranslationStructure = {
    ...
    connect: {
        ...
        restoreWithSecretKeyInstead: 'Inicia sessió amb clau secreta en lloc d’això',
    ...
    settings: {
        ...
        github: 'GitHub',
        machines: 'Màquines',
        remoteHostsTitle: 'Hosts remots',
        remoteHostsDesktopOnlyTitle: 'Els hosts remots només estan disponibles a l’escriptori',
        remoteHostsDesktopOnlySubtitle: 'Gestiona hosts SSH desats a l’escriptori.',
        remoteHostsManagementDisabledTitle: 'La gestió d’hosts remots està desactivada',
        remoteHostsManagementDisabledSubtitle: 'Aquesta versió no permet gestionar hosts remots.',
        remoteHostsEmptyTitle: 'No hi ha hosts remots',
        remoteHostsEmptySubtitle: 'Afegeix un host remot per reutilitzar credencials SSH a la configuració.',
        remoteHostsAddHost: 'Afegeix un host remot',
        remoteHostsAddHostTitle: 'Afegeix un host remot',
        remoteHostsEditHostTitle: 'Edita un host remot',
        remoteHostsHostGroupTitle: 'Servidor',
        remoteHostsSshGroupTitle: 'SSH',
        remoteHostsSecretMaterialGroupTitle: 'Material secret',
        remoteHostsSavePasswordLabel: 'Desa la contrasenya',
        remoteHostsPasswordSavedTitle: 'Contrasenya desada',
        remoteHostsPasswordSavedSubtitle: 'Deixa-ho en blanc per mantenir-la sense canvis.',
        remoteHostsStorePrivateKeyLabel: 'Desa la clau privada (xifrada)',
        remoteHostsPrivateKeyLabel: 'Clau privada',
        remoteHostsPrivateKeySavedHint: 'Ja hi ha una clau privada desada. Deixa-ho en blanc per mantenir-la sense canvis.',
        remoteHostsSecretMaterialDisabledTitle: 'El desament de secrets està desactivat',
        remoteHostsSecretMaterialDisabledSubtitle: 'Aquesta versió no permet emmagatzemar contrasenyes ni claus privades.',
        remoteHostsSetupAsMachineTitle: 'Configura com a màquina Happier',
        remoteHostsSetupAsMachineFailed: 'No s’ha pogut configurar aquest host com a màquina Happier.',
        remoteHostsConnectFromThisDeviceTitle: 'Connecta des d’aquest dispositiu',
        remoteHostsConnectFromThisDeviceSubtitle: 'Només aquest dispositiu. Obre un túnel SSH local per a aquesta sessió de l’app.',
        remoteHostsConnectFromThisDeviceFailed: 'No s’ha pogut obrir el túnel SSH local.',
        remoteHostsNativeSshTunnelRequiresEngine: 'Els túnels SSH natius necessiten la compilació del motor SSH natiu abans de poder iniciar-se des d’aquest dispositiu.',
        remoteHostsSshTunnelGroupTitle: 'Arriba a l’amfitrió remot des d’aquest dispositiu',
        remoteHostsSshTunnelActiveTitle: ({ host }: { host: string }) => `Túnel SSH actiu per a ${host}`,
        remoteHostsSshTunnelActiveSubtitle: ({ url }: { url: string }) => `Només aquest dispositiu. Punt final local: ${url}`,
        remoteHostsSshTunnelStopTitle: 'Atura el túnel SSH local',
        remoteHostsUseAsRelayHostTitle: 'Fes servir com a host de Relay',
        remoteHostsUseAsRelayHostSubtitle: 'Configura l’accés de Relay en aquest host SSH.',
        remoteHostsConfigureAccessTitle: 'Configura l’accés',
        remoteHostsConfigureAccessSubtitle: 'Tria com es pot accedir a aquest host remot.',
        remoteHostsOpenDetailsTitle: 'Detalls de l’host',
        remoteHostsRelayAccessGroupTitle: 'Accés remot',
        remoteHostsRelayAccessActiveTitle: ({ host }: { host: string }) => `Configurant l’accés per a ${host}`,
        remoteHostsRelayAccessActiveSubtitle: 'Les ordres d’accés de Relay s’executen a l’host remot per SSH. Això no crea cap túnel SSH.',
        remoteHostsMissingServerUrl: 'Selecciona un servidor abans de configurar una màquina remota.',
        remoteHostsRelayAccessIdentityFileRequired: 'L’accés de Relay en aquest host requereix un fitxer d’identitat SSH local.',
        remoteHostsTestConnectionTitle: 'Prova la connexió',
        remoteHostsInstallOrUpdateCliTitle: 'Instal·la o actualitza el CLI',
        remoteHostsDaemonServiceInstallOrUpdateTitle: 'Instal·la o actualitza el servei del dimoni',
        remoteHostsDaemonServiceStartTitle: 'Inicia el servei del dimoni',
        remoteHostsDaemonServiceStopTitle: 'Atura el servei del dimoni',
        remoteHostsDaemonServiceRestartTitle: 'Reinicia el servei del dimoni',
        remoteHostsRelayRuntimeStatusTitle: 'Estat de l’entorn d’execució del Relay',
        remoteHostsRelayRuntimeInstallOrUpdateTitle: 'Instal·la o actualitza l’entorn d’execució del Relay',
        remoteHostsRelayRuntimeStartTitle: 'Inicia l’entorn d’execució del Relay',
        remoteHostsRelayRuntimeStopTitle: 'Atura l’entorn d’execució del Relay',
        remoteHostsRelayRuntimeRestartTitle: 'Reinicia l’entorn d’execució del Relay',
        remoteHostsPortLine: ({ port }: { port: number }) => `Port: ${port}`,
        remoteHostsActiveTaskTitle: 'Tasca del sistema',
        remoteHostsHostTrustTitle: 'Confiar en l’host SSH?',
        remoteHostsReplaceHostKeyTitle: 'Voleu substituir la clau d’host SSH?',
        remoteHostsReplaceHostKeyAction: 'Substitueix la clau d’host',
        remoteHostsHostKeyCurrentFingerprintLabel: 'Empremta de confiança actual',
        remoteHostsHostKeyNewFingerprintLabel: 'Empremta nova',
        remoteHostsPasswordRequiredTitle: 'Cal la contrasenya SSH',
        remoteHostsRememberHostKeyTitle: 'Recordar aquesta clau d’host SSH?',
        remoteHostsRememberHostKeyAction: 'Confiar i recordar',
        remoteHostsTrustOnceAction: 'Confiar una vegada',
        remoteHostsPrivateKeyPassphraseTitle: 'Contrasenya de la clau privada SSH',
        remoteHostsKeyboardInteractiveTitle: 'Autenticació SSH',
        remoteHostsKeyboardInteractivePromptLabel: 'Sol·licitud SSH',
        remoteHostsTrustedHostKeysTitle: 'Claus d’host SSH de confiança',
        remoteHostsTrustedHostKeyRemoveTitle: 'Voleu eliminar la clau d’host SSH de confiança?',
        remoteHostsTrustedHostKeysClearTitle: 'Esborra les claus d’host SSH de confiança',
        remoteHostsConnectionSucceeded: 'Connexió correcta.',
        remoteHostsConnectionFailed: 'Ha fallat la connexió.',
        sshConfiguredHostPickerTitle: 'Hosts SSH suggerits',
        sshConfiguredHostPickerSubtitle: 'Emplena des de la configuració SSH local o known_hosts.',
        sshConfiguredHostPickerRefreshingSubtitle: 'Actualitzant suggeriments; es mostren els últims resultats.',
        sshConfiguredHostPickerSourceSshConfig: 'Configuració SSH',
        sshConfiguredHostPickerSourceKnownHosts: 'known_hosts',
        sshConfiguredHostPickerUnsupportedTitle: 'Introdueix els detalls SSH manualment',
        sshConfiguredHostPickerUnsupportedSubtitle: 'La detecció SSH local només està disponible a l’app d’escriptori.',
        sshConfiguredHostPickerLoadingTitle: 'Cercant hosts SSH…',
        sshConfiguredHostPickerLoadingSubtitle: 'Comprovant la configuració SSH local i known_hosts mitjançant el pont d’escriptori.',
        sshConfiguredHostPickerEmptyTitle: 'No hi ha hosts SSH suggerits',
        sshConfiguredHostPickerEmptySubtitle: 'Introdueix els detalls SSH manualment o actualitza després de canviar la configuració SSH.',
        sshConfiguredHostPickerErrorTitle: 'No s’han pogut carregar els suggeriments SSH',
        sshConfiguredHostPickerRefreshTitle: 'Actualitza els suggeriments SSH',
        sshConfiguredHostPickerRefreshingTitle: 'Actualitzant suggeriments SSH',
        features: 'Funcions',
        ...
        machineSetupCurrentMachineTitle: 'Configura aquest ordinador',
        ...
        machineSetupStepResolveRelay: 'S’estan comprovant els components existents',
        machineSetupStepCheckAuth: 'S’està comprovant l’estat d’inici de sessió',
        machineSetupStepConfigureRelay: 'S’està connectant al Relay',
        machineSetupStepAuthRequest: 'Aprova aquest ordinador',
        machineSetupStepAuthWait: 'S’està esperant l’aprovació',
        machineSetupStepInstallService: 'S’està instal·lant el servei en segon pla',
        machineSetupStepStartService: 'S’està iniciant el servei en segon pla',
        machineSetupStepVerifyService: 'S’està verificant el servei en segon pla',
        ...
        machineSetupRemoteSshUsernameLabel: 'Usuari SSH',
        machineSetupRemoteSshUsernamePlaceholder: 'ubuntu',
        machineSetupRemoteSshHostLabel: 'Amfitrió SSH',
        ...
        machineSetupRemoteSshAuthMethodLabel: 'Mètode d’autenticació',
        machineSetupRemoteSshAgentAuthLabel: 'Utilitza l’agent SSH',
        machineSetupRemoteSshKeyFileAuthLabel: 'Utilitza una clau privada',
        machineSetupRemoteSshPasswordAuthLabel: 'Utilitza una contrasenya',
        machineSetupRemoteSshIdentityFileLabel: 'Camí de la clau privada',
        machineSetupRemoteSshPrivateKeyMaterialLabel: 'Enganxa la clau privada',
        machineSetupRemoteSshPasswordLabel: 'Contrasenya SSH',
      ...
      installTitle: 'Instal·lació necessària',
      installSubtitle: 'Instal·la Tailscale i torna aquí.',
      loginTitle: 'Inici de sessió necessari',
      loginSubtitle: "Completa l'inici de sessió de Tailscale i torna aquí.",
      ...
      openInstallAction: 'Obre la descàrrega de Tailscale',
    ...
    relayAccess: {
      title: 'Accés al Relay',
      footer: 'Tria com el teu telèfon arriba a aquest Relay.',
      statusTitle: 'Estat',
      statusNotConfigured: 'Encara no configurat',
      statusWorking: "Comprovant l'accés al Relay",
      statusEnabled: 'Activat',
      statusDisabled: 'Desactivat',
      statusNeedsAuth: 'Inici de sessió necessari',
      statusError: 'Error',
      statusUnknown: 'Desconegut',
      shareableUrlTitle: 'URL compartible',
      methodTitle: "Mètode d'accés",
      saveAction: "Desa el mètode d'accés",
      disableAction: "Desactiva l'accés al Relay",
      refreshAction: "Actualitza l'estat d'accés",
      progressStepInspect: 'Inspecciona la configuració actual',
      progressStepCheck: "Comprova l'estat d'accés",
      progressStepPersist: "Desa la configuració d'accés",
      progressStepApply: "Aplica la configuració d'accés",
      progressStepVerify: "Verifica l'URL d'accés",
      progressStepDisable: "Desactiva l'accés al Relay",
      providers: {
        localOnly: {
          title: 'Només local',
          subtitle: "Només aquest ordinador pot accedir al Relay.",
        },
        lan: {
          title: 'LAN / URL personalitzat',
          subtitle: 'Fes servir un URL que ja tens (IP LAN o túnel).',
        },
        tailscaleServe: {
          title: 'Tailscale Serve',
          subtitle: 'URL privat per al teu tailnet (recomanat).',
        },
        tailscaleFunnel: {
          title: 'Tailscale Funnel',
          subtitle: 'URL públic via Funnel.',
        },
        cloudflareNamed: {
          title: 'Túnel de Cloudflare',
          subtitle: "URL públic via un túnel de Cloudflare amb nom.",
        },
      },
      fields: {
        urlLabel: 'URL del Relay',
        hostnameLabel: 'Nom del host',
        tokenLabel: 'Token',
      },
      missingUrl: 'Introdueix un URL del Relay per continuar.',
      missingHostname: 'Introdueix un nom del host per continuar.',
      missingToken: 'Introdueix un token per continuar.',
      webHandoffTitle: "Executa això a l'ordinador",
      webHandoffSubtitle: "Fes servir la CLI per configurar l'accés al relay, després torna aquí i actualitza.",
    },
    accessEndpoints: {
      status: {
        refreshing: 'Actualitzant els canals d’accés',
      },
      scope: {
        availableToOtherDevices: 'Disponible per a altres dispositius',
        thisDeviceOnly: 'Només aquest dispositiu',
      },
      direction: {
        makeCurrentServerReachable: 'Fes que aquest servidor sigui accessible',
        reachRemoteServerFromThisDevice: 'Arriba a un servidor remot des d’aquest dispositiu',
        unknown: 'Canal d’accés',
      },
      kind: {
        'relay-access-provider': 'Accés relay',
        'ssh-tunnel-desktop': 'Túnel SSH d’escriptori',
        'ssh-tunnel-native': 'Túnel SSH natiu',
        'server-profile-url': 'URL del servidor',
        'peer-mediation': 'Mediació entre parells',
        'manual-url': 'URL manual',
      },
      recommendedUse: {
        'multi-device': 'Millor per a altres dispositius',
        'native-this-device': 'Funciona en aquesta app nativa',
        'hosted-web': 'Funciona des del web allotjat',
        'lan-only': 'Només LAN o xarxa privada',
        diagnostic: 'Requereix atenció',
      },
      limitation: {
        'this-device-only': 'Només aquest dispositiu',
        'not-hosted-web-compatible': 'No disponible al web allotjat',
        'not-public-share-url': 'No és un URL públic per compartir',
        'session-scoped': 'Limitat a la sessió',
        'authentication-failed': 'L’autenticació SSH ha fallat',
        'foreground-only': 'Requereix mantenir l’app en primer pla',
        'host-key-mismatch': 'La clau SSH del host ha canviat',
        'host-key-rejected': 'S’ha rebutjat la clau SSH del host',
        'host-key-untrusted': 'La clau SSH del host encara no és de confiança',
        'platform-suspended': 'Pausat mentre l’app està suspesa',
        'loopback-bind-failed': 'No s’ha pogut vincular el port local del túnel',
        'network-captive-portal': 'La xarxa ha interceptat la connexió SSH',
        'remote-service-unreachable': 'No es pot arribar al servei remot a través del túnel',
        'requires-auth': 'Requereix autenticació SSH',
        'requires-host-key-trust': 'Requereix confiar en la clau del host',
      },
      remediation: {
        tailscale: {
          install: 'Instal·la Tailscale',
          login: 'Inicia sessió a Tailscale',
          serve: {
            enable: 'Activa Tailscale Serve',
            approve: 'Aprova Tailscale Serve',
          },
          funnel: {
            approve: 'Aprova Tailscale Funnel',
          },
        },
        cloudflare: {
          configure: 'Configura el túnel de Cloudflare',
        },
        serverProfile: {
          configureShareableUrl: 'Configura l’URL compartible',
        },
        remoteHost: {
          add: 'Afegeix un host remot',
          setup: 'Configura el host remot',
        },
        sshTunnel: {
          start: 'Inicia el túnel SSH',
          reuse: 'Usa el túnel SSH existent',
          stop: 'Atura el túnel SSH',
          authenticate: 'Autentica el túnel SSH',
          trustHost: 'Confia en la clau del host SSH',
        },
      },
    },
        ...
        systemTaskStepFinish: 'Acaba la configuració',
	        ...
	        systemTaskOpenLogs: 'Obre els registres',
	        systemTaskOpenLogsFailed: 'No s’ha pogut obrir la carpeta de registres.',
    ...
    connectedServices: {
        ...
        detail: {
            ...
            connectPersonalAccessTokenTitle: 'Connecta amb token d’accés personal',
            connectPersonalAccessTokenSubtitle: 'Enganxa un token d’accés personal granular',
            connectApiTokenTitle: 'Connecta amb token API',
            connectApiTokenSubtitle: 'Enganxa un token API del proveïdor o una contrasenya d’app',
            openTokenSetupTitle: 'Obre la configuració del token',
            openTokenSetupSubtitle: 'Obre la pàgina de configuració del proveïdor',
            openPersonalAccessTokenSetupTitle: 'Crea un token d’accés personal',
            openPersonalAccessTokenSetupSubtitle: 'Obre la configuració del token granular de GitHub',
            ...
            prompts: {
                ...
                personalAccessTokenTitle: 'Token d’accés personal',
                personalAccessTokenBody: 'Enganxa el teu token d’accés personal granular de GitHub.',
                personalAccessTokenPlaceholder: 'github_pat_…',
                apiTokenTitle: 'Token API',
                apiTokenBody: 'Enganxa el token API del proveïdor o una contrasenya d’app.',
    ...
    settingsSourceControl: {
        ...
        remoteConfirmation: {
            ...
            confirmBeforePulling: {
                title: 'Confirma abans de fer pull',
                subtitle: 'Pregunta abans de baixar i fusionar canvis remots.',
            },
            confirmBeforePushing: {
                title: 'Confirma abans de fer push',
                subtitle: 'Pregunta abans de pujar commits locals al remot.',
            },
            options: {
                always: {
    ...
    settingsPets: {
        ...
        disabledSubtitle: 'Activa l’experiment de mascotes per fer servir Blink en aquest dispositiu.',
    ...
    settingsNotifications: {
        activitySurfaces: {
            title: 'Superfícies d\'activitat',
            footer: 'Controla Live Activities, Dynamic Island i widgets en aquest dispositiu.',
            enabledSubtitle: 'Activa les superfícies de sessió visibles en aquest dispositiu',
            shared: {
                title: 'Comportament compartit',
                footer: 'Tria com s\'han de comportar els tocs i el contingut de previsualització a totes les superfícies d\'activitat.',
            },
            tapTargetTitle: 'Destí del toc',
            tapTargetOpenSessionTitle: 'Obre la sessió actual',
            tapTargetOpenSessionsTitle: 'Obre les sessions actives',
            privacyTitle: 'Privacitat',
            privacyStatusOnlyTitle: 'Només estat',
            privacyTitleOnlyTitle: 'Només títol',
            privacyIncludePreviewTitle: 'Inclou text de previsualització',
            liveActivities: {
                title: 'Live Activities',
                footer: 'Controla la presentació a la pantalla bloquejada i a Dynamic Island a l’iPhone.',
                enabledSubtitle: 'Activa les Live Activities en aquest dispositiu',
                strategyTitle: 'Activity strategy',
                strategySubtitle: 'Tria si una activitat segueix la sessió més important o es manté fixada.',
                focusedTitle: 'Sessió focalitzada',
                attentionTitle: 'Atenció',
                runningTitle: 'Sessions en curs',
                ...
                presentationSubtitle: 'Tria com les Live Activities han de destacar la sessió actual.',
                maxConcurrentTitle: 'Màxim d\'activitats simultànies',
                maxConcurrentOneTitle: '1 activitat',
                maxConcurrentTwoTitle: '2 activitats',
                maxConcurrentFourTitle: '4 activitats',
                previewTextTitle: 'Text de previsualització',
                actionButtonsTitle: 'Botons d\'acció',
                includeReadyTitle: 'Inclou sessions llestes',
                includeThinkingTitle: 'Inclou sessions pensant',
                remoteUpdates: {
                    title: 'Actualitzacions remotes',
                    footer: 'Diagnòstic del servidor seleccionat per actualitzar Live Activities quan l’app ja no és en primer pla.',
                    effectiveModeTitle: 'Lliurament efectiu',
                    effectiveMode: {
                        hosted_happier_relay: 'Relay allotjat',
                        direct_apns: 'APNs directe',
                        background_wake_best_effort: 'Reactivació en segon pla',
                        local_only: 'Només runtime local',
                        disabled: 'Desactivat',
                    },
                    details: {
                        ...
                        bestEffort: 'Millor esforç',
                        selected: 'Seleccionat',
                        fallback: 'Alternativa',
                        preferred_unavailable: 'Només local',
                        local_only: 'Només local',
                        disabled: 'Desactivat',
                        runtimeOnly: 'Només runtime',
                    },
                    hostedRelayTitle: 'Relay allotjat de Happier',
                    hostedRelayAvailableSubtitle: 'El relay allotjat està configurat per a aquest servidor seleccionat.',
                    hostedRelayDisabledSubtitle: 'El relay allotjat està desactivat per a aquest servidor self-hosted.',
                    hostedRelayBlockedSubtitle: 'La identitat del relay allotjat i el suport del proveïdor encara no estan implementats.',
                    hostedRelayUnavailableSubtitle: 'El relay allotjat no està disponible des d’aquest servidor seleccionat.',
                    directApnsTitle: 'APNs directe',
                    directApnsConfiguredSubtitle: 'Les credencials d’APNs directe estan configurades sense exposar material secret.',
                    directApnsMissingCredentialsSubtitle: 'A APNs directe li falta configuració de credencials del servidor.',
                    directApnsUnavailableSubtitle: 'APNs directe no està disponible per a aquest servidor seleccionat.',
                    backgroundWakeTitle: 'Reactivació en segon pla',
                    backgroundWakeBestEffortSubtitle: 'La reactivació en segon pla pot provar d’actualitzar, però iOS la pot ajornar o descartar.',
                    backgroundWakeDisabledSubtitle: 'L’alternativa de reactivació en segon pla està desactivada en aquest servidor seleccionat.',
                    localOnlyTitle: 'Actualitzacions només locals',
                    localOnlyRuntimeSubtitle: 'Les actualitzacions només locals funcionen mentre el runtime de l’app es pot executar; no prometen actualitzacions amb l’app tancada.',
                },
            },
            widgets: {
                title: 'Widgets de la pantalla d\'inici',
                footer: 'Controla la vista general dels widgets que es mostra a la pantalla d’inici del dispositiu.',
                enabledSubtitle: 'Activa els widgets en aquest dispositiu',
                summaryTitle: 'Resum',
                attentionTitle: 'Atenció',
                runningTitle: 'Sessions en curs',
                previewTextTitle: 'Text de previsualització',
                machinePathTitle: 'Màquina i ruta',
            },
        },
        badges: {
        ...
        quietHours: {
            title: 'Hores de silenci',
            footer: 'Les hores de silenci del compte s’apliquen arreu per defecte. Les substitucions del dispositiu només afecten aquest dispositiu.',
            accountOffTitle: 'Sense hores de silenci del compte',
            accountOffSubtitle: 'Lliura notificacions del compte en qualsevol moment',
            accountNightlyTitle: 'Cada nit, de 22:00 a 7:00',
            accountNightlySubtitle: 'Silencia o suprimeix canals d’atenció durant la nit',
            deviceAccountTitle: 'Aquest dispositiu segueix l’horari del compte',
            deviceAccountSubtitle: 'Fes servir la política sincronitzada d’hores de silenci del compte',
            deviceDisabledTitle: 'Desactiva les hores de silenci en aquest dispositiu',
            deviceDisabledSubtitle: 'Permet que aquest dispositiu lliuri fins i tot mentre les hores de silenci del compte són actives',
            deviceCustomNightlyTitle: 'Aquest dispositiu fa servir hores de silenci nocturnes',
            deviceCustomNightlySubtitle: 'Substitueix l’horari del compte amb 22:00 a 7:00 en aquest dispositiu',
        },
        sounds: {
            title: 'Sons',
            footer: 'Els sons predeterminats del compte se sincronitzen arreu. Aquest dispositiu pot silenciar sons locals.',
            accountHappierTitle: 'Sons de Happier',
            accountHappierSubtitle: 'Fes servir un to suau per a les actualitzacions i un de més clar quan cal atenció',
            accountDefaultTitle: 'Predeterminat del sistema',
            accountDefaultSubtitle: 'Fes servir el so de notificació de la plataforma',
            accountSilentTitle: 'Silenciós',
            accountSilentSubtitle: 'Lliura notificacions sense so',
            deviceEnabledTitle: 'Reprodueix sons en aquest dispositiu',
            deviceEnabledSubtitle: 'Substitució del dispositiu per als sons de notificació locals',
            previewTitle: 'Previsualització del so',
            previewSubtitle: 'Envia una notificació local de previsualització en aquest dispositiu',
            previewNotificationTitle: 'Previsualització del so de notificació',
            previewNotificationBody: 'Així es comportarà el so de notificació actual.',
        },
        push: {
        ...
        foregroundBehavior: {
            ...
            account: 'Predeterminat del compte',
            accountDescription: "Fes servir el comportament de notificacions dins l'app del compte en aquest dispositiu",
            full: 'Completes',
    ...
    notifications: {
        actions: {
            ...
            answer: 'Respondre',
            other: 'Altres',
            alwaysAllowTool: ({ tool }: { tool: string }) => `Permetre sempre ${tool}`,
        },
        activity: {
    ...
    settingsAppearance: {
        ...
        showLineNumbersInDiffs: 'Mostra els números de línia a les vistes de codi',
        showLineNumbersInDiffsDescription: 'Mostra els números de línia a les diferències, previsualitzacions de fitxers i editors',
        ...
        wrapLinesInDiffsDescription: 'Ajusta les línies llargues en lloc del desplaçament horitzontal a les diferències, previsualitzacions de fitxers i editors',
    ...
    settingsFeatures: {
        ...
        expLiveActivitiesSubtitle: 'Activa les superfícies de Live Activities i Dynamic Island d’iOS',
        expHomeScreenWidgets: 'Widgets de la pantalla d’inici',
        expHomeScreenWidgetsSubtitle: 'Activa les superfícies de widgets de la pantalla d’inici d’iOS',
        voice: 'Veu',
        ...
        expVoiceDaemonInference: 'Inferència de veu del daemon',
        expVoiceDaemonInferenceSubtitle: 'Activa les superfícies locals de TTS/STT neural del daemon (requereix Agent de veu)',
  ...
  newSession: {
    ...
    // Used by new-session screen and launch flows
        ...
        ghCliInstallModal: {
            ...
            description: 'Això instal·la la dependència opcional GitHub CLI utilitzada pels fluxos de control de codi de GitHub després de la confirmació.',
        },
    },
    ...
    session: {
        ...
        forking: {
	        ...
	        rollback: {
	            ...
	            checkpointCode: {
	                title: 'Opcions de reversio',
	                conversationUnavailable: 'La reversio de la conversa no esta disponible per a aquesta sessio.',
	                codeOnlyConfirmation: 'Entenc que la conversa no canviara.',
	                showAdvanced: 'Mostra opcions avancades nomes de codi',
	                choices: {
	                    conversation_only: {
	                        title: 'Només conversa',
	                        description: 'Reverteix la transcripcio sense canviar fitxers.',
	                    },
	                    conversation_and_code_with_stash: {
	                        title: 'Conversa i codi, amb Git stash',
	                        description: 'Crea un punt de copia de Happier, desa els canvis amb stash i aplica el patch invers.',
	                    },
	                    conversation_and_code_without_stash: {
	                        title: 'Conversa i codi, sense Git stash',
	                        description: 'Crea un punt de copia de Happier i aplica el patch invers en aquest worktree.',
	                    },
	                    code_only_with_stash: {
	                        title: 'Només codi, amb Git stash',
	                        description: 'Avançat: deixa la transcripcio igual i reverteix fitxers despres del stash.',
	                    },
	                    code_only_without_stash: {
	                        title: 'Només codi, sense Git stash',
	                        description: 'Avançat: deixa la transcripcio igual i reverteix fitxers amb la copia de Happier.',
	                    },
	                },
	            },
	        },
          ...
          machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
            ...
            machineOfflineCannotResume: 'La màquina està fora de línia. Torna-la a posar en línia per reprendre aquesta sessió.',
                ...
                actionMenu: {
                    ...
                    backgroundFollow: 'Segueix en segon pla',
                },
              detailsPanel: {
                  emptyTitle: 'No hi ha cap pestanya oberta',
                  emptyHint: 'Obre un fitxer, diff o terminal des d’una altra pestanya.',
                  unsupportedTab: 'Pestanya de detalls no compatible.',
                        ...
                        enterFocusModeA11y: 'Entra al mode d’enfocament del panell',
                        exitFocusModeA11y: 'Surt del mode d’enfocament del panell',
              },
    ...
    commandPalette: {
      ...
      devVoiceQa: {
        ...
        recordedAudio: {
          title: "QA de STT amb àudio enregistrat",
          uriLabel: "URI de l'àudio enregistrat",
          uriPlaceholder: "file:///recording.wav o tria un fitxer web",
          daemonPackIdLabel: "Substitució de l'ID del paquet STT del daemon",
          daemonPackIdPlaceholder: "Opcional: aplica la configuració QA de STT daemon local_neural abans de transcriure",
          daemonMachineIdLabel: "Substitució de l'ID de màquina del daemon",
          daemonMachineIdPlaceholder: "Opcional: inicialitza un objectiu de màquina per a l'ID de sessió d'àudio enregistrat",
          daemonBasePathLabel: "Substitució del camí base del daemon",
          daemonBasePathPlaceholder: "Opcional: inicialitza el camí base de la màquina per al STT del daemon",
          chooseFile: "Tria àudio enregistrat",
    ...
    server: {
        ...
        reachabilityRemediation: {
            failedToOpenInstallLink: 'No s’ha pogut obrir la pàgina d’instal·lació de Tailscale.',
            tailscale: {
                title: 'Aquest relay fa servir Tailscale',
                desktopBody: 'Aquest ordinador no ha pogut arribar al relay per Tailscale. Pot ser que Tailscale no estigui instal·lat, que no s’hagi iniciat la sessió o que no estigui connectat a la tailnet correcta en aquest ordinador.',
                webBody: 'Aquest navegador no ha pogut arribar al relay per Tailscale. Obre Tailscale en aquest dispositiu, assegura’t que està connectat a la tailnet correcta i torna-ho a provar.',
                nativeBody: 'Aquest dispositiu no ha pogut arribar al relay per Tailscale. Obre Tailscale, assegura’t que està connectat a la tailnet correcta i torna-ho a provar.',
                installAction: 'Instal·la Tailscale',
    ...
    sessionsList: {
        ...
        emptyState: {
            title: 'Encara no hi ha sessions',
            description: 'Inicia una sessió en una de les teves màquines en línia.',
            descriptionPrefix: 'Inicia una sessió en una de les teves màquines amb ',
            descriptionSuffix: ' al terminal, o bé fent servir els botons de sota.',
            actionsTitle: 'Inicia una sessió',
            startSessionOnMachine: ({ machine }: { machine: string }) => `Inicia una sessió a ${machine}`,
            startSessionOnMachineSubtitle: 'Tria una carpeta i obre-hi una nova sessió en aquesta màquina.',
            reconnectMachineActionSubtitle: 'Torna a connectar el servei en segon pla perquè aquesta màquina pugui iniciar sessions de nou.',
            startDaemonActionSubtitle: 'Instal·la o reinicia el servei en segon pla necessari per iniciar sessions.',
        },
    ...
    sourceControlWorkspace: {
        ...
        openInSplitRight: 'Obre en divisió a la dreta',
        openInSplitDown: 'Obre en divisió a sota',
        revealInCurrentSplit: 'Mostra en la divisió actual',
    ...
    toolView: {
      ...
      files: {
        ...
        worktrees: 'Arbres de treball',
          ...
          agentReportedTurnChanges: ({ count }: { count: number }) => `Últim torn informat per l’agent (${count})`,
          checkpointTurnChanges: ({ count }: { count: number }) => `Últim torn del checkpoint (${count})`,
          ...
          agentReportedTurnDescription: 'Fitxers informats per l’agent/runtime per a l’últim torn completat.',
          ...
          checkpointAttributionShared: 'El contingut del checkpoint és exacte per a l’interval del repositori. L’atribució és limitada perquè aquest worktree era compartit.',
          checkpointAttributionUnknown: 'El contingut del checkpoint és exacte per a l’interval del repositori. L’atribució de l’actor és desconeguda.',
          checkpointUnavailable: 'L’evidència del checkpoint no està disponible per a aquest torn.',
...
settingsSession: {
            sessionList: {
                ...
                orderingTitle: 'Ordenació',
                orderingSubtitle: 'Tria com s’ordenen les sessions a la llista',
                orderingOptions: {
          ...
          sessionCreation: {
            ...
            mobileWorkspaceExperience: {
                ...
                title: 'Espai de treball mòbil',
                subtitle: 'Tria la disposició predeterminada de sessió mòbil.',
                options: {
                    cockpitTitle: 'Tauler de control',
                    cockpitSubtitle: 'Fes servir la barra de pestanyes inferior per al xat, fitxers, Git, pestanyes i terminal.',
                    classicTitle: 'Clàssic',
                    classicSubtitle: 'Fes servir la disposició mòbil anterior d’una sola pantalla.',
                },
            },
            input: {
                title: 'Entrada',
        ...
        local: {
            ...
            kokoro: {
                ...
                assetPack: {
                    ...
                    subtitleWeb: 'Selecciona el paquet de model del daemon. Kokoro identifica la família del model, no un runtime del navegador.',
                },
                model: {
                    title: 'Model Kokoro',
                    subtitleNative: 'Descarrega els fitxers necessaris per habilitar síntesi al dispositiu.',
                    subtitleWeb: 'Gestionat pel servei de paquets de model del daemon de veu.',
                },
                modelStatus: {
                ...
                voice: {
                    ...
                    subtitleWeb: 'Tria la veu de Kokoro enviada al daemon per a les respostes.',
                ...
                web: {
                    warmingUp: 'Preparant…',
                    clearCache: {
                        confirmTitle: 'Vols eliminar els fitxers de model del daemon?',
                        confirmBody: 'Això eliminarà els fitxers de model i veu del daemon descarregats per a aquest paquet.',
                    ...
                    cache: {
                        title: 'Fitxers de model del daemon',
                        subtitle: 'Gestiona els fitxers de model del daemon descarregats per a aquest paquet.',
                    },
                },
            },
            localNeuralStt: {
            ...
            ttsProviderSubtitle: 'Tria TTS del dispositiu, un endpoint compatible amb OpenAI o TTS neural local amb daemon',
    ...
    releaseNotes: {
        ...
        onboardingShowcase: {
            ...
            subtitle: 'Sessions de codi que et segueixen a tot arreu.',
            cards: {
                welcome: {
                    title: 'Pensat per al ritme',
                ...
                cockpit: {
                    title: "El teu centre de comandament mòbil",
                    body: "Una vista mòbil enfocada per a agents actius, amb accés en un toc a xat, fitxers, Git, terminal i detalls.",
                    alt: "Imatge abstracta de marcador per al centre de comandament.",
                ...
                reviewComments: {
                    title: "Revisa i arregla codi fàcilment",
                    body: "Deixa comentaris en línies exactes de fitxers o diffs, tria què incloure i envia context estructurat a un agent.",
                ...
                pets: {
                    title: "Coneix Pets",
                    body: "Un petit company que t’ajuda a mantenir el focus entre sessions. Útil? Potser. Encantador? Sens dubte.",
                    alt: "Imatge abstracta de marcador per al company pet.",
