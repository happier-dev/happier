...
export const ca: TranslationStructure = {
    settingsKeyboard: {
        ...
        entrySubtitle: 'Descobreix i controla les dreceres de l\'aplicació',
        generalGroupTitle: 'Controls de teclat',
        generalGroupFooter: 'Les preferències de dreceres es desen localment en aquest dispositiu.',
        enableShortcutsTitle: 'Activa les dreceres unificades',
        enableShortcutsSubtitle: 'Fes servir el nou registre d\'ordres de teclat per a les dreceres de l\'aplicació.',
        singleKeyTitle: 'Dreceres d\'una sola tecla',
        singleKeySubtitle: 'Permet dreceres com ? quan no hi ha cap entrada de text enfocada.',
        conflictsTitle: ({ count }: { count: number }) => `${count} conflicte${count === 1 ? '' : 's'} de drecera detectat${count === 1 ? '' : 's'}`,
        conflictsSubtitle: ({ count }: { count: number }) => `${count} ordre${count === 1 ? ' necessita' : 's necessiten'} revisió abans que totes les dreceres puguin estar actives.`,
        ...
        resetCommandAccessibility: ({ command }: { command: string }) => `Restableix la drecera de ${command}`,
        commands: {
            composerAbortConfirm: 'Confirma l\'avortament',
            composerFocus: 'Enfoca el redactor',
            composerSendImmediate: 'Envia immediatament',
            commandPaletteOpen: 'Obre la paleta d\'ordres',
            modeCycle: 'Canvia de mode',
            permissionCycle: 'Canvia els permisos',
            ...
            transcriptMessageNext: 'Missatge següent de la transcripció',
            transcriptMessagePrevious: 'Missatge anterior de la transcripció',
            transcriptScrollBottom: 'Desplaça la transcripció fins al final',
            transcriptScrollPageDown: 'Desplaça una pàgina avall la transcripció',
            transcriptScrollPageUp: 'Desplaça una pàgina amunt la transcripció',
            transcriptScrollTop: 'Desplaça la transcripció fins a dalt',
        },
    },
    tabs: {
    ...
    settingsAppearance: {
        ...
        settingsNavSidebarDescription: 'Mostra la barra lateral de configuració a les sessions (web/tablet)',
...
deps: {
  ...
  newSession: {
        ...
        reviewFindings: {
            ...
            pendingMessages: {
                ...
                indicator: ({ count }: { count: number }) => `Pendent (${count})`,
	                ...
	                nonSteerableNotice: 'El torn actual no pot acceptar steering després d’aquest canvi de mode. S’executarà després, o fes servir Envia ara per interrompre.',
	                actions: {
                    up: 'Amunt',
                    down: 'Avall',
                  edit: 'Edita',
    ...
    commandPalette: {
        ...
        shortcutsHelpNewSession: 'Sessió nova',
        commands: {
    ...
    sessionsList: {
        ...
        failedToMoveSessionToFolder: 'No s’ha pogut moure la sessió a aquesta carpeta.',
        ...
        renameFolderPromptTitle: 'Canvia el nom de la carpeta',
        deleteFolderPromptTitle: 'Suprimir carpeta?',
        deleteFolderPromptDescription: 'Les sessions d’aquesta carpeta es mouran a la carpeta pare o a l’arrel de l’espai de treball.',
    },
    ...
    sourceControlWorkspace: {
        ...
        openInSplitRight: 'Obre en una divisió a la dreta',
        openInSplitDown: 'Obre en una divisió a sota',
        revealInCurrentSplit: 'Mostra a la divisió actual',
    ...
    toolView: {
      ...
      files: {
        ...
        stagedChanges: ({ count }: { count: number }) => `Canvis preparats (${count})`,
          ...
          openReviewCommentsFailed: "No s'han pogut obrir els comentaris de revisió",
            ...
            sessionMedia: {
                ...
                unavailableImageA11y: ({ name }: { name: string }) => `Imatge no disponible: ${name}`,
                previewUnavailableA11y: 'Previsualització no disponible',
            },
        ...
        fileActions: {
            ...
            selectEntireFileForCommit: 'Selecciona tot el fitxer',
            rangeSelection: 'Interval',
        ...
        sourceControlOperations: {
            ...
            update: {
                ...
                publishRepository: {
                    ...
                    originConflictRemediation: 'Tria com gestionar l’origin existent abans de publicar.',
                    commitRequired: 'Fes commit dels canvis pendents abans de publicar.',
                    unsafeUrl: 'Happier ha bloquejat una URL de seguiment no segura.',
                    auth: {
                        connectedAccountReady: 'La connexió de GitHub està preparada.',
                        providerCliReady: 'gh CLI està autenticat.',
                    },
                    remediation: {
                        connectGitHub: 'Connecta GitHub',
                        installGh: 'Instal·la gh CLI',
                        useManagedGh: 'Utilitza gh CLI gestionat',
                        authenticateGh: 'Autentica gh CLI',
                        openBrowser: 'Obre al navegador',
                    },
                    errors: {
...
settingsSession: {
	            sessionList: {
	                ...
	                orderingTitle: 'Opcions de la llista de sessions',
	                orderingSubtitle: 'Tria com s’agrupen i es mostren les sessions.',
	                orderingOptions: {
	                ...
	                folderTreeView: 'Arbre de carpetes',
          ...
          sessionCreation: {
              ...
              rememberLastEngineSelectionsTitle: 'Recorda les últimes seleccions de motor',
              rememberLastEngineSelectionsEnabledSubtitle: 'Les sessions noves reutilitzen l’últim model, mode i opcions de motor per a cada servidor i motor.',
              rememberLastEngineSelectionsDisabledSubtitle: 'Les sessions noves comencen amb els valors predeterminats del motor si cap esborrany o drecera no aporta seleccions.',
      ...
      machine: {
        ...
        renameTitle: 'Canvia el nom de la màquina',
          ...
          replacementRepair: {
              ...
              chooseReplacementSubtitle: 'Tria la màquina que ha substituït aquesta.',
              pickerTitle: 'Tria la màquina substituta',
              pickerCandidatesTitle: 'Màquines disponibles',
