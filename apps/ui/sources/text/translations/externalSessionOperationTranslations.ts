...
export const externalSessionOperationTranslations = {
    ...
    ca: translated({
        ...
        externalAgentStatusOnMachine: ({ agent, machine, status }) => `${agent} a ${machine}: ${status}`,
    ...
    es: translated({
        ...
        externalAgentStatusOnMachine: ({ agent, machine, status }) => `${agent} en ${machine}: ${status}`,
    ...
    it: translated({
        ...
        externalAgentStatusOnMachine: ({ agent, machine, status }) => `${agent} su ${machine}: ${status}`,
    ...
    ja: translated({
        ...
        externalAgentStatusOnMachine: ({ agent, machine, status }) => `${machine} 上の ${agent}: ${status}`,
        ...
        operationImportCountEstimated: ({ imported, total }: { imported: number; total: number }) => `約 ${total} 件中 ${imported} 件`,
    ...
    pl: translated({
        ...
        externalAgentStatusOnMachine: ({ agent, machine, status }) => `${agent} na ${machine}: ${status}`,
    ...
    pt: translated({
        ...
        externalAgentStatusOnMachine: ({ agent, machine, status }) => `${agent} em ${machine}: ${status}`,
    ...
    ru: translated({
        ...
        externalAgentStatusOnMachine: ({ agent, machine, status }) => `${agent} на ${machine}: ${status}`,
    ...
    zhHans: translated({
        ...
        externalAgentStatusOnMachine: ({ agent, machine, status }) => `${machine} 上的 ${agent}：${status}`,
        ...
        operationImportCountEstimated: ({ imported, total }: { imported: number; total: number }) => `约 ${total} 条消息中已导入 ${imported} 条`,
    ...
    zhHant: translated({
        ...
        operationImportCountEstimated: ({ imported, total }: { imported: number; total: number }) => `約 ${total} 則訊息中已匯入 ${imported} 則`,
