...
const settingsAppearanceTranslationExtension = {
  ...
  settingsNavSidebarDescription: 'Pokaż pasek boczny nawigacji ustawień na komputerze i tablecie',
  mobileWorkspaceExperience: 'Tryb mobilnej przestrzeni roboczej',
  mobileWorkspaceExperienceDescription: 'Wybierz, jak sesje i projekty otwierają się na telefonie',
...
const settingsSessionHandoffTranslationExtensions = {
  pl: {
    ...
    directTargetMode: {
      ...
      convertToPersistedTitle: 'Przeksztalc na Happier',
      convertToPersistedSubtitle: 'Zaimportuj transkrypt i kontynuuj jako sesje zarzadzana przez Happier.',
    },
  },
} as const;
...
export const pl: TranslationStructure = {
  ...
  connect: {
    ...
    restoreWithSecretKeyInstead: "Zaloguj się kluczem tajnym zamiast tego",
  ...
  memorySearchSettings: {
    ...
    embeddings: {
      ...
      settings: {
        ...
        settingsPlugins: {
          ...
          reloadAction: "Przeładuj",
          reloadSubtitle: "Przeładuj tę wtyczkę i odśwież jej projektowane opisy.",
    ...
    machineSetupCurrentMachineTitle: "Skonfiguruj ten komputer",
    ...
    machineSetupRemoteSshKeyFileAuthLabel: "Użyj klucza prywatnego",
    machineSetupRemoteSshPasswordAuthLabel: "Użyj hasła",
    machineSetupRemoteSshIdentityFileLabel: "Ścieżka do klucza prywatnego",
...
settingsPets: {
  ...
  settingsAppearance: {
    ...
    showLineNumbersInDiffs: "Pokaż numery linii w widokach kodu",
    showLineNumbersInDiffsDescription:
      "Wyświetlaj numery linii w różnicach, podglądach plików i edytorach",
    ...
    wrapLinesInDiffs: "Zawijanie linii w widokach kodu",
    wrapLinesInDiffsDescription:
      "Zawijaj długie linie zamiast przewijania poziomego w różnicach, podglądach plików i edytorach",
  ...
  settingsFeatures: {
    ...
    voiceSubtitle: "Włącz funkcje głosowe",
      ...
      expVoiceDaemonInference: "Inferencja głosowa daemona",
      expVoiceDaemonInferenceSubtitle:
        "Włącz lokalne neuronowe powierzchnie TTS/STT w daemonie (wymaga Agenta głosowego)",
  ...
  session: {
    ...
    machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
      ...
      detailsPanel: {
        ...
        emptyHint: "Otwórz plik, diff lub terminal z innej karty.",
...
settingsSession: {
      sessionList: {
          ...
          orderingTitle: 'Kolejność',
          orderingSubtitle: 'Wybierz sposób sortowania sesji na liście',
          orderingOptions: {
    ...
    local: {
      ...
      kokoro: {
        ...
        assetPack: {
          ...
          subtitleWeb: "Wybierz pakiet modelu daemona. Kokoro oznacza rodzinę modelu, a nie runtime przeglądarkowy.",
        },
        model: {
          title: "Model Kokoro",
          subtitleNative:
            "Pobierz wymagane pliki, aby włączyć syntezę na urządzeniu.",
          subtitleWeb: "Zarządzane przez usługę pakietów modeli daemona głosowego.",
        },
        modelStatus: {
        ...
        voice: {
          ...
          subtitleWeb: "Wybierz głos Kokoro wysyłany do daemona dla odpowiedzi.",
        ...
        web: {
          ...
          clearCache: {
            confirmTitle: "Usunąć pliki modelu daemona?",
            confirmBody:
              "To usunie pobrane pliki modelu i głosu daemona dla tego pakietu.",
          ...
          cache: {
            title: "Pliki modelu daemona",
            subtitle: "Zarządzaj pobranymi plikami modelu daemona dla tego pakietu.",
          },
        },
      },
      localNeuralStt: {
      ...
      ttsProviderSubtitle:
        "Wybierz TTS urządzenia, endpoint zgodny z OpenAI lub lokalne neuralne TTS przez daemon",
      daemonInference: {
        execution: {
  ...
  changelog: {
    ...
    onboardingShowcase: {
      ...
      subtitle: "Sesje kodowania, które towarzyszą Ci wszędzie.",
      cards: {
        welcome: {
          title: "Stworzony dla tempa",
        ...
        cockpit: {
            title: "Twoje mobilne centrum dowodzenia",
            body: "Skupiony widok mobilny dla aktywnych agentów, z dostępem jednym stuknięciem do czatu, plików, Git, terminala i szczegółów.",
            alt: "Abstrakcyjny obraz zastępczy centrum dowodzenia.",
        ...
        reviewComments: {
            title: "Łatwe review i poprawki kodu",
            body: "Komentuj dokładne linie plików lub diffów, wybierz co dołączyć i wyślij uporządkowany kontekst do agenta.",
            alt: "Abstrakcyjny obraz zastępczy komentarzy review.",
        ...
        pets: {
            title: "Poznaj Pets",
            body: "Mały towarzysz, który pomaga utrzymać rytm między sesjami. Przydatne? Może. Urocze? Zdecydowanie.",
            alt: "Abstrakcyjny obraz zastępczy towarzysza pet.",
  ...
  setupOnboarding: {
          ...
          relayDiagramPhoneLabel: 'Telefon',
          relayDiagramRelayLabel: 'Przekaźnik',
          relayDiagramThisComputerLabel: 'Ten komputer',
