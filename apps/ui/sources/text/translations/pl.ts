...
export const pl: TranslationStructure = {
    settingsKeyboard: {
        ...
        entrySubtitle: 'Odkrywaj skróty aplikacji i zarządzaj nimi',
        generalGroupTitle: 'Sterowanie klawiaturą',
        generalGroupFooter: 'Preferencje skrótów są zapisywane lokalnie na tym urządzeniu.',
        enableShortcutsTitle: 'Włącz ujednolicone skróty',
        enableShortcutsSubtitle: 'Używaj nowego rejestru poleceń klawiatury dla skrótów aplikacji.',
        singleKeyTitle: 'Skróty jednoklawiszowe',
        singleKeySubtitle: 'Zezwalaj na skróty takie jak ?, gdy pole tekstowe nie jest aktywne.',
        conflictsTitle: ({ count }: { count: number }) => `Wykryto ${count} konflikt${count === 1 ? '' : 'y'} skrótów`,
        conflictsSubtitle: ({ count }: { count: number }) => `${count} polece${count === 1 ? 'nie wymaga' : 'ń wymaga'} przeglądu, zanim wszystkie skróty będą aktywne.`,
        ...
        resetCommandAccessibility: ({ command }: { command: string }) => `Zresetuj skrót polecenia ${command}`,
        commands: {
            ...
            permissionCycle: 'Przełącz uprawnienia',
            ...
            transcriptMessageNext: 'Następna wiadomość transkrypcji',
            transcriptMessagePrevious: 'Poprzednia wiadomość transkrypcji',
  ...
  settingsAppearance: {
    ...
    settingsNavSidebarDescription:
      "Pokazuj pasek boczny ustawień w sesjach (web/tablet)",
      ...
      pendingMessages: {
        ...
        badgeLabel: ({ count }: { count: number }) =>
          count > 0 ? `Oczekujące (+${count})` : "Oczekujące",
	        ...
	        nonSteerableNotice: "Bieżąca tura po tej zmianie trybu nie może przyjąć steeringu. Wiadomość uruchomi się jako następna albo użyj Wyślij teraz, aby przerwać.",
	        actions: {
          up: "W górę",
          down: "W dół",
          edit: "Edytuj",
  ...
  sessionsList: {
    ...
    workspaceRoot: 'Główny folder obszaru roboczego',
    moveToFolder: 'Przenieś do folderu',
    failedToMoveSessionToFolder: 'Nie udało się przenieść sesji do tego folderu.',
    ...
    deleteFolderPromptTitle: 'Usunąć folder?',
    deleteFolderPromptDescription: 'Sesje w tym folderze zostaną przeniesione do folderu nadrzędnego albo do głównego folderu obszaru roboczego.',
  },
  ...
  files: {
    ...
    stagedChanges: ({ count }: { count: number }) =>
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        sessionMedia: {
          ...
          unavailableImageA11y: ({ name }: { name: string }) => `Obraz niedostępny: ${name}`,
          previewUnavailableA11y: "Podgląd niedostępny",
        },
    ...
    fileActions: {
      ...
      selectEntireFileForCommit: "Wybierz cały plik",
      rangeSelection: "Zakres",
    ...
    sourceControlOperations: {
      ...
      update: {
        ...
        publishRepository: {
          ...
          originConflictRemediation: "Wybierz, jak obsłużyć istniejący origin przed publikacją.",
          commitRequired: "Zacommituj oczekujące zmiany przed publikacją.",
          unsafeUrl: "Happier zablokował niebezpieczny URL dalszego działania.",
          auth: {
            connectedAccountReady: "Połączenie z GitHub jest gotowe.",
            providerCliReady: "gh CLI jest uwierzytelnione.",
          },
          remediation: {
            connectGitHub: "Połącz GitHub",
            installGh: "Zainstaluj gh CLI",
            useManagedGh: "Użyj zarządzanego gh CLI",
            authenticateGh: "Uwierzytelnij gh CLI",
  ...
  executionRuns: {
    ...
    details: {
      ...
      timestamps: {
        ...
        detailSearchPlaceholder: 'Wyszukaj powierzchnie',
        ...
        invalidActionSubtitle: 'Ta akcja nie jest już dostępna w tej kompilacji.',
...
settingsSession: {
	      sessionList: {
	          ...
	          orderingTitle: 'Opcje listy sesji',
	          orderingSubtitle: 'Wybierz sposób grupowania i wyświetlania sesji.',
	          orderingOptions: {
	          ...
	          folderTreeView: 'Drzewo folderów',
      ...
      sessionCreation: {
        ...
        rememberLastEngineSelectionsTitle: "Zapamiętuj ostatnie wybory silnika",
        rememberLastEngineSelectionsEnabledSubtitle:
          "Nowe sesje używają ostatniego modelu, trybu i opcji silnika dla każdego serwera i silnika.",
        rememberLastEngineSelectionsDisabledSubtitle:
          "Nowe sesje zaczynają od domyślnych ustawień silnika, chyba że szkic lub skrót poda wybory.",
    ...
    renameDescription:
      ...
      replacementRepair: {
        ...
        chooseReplacementSubtitle:
          "Wybierz maszynę, która zastąpiła tę maszynę.",
        pickerTitle: "Wybierz maszynę zastępczą",
        pickerCandidatesTitle: "Dostępne maszyny",
