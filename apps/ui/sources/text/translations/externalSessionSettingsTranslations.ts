const en = {
    ...
    browseRouteUnavailableTitle: 'External sessions are unavailable here',
    browseRouteUnavailableSubtitle: 'This server does not offer external session browsing. Go back and pick another server, or try again later.',
    browseRouteAvailabilityUnknownTitle: 'Could not confirm external session support',
    browseRouteAvailabilityUnknownSubtitle: 'Happier could not check whether this server offers external session browsing. Go back and try again in a moment.',
};
...
export const externalSessionSettingsTranslations = {
    ...
    settingsRestoreUpdateFailed: 'Happier konnte die Einstellung zum Folgen nach dem Neustart nicht ändern. Versuch es noch einmal.',
    ...
    settingsAutoLinkGroupFooter: 'Automatisches Verknüpfen ist standardmäßig aus und unabhängig von der Einrichtung der Agent-Integration und vom passiven Folgen.',
    ...
    settingsManageAllSubtitle: 'Integrationen und passives Folgen über verbundene Rechner hinweg prüfen.',
    settingsMachineOnline: 'Online',
    settingsMachineOffline: 'Offline',
    ...
    browseAnnotationsIncomplete: 'Einige Verknüpfungs- und Import-Status ließen sich nicht bestätigen. Wenn du eine nicht verknüpfte Session öffnest, wird ihr aktueller Status geprüft.',
