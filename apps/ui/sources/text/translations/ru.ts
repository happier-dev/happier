...
export const ru: TranslationStructure = {
  ...
  connect: {
    ...
    restoreWithSecretKeyInstead: "Войти с секретным ключом вместо этого",
  ...
  settingsPlugins: {
    ...
    reloadSubtitle: "Перезагрузить этот плагин и обновить его спроецированные дескрипторы.",
  ...
  settings: {
    ...
    machineSetupCurrentMachineTitle: "Настроить этот компьютер",
    ...
    machineSetupRemoteSshKeyFileAuthLabel: "Использовать приватный ключ",
    machineSetupRemoteSshPasswordAuthLabel: "Использовать пароль",
    machineSetupRemoteSshIdentityFileLabel: "Путь к приватному ключу",
  ...
  settingsFeatures: {
    ...
    expVoiceDaemonInference: "Голосовой инференс демона",
    expVoiceDaemonInferenceSubtitle: "Включить локальные нейронные поверхности TTS/STT в демоне (требуется Голосовой агент)",
  ...
  session: {
    ...
    machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
      ...
      detailsPanel: {
        ...
        emptyHint: "Откройте файл, diff или терминал на другой вкладке.",
...
settingsSession: {
    sessionList: {
        ...
        orderingTitle: 'Сортировка',
        orderingSubtitle: 'Выберите, как упорядочивать сессии в списке',
        orderingOptions: {
    ...
    local: {
      ...
      kokoro: {
        ...
        assetPack: {
          ...
          subtitleWeb: "Выберите пакет модели daemon. Kokoro обозначает семейство модели, а не браузерный runtime.",
        },
        model: {
          title: "Модель Kokoro",
          subtitleNative: "Скачайте необходимые файлы для синтеза на устройстве.",
          subtitleWeb: "Управляется сервисом пакетов моделей голосового daemon.",
        },
        modelStatus: {
        ...
        voice: {
          ...
          subtitleWeb: "Выберите голос Kokoro, отправляемый daemon для ответов.",
        ...
        web: {
          ...
          clearCache: {
            confirmTitle: "Удалить файлы модели daemon?",
            confirmBody:
              "Это удалит скачанные файлы модели и голоса daemon для этого пакета.",
          ...
          cache: {
            title: "Файлы модели daemon",
            subtitle: "Управляйте скачанными файлами модели daemon для этого пакета.",
          },
        },
      },
      localNeuralStt: {
      ...
      ttsProviderSubtitle:
        "Выберите TTS на устройстве, OpenAI-совместимый эндпоинт или локальный нейросетевой TTS через daemon",
      daemonInference: {
        execution: {
  ...
  changelog: {
    ...
    onboardingShowcase: {
      ...
      subtitle: "Сессии кодинга, которые следуют за вами повсюду.",
      cards: {
        welcome: {
          title: "Создано для ритма",
        ...
        cockpit: {
            title: "Ваш мобильный командный центр",
            body: "Сфокусированный мобильный вид для активных агентов с доступом в одно касание к чату, файлам, Git, терминалу и деталям.",
            alt: "Абстрактное изображение-заглушка командного центра.",
        ...
        reviewComments: {
            title: "Проще ревью и исправление кода",
            body: "Комментируйте точные строки файлов или diff, выбирайте что включить и отправляйте структурированный контекст агенту.",
            alt: "Абстрактное изображение-заглушка комментариев ревью.",
        ...
        pets: {
            title: "Знакомьтесь: Pets",
            body: "Маленький спутник, который помогает не терять фокус между сессиями. Полезно? Возможно. Очаровательно? Точно.",
            alt: "Абстрактное изображение-заглушка pet-компаньона.",
  ...
  setupOnboarding: {
    ...
    relayDiagramPhoneLabel: "Телефон",
    relayDiagramRelayLabel: "Реле",
    relayDiagramThisComputerLabel: "Этот компьютер",
