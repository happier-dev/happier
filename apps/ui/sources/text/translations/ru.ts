...
const settingsAppearanceTranslationExtension = {
  themeProfiles: {
    ...
    activeFooter: 'Выберите тему, используемую интерфейсом. Управляйте пользовательскими темами с экрана тем.',
    builtInGroup: 'Встроенные темы',
    builtInFooter: 'Встроенные темы доступны только для чтения. Дублируйте один, чтобы настроить его локально.',
    customGroup: 'Пользовательские темы',
    customFooter: 'Коснитесь темы, чтобы активировать ее, или используйте действия со строками, чтобы редактировать, дублировать или удалять ее.',
    defaultTheme: 'Тема по умолчанию',
    defaultThemeSubtitle: 'Используйте цвета темы Happier без специального профиля.',
    active: 'Активный',
    customProfileSubtitle: 'Пользовательский профиль локальной темы',
    tapToActivate: 'Нажмите, чтобы активировать',
    actionsGroup: 'Действия темы',
    createProfile: 'Создать тему',
    createProfileSubtitle: 'Начните с любой встроенной или пользовательской темы.',
    importProfile: 'Импортировать тему',
    importProfileSubtitle: 'Вставьте JSON или выберите файл профиля темы Happier',
    exportProfile: 'Экспортировать тему',
    exportProfileSubtitle: 'Экспортируйте эту тему как JSON',
    presetsGroup: 'Встроенные пресеты',
    presetsFooter: 'Встроенные профили доступны только для чтения. Клонируйте один, чтобы настроить его.',
    presets: {
    ...
    readOnlyPreset: 'Предустановка только для чтения',
    clonePreset: 'Клонировать пресет',
    cloneProfile: 'Клонировать профиль',
    duplicateTheme: 'Дублировать тему',
    editProfile: 'Редактировать профиль',
    newProfileName: ({ count }: { count: number }) => `Пользовательская тема ${count}`,
    cloneName: ({ name }: { name: string }) => `${name} — копия`,
    detailsGroup: 'Подробности',
    presetGroup: 'Предустановка',
    presetSource: 'Предустановка',
    presetSourceSubtitle: 'Выберите тему, которая будет использоваться в качестве отправной точки.',
    assetAppearance: 'Внешний вид актива',
    assetAppearanceSubtitle: 'Выберите, будут ли в этой теме использоваться светлые или темные ресурсы приложений.',
    replacePresetTitle: 'Заменить текущие цвета?',
    replacePresetSubtitle: 'Изменение предустановки заменит текущие черновые цвета. Несохраненные изменения цвета будут отменены.',
    profileName: 'Имя профиля',
    editorModeGroup: 'Тематический режим',
    editorModeFooter: 'Эта тема редактирует цветовой режим, выбранный в ее предустановке.',
    editorMode: 'Вариант',
    lightMode: 'Свет',
    darkMode: 'Темный',
    previewTitle: 'Предварительный просмотр темы',
    previewSubtitle: 'Предварительный просмотр поверхностей, текста, элементов управления, состояния и синтаксиса в локальной песочнице.',
    previewButton: 'Первичное действие',
    previewStatus: 'Готово',
    previewCode: 'const theme = "happier";',
    colorInputPlaceholder: '#RRGGBB, rgba(...), transparent',
    tokenSubtitle: 'Переопределение токена общедоступного цвета',
    recentColors: 'Последние цвета',
    colorPickerFallback: 'Введите значение цвета или повторно используйте последний цвет.',
    invalidColor: 'Use hex, rgb(...), rgba(...), or transparent.',
    invalidProfileName: 'Неверное имя профиля.',
    profileLimitReached: 'Достигнут лимит тем.',
    contrastWarning: 'Низкий контраст для этой пары токенов. Вы все еще можете сохранить или сбросить настройки.',
    resetToken: 'Сбросить токен',
    resetGroup: 'Сброс и деактивация',
    resetMode: 'Сбросить цвета темы',
    deactivateProfile: 'Использовать тему по умолчанию',
    ...
    importJson: 'Тема JSON',
    importJsonPlaceholder: "Вставьте сюда JSON своей темы.",
    importFile: 'Выбрать файл',
    importWarnings: ({ count }: { count: number }) => `При импорте обнаружено предупреждений: ${count}.`,
    importErrors: {
      invalidJson: 'Вставленный текст недействителен JSON.',
      unsupportedSchema: 'Эта версия профиля темы не поддерживается.',
      invalidProfile: 'Не удалось импортировать этот профиль темы.',
      tooLarge: 'Этот профиль темы JSON слишком велик.',
    },
    exportFooter: 'Экспортированный JSON включает все общедоступные значения токенов цвета для этой темы.',
    exportJson: 'Экспортировать JSON',
    copyExportJson: 'Скопируйте JSON',
    downloadExportJson: 'Скачать JSON',
    noProfiles: 'Пользовательских тем пока нет',
    groups: {
      background: 'Фон',
      surface: 'Поверхности',
      border: 'Границы',
...
export const ru = {
    ...
    pluginSurfaces: {
        state: {
            loading: { title: 'Загрузка содержимого плагина', reason: 'Пока Happier загружает последнее обновление, отображается доступное содержимое.' },
            refreshing: { title: 'Обновление содержимого плагина', reason: 'Пока Happier проверяет обновления, отображается последнее доступное содержимое.' },
            stale: { title: 'Содержимое плагина может быть устаревшим', reason: 'Отображается последнее доступное содержимое. Повторите попытку, чтобы проверить обновления.' },
            offline: { title: 'Содержимое плагина недоступно в сети', reason: 'До повторного подключения последнее доступное содержимое отображается только для чтения.' },
        },
        offlineSnapshot: {
        ...
        appPage: {
            title: 'Страницы плагинов',
            subtitle: 'Полноэкранные разделы, предоставленные установленными плагинами.',
            empty: 'Нет доступных страниц плагинов.',
            unknown: 'Эта страница плагина недоступна. Плагин может загружаться, быть отключён или удалён.',
        },
    ...
    settingsKeyboard: {
        ...
        setShortcutPromptPlaceholder: 'Альт+К',
        setShortcutInvalidTitle: 'Неверный ярлык',
        ...
        commands: {
            ...
            sessionsRowMoveUp: 'Переместить выбранную строку вверх',
            sessionsRowMoveDown: 'Переместить выделенную строку вниз',
            sessionsRowMoveToFolder: 'Переместить выбранную строку в папку',
            sessionsRowMoveToWorkspaceRoot: 'Переместить выбранную строку в корень рабочей области',
            sessionsSelectionToggleFocused: 'Выбрать целевую сессию',
            sessionsSelectionExtendUp: 'Расширить выбор сеанса вверх',
            sessionsSelectionExtendDown: 'Расширить выбор сеанса вниз',
            sessionsSelectionSelectAll: 'Выбрать все видимые сеансы',
            sessionsSelectionClear: 'Очистить выбор сеанса',
            settingsOpen: 'Открыть настройки',
            transcriptSelectionCancel: 'Отменить выбор транскрипции',
            transcriptSelectionCopy: 'Копировать выбранные расшифровки сообщений',
            transcriptSelectionSelectAll: 'Выбрать все расшифровки сообщений',
            transcriptSelectionSendToSession: 'Отправить выбранные расшифровки сообщений в сеанс',
            ...
            splitCanvasFocusDown: "Фокус разделен ниже",
  ...
  automations: {
    ...
    list: {
      interval: ({ minutes, timezone }: { minutes: number; timezone: string | null }) => `Каждые ${minutes} мин${timezone ? ` (${timezone})` : ""}`,
    ...
    detail: {
      ...
      runMeta: {
        ...
        state: {
          ...
          cancelled: "Отменён",
          expired: "Истёк",
          dispatch_failed: "Сбой отправки",
          skipped: "Пропущен",
          missed: "Пропущен по расписанию",
          outcome_uncertain: "Результат неизвестен",
        },
        occurred: ({ time }: { time: string }) => `Произошло: ${time}`,
        invoked: ({ time }: { time: string }) => `Вызвано: ${time}`,
      ...
      runDetail: {
        ...
        recipe: "Принятый рецепт",
        recipeAbsent: "Приватные сведения о принятии не были сохранены.",
        templateVersion: "Версия шаблона",
        event: "Событие",
        conversation: "Разговор",
        sourceInstance: "Экземпляр источника",
        filter: "Фильтр",
        filterMatched: "Совпало",
        payload: "Данные",
        input: "Ввод",
        target: "Зафиксированная цель",
        ...
        failureDetail: "Подробности ошибки",
        failureDetailAbsent: "Приватные подробности ошибки не были сохранены.",
        predecessorSummary: "Есть сводка предшественника, но она недоступна в этих сведениях.",
        currentnessUnavailable: "Приватные сведения о запуске временно недоступны, пока меняется шифрование аккаунта.",
        materialUnavailable: "На этом устройстве нет текущего ключа шифрования аккаунта.",
        modeMismatch: "Сохранённые приватные сведения используют другой режим шифрования аккаунта.",
        contentInvalid: "Сохранённые приватные сведения недействительны.",
        invalidTemplate: "Принятый шаблон недействителен. Этот запуск не будет отправлен или повторён.",
        outcomeUnknown: "Результат отправки неизвестен. Happier не будет повторно отправлять зафиксированную цель.",
      },
    },
    create: {
  ...
  ui: {
    resizableDockedPane: {
      ...
      resizeHint:
        "Используйте стрелки клавиатуры или действия регулировки, чтобы изменить размер",
    },
    modalPane: {
      right: "Правая боковая панель",
      details: "Панель сведений",
      bottom: "Нижняя панель",
      dismiss: ({ pane }: { pane: string }) => `Закрыть ${pane}`,
    },
    pluginUi: {
      loading: "Загрузка",
  ...
  connectedServices: {
    ...
    diagnostics: {
      title: {
        ...
        recovery_retry_scheduled: 'Восстановление провайдера запланировано',
                ...
                connected_service_credential_refresh_unavailable: "Обновление подключенной учетной записи временно недоступно",
      ...
      status: {
        ...
        recovery_retry_scheduled: 'Запланирован повтор восстановления провайдера',
                ...
                post_switch_verification_failed: 'Аккаунт провайдера не удалось проверить',
                connected_service_credential_reconnect_required: "Подключенную учетную запись нужно переподключить",
                connected_service_credential_refresh_unavailable: "Не удалось временно обновить подключенную учетную запись",
      ...
      body: {
        ...
        provider_session_state_unavailable_for_resume: 'Проверьте подключенные аккаунты, затем начните новую сессию с выбранным аккаунтом или продолжите с текущим.',
        ...
        resume_reachability_inputs_missing: 'Демон не смог проверить состояние возобновления провайдера, потому что отсутствовали необходимые данные.',
        ...
        recovery_retry_scheduled: 'Happier запланировал повтор восстановления провайдера. Можно повторить сейчас или проверить подключённые аккаунты.',
                ...
                connected_service_credential_refresh_unavailable: "Не удалось обновить выбранную подключенную учетную запись. Повторите попытку через некоторое время.",
    ...
    account: {
      configurationTitle: 'Настройки учетной записи',
      configurationUpdatedTitle: 'Настройки учетной записи обновлены',
            ...
            claude: {
                ...
                fields: {
                    ...
                    claudeUnifiedTerminalWorkspaceTrust: {
                        title: "Доверие к рабочему пространству",
                        subtitle: "Выберите, как Happier будет отвечать, когда Claude спрашивает, доверять ли рабочей области.",
                        options: {
                            ask_every_time: {
                                title: "Спрашивай каждый раз",
                                subtitle: "Покажите точный вопрос доверия к рабочей области в сеансе."
                            },
                            always_trust_happier_workspaces: {
                                title: "Всегда доверяйте рабочим областям Happier",
                                subtitle: "Доверяйте текущему перезаписанному приглашению Claude для рабочих областей, открытых с помощью Happier."
                            },
                            always_reject_happier_workspaces: {
                                title: "Всегда отклонять рабочие области Happier",
                                subtitle: "Отклонить текущий перезахваченный запрос Claude для рабочих областей, открытых Happier."
                            }
                        }
                    },
            ...
            opencode: {
                ...
                sections: {
                    ...
                    server: {
                        ...
                        footer: "Оставьте пустым, чтобы использовать управляемый Happier жизненный цикл сервера OpenCode. Укажите абсолютный HTTPS URL для любого сервера, который вы запускаете сами, или HTTP только для localhost. Пароль укажите в поле ниже, а не в URL."
                    }
                },
                fields: {
                    opencodeBackendMode: {
                    ...
                    opencodeServerBaseUrl: {
                        ...
                        subtitle: "Необязательное переопределение для сервера, который вы запускаете сами. HTTPS может использовать любой хост; HTTP ограничен localhost."
                    },
                    opencodeServerPassword: {
                        title: "Пароль существующего сервера OpenCode",
                        subtitle: "Указывайте только если ваш сервер OpenCode запущен с OPENCODE_SERVER_PASSWORD. Хранится в зашифрованном виде на этом устройстве и никогда не синхронизируется."
                    }
                }
            },
            auggie: {
  ...
  settingsFeatures: {
    ...
    sourceControlUnavailableForSession: "Система контроля версий недоступна для этого сеанса.",},
  ...
  deps: {
    ...
    installable: {
      ...
      gh: {
        title: "GitHub интерфейс командной строки",
      },},
    ui: {
      notAvailable: "Недоступно",
  ...
  newSession: {
    ...
    failedToStart:
      "Не удалось запустить сеанс. Повторите попытку или проверьте выбранную машину и настройки сеанса.",
    actionMethodUnavailable: "Обновите Happier на целевой машине, чтобы создать новый сеанс.",
    sessionTimeout:
  ...
  sessionsList: {
    ...
    sessionFallbackLabel: 'Сессия',
    moveSheetTitle: ({ item }: { item: string }) => 'Move ' + item,
    moveSheetDestinationLabel: 'Пункт назначения',
    moveSheetSubmit: 'Переместить',
    moveSheetSearchPlaceholder: 'Search folders...',
    moveSheetEmpty: 'Нет доступных целей перемещения',
    moveSheetDestinations: 'Направления',
    moveSheetDisabledDescendant: 'Невозможно переместить в себя или в дочернюю папку.',
    moveSheetDisabledMaxDepth: 'Это превысит предел глубины папки.',
    moveSheetDisabledCurrent: 'Уже в этом месте.',
    moveSheetDisabledUnavailable: 'Этот пункт назначения недоступен.',
    dragHandleA11yLabel: 'Перетащите ручку',
    ...
    dragA11yBlockedDescendantCycle: 'пункт назначения находится внутри перемещенной папки',
    dragA11yBlockedLeafCannotBeParent: 'сеансы не могут содержать другие элементы',
    dragA11yBlockedMaxDepth: 'достигнут предел глубины папки',
    dragA11yBlockedSamePosition: 'уже в этом положении',
    dragA11yBlockedWorkspaceScope: 'пункт назначения находится в другом рабочем пространстве',
    dragA11yBlockedNoTarget: 'пункт назначения не выбран',
    dragA11yBlockedDirectSession: 'прямые сеансы нельзя перемещать в папки',
    dragA11yBlockedFeatureDisabled: 'папки сеанса не включены',
    ...
    selectionCheckboxA11yLabel: 'Выберите сеанс',
  ...
  session: {
    ...
    staleRunner: {
      banner: {
        ...
        body: "Этот сеанс все еще работает на старом коде среды выполнения. Перезапустите раннер, чтобы использовать текущий runtime демона.",
        ...
        unavailableBody: "Перезапуск недоступен для этого сеанса. Сеанс может продолжить работу на текущем раннере.",
      },
      actions: {
    ...
    agentContinuation: {
      ...
      unavailable: {
        ...
        targetNoSessions: ({ agent }: { agent: string }) => `${agent} не может вести сессию.`,
    ...
    forking: {
      ...
      strategy: {
          ...
          unavailable: {
              ...
              nativeProviderBound: "Агент не может ответвить сессию, привязанную к аккаунту провайдера.",
  ...
  commandPalette: {
    ...
    noCommandsFound: "Команды не найдены",
        ...
        commands: {
            ...
            sessionFallbackSubtitle: 'Переключиться на сеанс',
            sessionRequiredTitle: 'Требуется сеанс',
            sessionRequiredBody: 'Сначала откройте сеанс, чтобы эта команда могла нацелиться на него.',
  ...
  modelPickerOverlay: {
    ...
    effectiveLabel: ({ label }: { label: string }) => `Фактически: ${label}`,
      ...
      startGlobalVoice: "Запустить глобальный голос",
      ...
      endDictation: "Завершить диктовку",
        ...
        voiceSurface: {
          ...
          orbLabel: "Голос",
          orbStartHint: "Начинает голосовой разговор. Проведите вверх, чтобы открыть разговор.",
          orbEndHint: "Завершает голосовой разговор. Уже начатая работа над кодом продолжается. Проведите вверх, чтобы открыть разговор.",
          orbMinimiseHint: "Сворачивает голос",
          orbExpand: "Развернуть голос",
          orbCollapse: "Свернуть голос",
          delegatedWorking: "Работает…",
          composerStartHint: "Начинает голосовой разговор об этой сессии.",
          composerGlobalStartHint: "Начинает голосовой разговор, не привязанный ни к одной сессии.",
          composerEndHint: "Завершает голосовой разговор. Уже начатая работа над кодом продолжается.",
    ...
    stagedChanges: ({ count }: { count: number }) =>
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        sessionMedia: {
          ...
          previewImageA11y: ({ name, current, total }: { name: string; current: number; total: number }) => `Изображение ${current} из ${total}: ${name}`,

          previewUnavailableA11y: "Предварительный просмотр мультимедиа недоступен.",
  ...
  localServices: {
    ...
    publicPreview: {
      ...
      authenticatedMode: 'Доступ после входа',
      publicMode: 'Любой, у кого есть ссылка',
      expiredSubtitle: 'Срок действия ссылки истёк',
      expiresInMinutes: ({ count }: { count: number }) => `Истекает через ${count} мин`,
      expiresInHours: ({ count }: { count: number }) => `Истекает через ${count} ч`,
      expiresInDays: ({ count }: { count: number }) => `Истекает через ${count} дн.`,
      modePromptTitle: 'Тип ссылки',
      ttlPromptTitle: 'Срок действия ссылки',
      ttlPromptMessage: ({ service }: { service: string }) => `Как долго публичная ссылка на «${service}» должна оставаться действительной?`,
      ttlOptionMinutes: ({ count }: { count: number }) => `${count} минут`,
      ttlOptionHours: ({ count }: { count: number }) => `${count} часов`,
      ttlOptionDays: ({ count }: { count: number }) => `${count} дней`,
  ...
  browserContext: {
    ...
    editor: {
      ...
      attach: 'Прикрепить аннотацию',
      cancel: 'Отмена',
      captureUnavailable: 'Захват аннотации недоступен для этого представления.',
      selectUnavailable: 'Выбор элементов недоступен для этого представления.',
      marked: ({ count }: { count: string }) => `Отмечено: ${count}`,
      removeMark: ({ label }: { label: string }) => `Удалить ${label}`,
      markElement: ({ label }: { label: string }) => `Элемент ${label}`,
      markRegion: 'Область',
      markStroke: 'Рисунок',
    },
  },
...
settingsSession: {
    newSessionDraftEntry: {
	    ...
	    sessionList: {
	        ...
	        folderTreeView: "Представление в виде дерева папок",},
      ...
      sessionCreation: {
        ...
        wizardPresentationDropdownSubtitle: "Показывать компактную строку, открывающую полный селектор.",
          ...
          promptPersonalization: {
              title: 'Оперативная персонализация',
              footer: 'Выберите, какие встроенные инструкции Happier добавляют в новые сеансы агента. Это не скрывает параметры, которые уже отправляет агент.',
              askAgentToRenameSessionsTitle: 'Обновления названия сеанса',
              askAgentToRenameSessionsNeverTitle: 'Никогда',
              askAgentToRenameSessionsNeverSubtitle: 'Не предлагайте агентам устанавливать названия сеансов.',
              askAgentToRenameSessionsInitialTitle: 'В начале сеанса',
              askAgentToRenameSessionsInitialSubtitle: 'Предлагайте агентам установить короткий заголовок из первого сообщения пользователя.',
              askAgentToRenameSessionsOngoingTitle: 'Когда задача изменится',
              askAgentToRenameSessionsOngoingSubtitle: 'Предлагайте агентам устанавливать заголовки в начале сеанса и при изменении задачи.',
              askAgentToRenameSessionsInitialSelectedSubtitle: 'Агентам предлагается установить заголовок в начале сеанса.',
              askAgentToRenameSessionsOngoingSelectedSubtitle: 'Агентам предлагается обновить заголовки при изменении задачи.',
              askAgentToRenameSessionsDisabledSubtitle: 'Агентам не предлагается устанавливать названия; ручное переименование все еще работает.',
              askAgentToSuggestReplyOptionsTitle: 'Попросите агента предложить варианты ответа',
              askAgentToSuggestReplyOptionsEnabledSubtitle: 'В подсказке агентам предлагается предложить варианты быстрого ответа, если это необходимо.',
              askAgentToSuggestReplyOptionsDisabledSubtitle: 'В приглашении агентам не предлагается добавить параметры быстрого ответа.',
          },
      defaultPermissions: {
  ...
  settingsVoice: {
    ...
    history: {
      ...
      upgradeRequiredTitle: 'Для загрузки истории голоса требуется обновление',
      upgradeRequiredBody: 'Этот сервер не поддерживает формат зашифрованной истории, используемый этой учётной записью. Обновите Happier на сервере, затем перезагрузите страницу.',
    ...
    realtimeProviders: {
      ...
      ...voiceRealtimeProviderSetupTranslations.ru,
      operationFailed: 'Не удалось обновить настройку. Повторите попытку.',
      operationFailedUnsaved: 'Не удалось обновить настройку. Изменения не сохранены.',
      operationFailedVoiceNotFound: 'Выбранный голос недоступен в подключённом аккаунте. Выберите другой голос и снова выполните это действие. Изменения не сохранены.',
      operationFailedStage: ({ stage }: { stage: string }) => `Неудавшийся шаг: ${stage}`,
      operationFailedStatus: ({ status }: { status: number }) => `Ответ провайдера: HTTP ${status}`,
      codex: {
    ...
    byo: {
      ...
      realtime: {
        ...
        voiceSettings: {
          ...
          speed: {
            title: "Скорость",
            subtitle: "0.7–1.2. Пусто = по умолчанию.",
            promptTitle: "Скорость (0.7–1.2)",
            promptBody:
              "Введите число от 0.7 до 1.2. Оставьте пустым, чтобы использовать по умолчанию.",
            invalid: "Введите число от 0.7 до 1.2.",
          },
        },
    ...
    externalCredentials: {
      ...voiceExternalCredentialApprovalTranslations.ru,
      ...
      footer: "Сохранённые ключи хранятся в вашей учётной записи. Хост отправляет их на объявленный адрес провайдера; код плагина получает только результат операции.",
      rawPromptDescription: "Вставьте ключ API провайдера. Код плагина в объявленной среде выполнения этого провайдера получает выбранные учётные данные напрямую и может использовать или копировать их.",
      rawFooter: "Прямой доступ к учётным данным позволяет коду плагина в объявленной среде выполнения напрямую получить выбранные учётные данные и использовать или копировать их. Проверьте доступ перед использованием.",
      rawCredentialAccessReviewBody: ({ pluginId, localId, credentialSlot, source, realm, phase }: { pluginId: string; localId: string; credentialSlot: string; source: string; realm: string; phase: string }) =>
        `Код плагина для ${pluginId}/${localId} получает выбранные учётные данные ${source} для ${credentialSlot} во время ${phase} в среде выполнения ${realm}. Он может использовать или копировать их.`,
      ready: "Ключ API сохранён",
      missing: "Требуется ключ API",
      unavailable: "Настройка учётных данных недоступна",
    },
    local: {
      ...voiceLocalCredentialTranslations.ru,
      ...
      googleCloudTts: {
        ...
        apiKey: {
          machineCredentialRestrictionBody: "Сохранённый ключ ограничен сертификатом приложения Android и не может использоваться выбранной машиной. Введите отдельный API‑ключ, совместимый с машиной; существующее синхронизированное значение останется без изменений для старых клиентов.",
      ...
      models: {
          ...
          modelFiles: ({ size }: { size: string }) => `Файлы модели: ${size}`,
    ...
    privacy: {
      ...
      currentUiContextModeTitle: "Контекст текущего интерфейса",
      currentUiContextModeSubtitle:
        "Выберите, когда Voice может использовать ограниченный семантический контекст активного окна приложения Happier или вкладки браузера.",
      currentUiContextMode: {
        offTitle: "Выключено",
        offSubtitle: "Voice не получает от этого клиента контекст текущего интерфейса или контекстные команды.",
        onDemandTitle: "По запросу",
  ...
  releaseNotes: {
    ...
    onboardingShowcase: {
        details: PRODUCT_STORY_DETAILS_ENGLISH,
            ...
            alt: "Абстрактное изображение-заглушка для системы контроля версий.",
  ...
  welcome: {
    ...
    welcomeFooterRelay: "Самостоятельный хостинг?",
  ...
  setupOnboarding: {
    ...
    handoffPlatformPosixLabel: "macOS/Линукс",
    handoffPlatformMacosLabel: "macOS",
    handoffPlatformLinuxLabel: "Линукс",
  ...
  profiles: {
   ...
   settingsPlugins: {
    ...
    developmentSourceInstall: "Разрабатывать локальную папку плагина",
    developmentSourceInstallSubtitle: "Разрешите демону на этом компьютере собирать и запускать плагин из вашей папки. Сначала вы подтверждаете конкретную папку.",
    developmentSourceInstallTitle: "Папка плагина",
    developmentSourceInstallBody: "Укажите полный путь к папке проекта плагина на этом компьютере.",
    ...
    developmentCreateSurfaceTitle: "Поверхность интерфейса плагина",
    developmentCreateSurfaceBody: "Выберите поверхность интерфейса, с которой начинается этот плагин. React Native также отрисовывается в вебе.",
    developmentCreateSurfaceReactNative: "React Native",
    developmentCreateSurfaceHostedWeb: "Размещённый веб",
    developmentCreateSurfaceNone: "Без интерфейса",
    ...
    agentUiDiagnosticsTitle: "Диагностика интерфейса агента",
    ...
    marketplaceInstallReviewBlockedNewerVersions: 'Более новые версии заблокированы до загрузки:',
  ...
  cacheSubtitle: 'Сводки checkpoint повторно используются по квитанции; сводки working tree остаются временными.',
    ...
    reset: {
      requested: {
        title: "Сброс интерфейса плагина",
        reason: "Happier ожидает подтверждения сброса.",
      },
      awaitingProjection: {
        title: "Ожидание сброса плагина",
        reason: "Happier ожидает обновлённое состояние плагина.",
      },
      complete: {
        title: "Интерфейс плагина сброшен",
        reason: "Интерфейс плагина снова доступен.",
      },
      failed: {
        title: "Не удалось сбросить интерфейс плагина",
        reason: "Попробуйте выполнить сброс ещё раз.",
      },
    },
  },
    pluginRuntime: {
        ...
        hostedWebUnavailableTitle: 'Размещенное представление плагина недоступно',
        hostedWebPolicyDenied: 'Это представление плагина недоступно на этой поверхности. Проверьте настройки доступности или используйте поддерживаемую поверхность.',
        hostedWebSandboxUnavailable: 'Этот плагин не объявляет параметры изоляции, необходимые для показа этого представления. Обновите плагин и повторите попытку.',
        hostedWebSecurityUnavailable: 'Настройки безопасности плагина нельзя применить в этом представлении. Обновите плагин или используйте поддерживаемый хост.',
        hostedWebFrameOriginUnavailable: 'Happier не удалось установить доверенный адрес для этого представления. Обновите страницу и повторите попытку.',
        hostedWebBridgeNonceUnavailable: 'Happier не удалось установить безопасное соединение с этим представлением. Обновите страницу и повторите попытку.',
        hostedWebBridgeTimeout: 'Это представление плагина не завершило подключение. Обновите страницу и повторите попытку.',
