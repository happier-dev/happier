...
settingsSession: {
  ...
  setupOnboarding: {
    ...
    relayOnRemoteComputerTitle: "На удалённом компьютере",
    ...
    webDesktopOnlyDesktopAppTitle: "Или получите приложение для компьютера",
    webDesktopOnlyDesktopAppSubtitle: "Установите Happier на этот компьютер, чтобы запускать Relay и настроить фоновую службу.",
    ...
    webDesktopOnlySetupCommandTitle: "Настройте этот компьютер",
    ...
    setupNewMachineAction: "Настроить новый компьютер",
