  ...
  automations: {
    ...
    form: {
      trigger: {
        ...
        executionReadOnly: 'Только чтение',
      },
    ...
    detail: {
      ...
      event: {
        ...
        observationPlacementTitle: "Расположение наблюдения за событиями",
...
settingsSession: {
  ...
  terminalEmbedded: {
    ...
    settings: {
      ...
      rendererNativeDescription: "Использует нативный рендерер, даже если экранным дикторам по-прежнему нужно доступное веб-представление xterm.js; все остальные нативные проверки безопасности продолжают действовать.",
    },
    quickKeys: {
      esc: "ESC",
      tab: "TAB",
