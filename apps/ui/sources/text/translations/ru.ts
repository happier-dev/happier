...
export const ru: TranslationStructure = {
    settingsKeyboard: {
        ...
        entrySubtitle: 'Просматривайте сочетания приложения и управляйте ими',
        generalGroupTitle: 'Управление с клавиатуры',
        generalGroupFooter: 'Настройки сочетаний сохраняются локально на этом устройстве.',
        enableShortcutsTitle: 'Включить единые сочетания',
        enableShortcutsSubtitle: 'Использовать новый реестр клавиатурных команд для сочетаний приложения.',
        singleKeyTitle: 'Одноклавишные сочетания',
        singleKeySubtitle: 'Разрешать сочетания вроде ?, когда текстовое поле не в фокусе.',
        conflictsTitle: ({ count }: { count: number }) => `Обнаружено конфликтов сочетаний: ${count}`,
        conflictsSubtitle: ({ count }: { count: number }) => `Команд для проверки перед активацией всех сочетаний: ${count}.`,
        ...
        noDefaultShortcut: 'Нет сочетания по умолчанию',
        ...
        resetCommandAccessibility: ({ command }: { command: string }) => `Сбросить сочетание для ${command}`,
        commands: {
            composerAbortConfirm: 'Подтвердить остановку',
            composerFocus: 'Перейти к полю ввода',
            composerSendImmediate: 'Отправить сразу',
            commandPaletteOpen: 'Открыть палитру команд',
            modeCycle: 'Переключить режим',
            permissionCycle: 'Переключить разрешения',
            shortcutsHelpOpen: 'Открыть справку по сочетаниям',
            sessionNew: 'Создать новую сессию',
            sessionMruNext: 'Следующая недавняя сессия',
            sessionMruPrevious: 'Предыдущая недавняя сессия',
            sessionVisibleNext: 'Следующая видимая сессия',
            sessionVisiblePrevious: 'Предыдущая видимая сессия',
            ...
            transcriptMessageNext: 'Следующее сообщение стенограммы',
            transcriptMessagePrevious: 'Предыдущее сообщение стенограммы',
            transcriptScrollBottom: 'Прокрутить стенограмму вниз',
            ...
            transcriptScrollTop: 'Прокрутить стенограмму вверх',
        },
    },
  tabs: {
  ...
  settingsAppearance: {
    ...
    settingsNavSidebar: "Сайдбар настроек",
    settingsNavSidebarDescription:
      "Показывать сайдбар настроек в сессиях (web/tablet)",
  ...
  sessionsList: {
    ...
    addFolder: 'Добавить папку',
    newFolderDefaultName: 'Папка',
    folderNamePlaceholder: 'Название папки',
    workspaceRoot: 'Корень рабочего пространства',
    moveToFolder: 'Переместить в папку',
    failedToMoveSessionToFolder: 'Не удалось переместить сеанс в эту папку.',
    newSessionInFolder: 'Новый сеанс в папке',
    ...
    deleteFolderPromptDescription: 'Сеансы из этой папки будут перемещены в родительскую папку или в корень рабочего пространства.',
  },
  ...
  externalSessions: {
    ...
    openInSplitRight: "Открыть в правой области",
    openInSplitDown: "Открыть в нижней области",
    revealInCurrentSplit: "Показать в текущей области",
        ...
        pendingMessages: {
          ...
          badgeLabel: ({ count }: { count: number }) =>
            count > 0 ? `Ожидает (+${count})` : "Ожидает",
	          ...
	          nonSteerableNotice: "Текущий ход после смены режима не может принять steering. Сообщение выполнится следующим, либо используйте Отправить сейчас, чтобы прервать.",
	          actions: {
          up: "Вверх",
          down: "Вниз",
          edit: "Редактировать",
  ...
  files: {
    ...
    stagedChanges: ({ count }: { count: number }) =>
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        sessionMedia: {
          ...
          unavailableImageA11y: ({ name }: { name: string }) => `Изображение недоступно: ${name}`,
          previewUnavailableA11y: "Предпросмотр недоступен",
        },
    ...
    fileActions: {
      ...
      selectEntireFileForCommit: "Выбрать весь файл",
      rangeSelection: "Диапазон",
    ...
    sourceControlOperations: {
      ...
      update: {
        ...
        publishRepository: {
          ...
          originConflictRemediation: "Выберите, как обработать существующий origin перед публикацией.",
          commitRequired: "Закоммитьте ожидающие изменения перед публикацией.",
          unsafeUrl: "Happier заблокировал небезопасный URL для продолжения.",
          auth: {
            connectedAccountReady: "Подключение GitHub готово.",
            providerCliReady: "gh CLI аутентифицирован.",
          },
          remediation: {
            connectGitHub: "Подключить GitHub",
            installGh: "Установить gh CLI",
            useManagedGh: "Использовать управляемый gh CLI",
            authenticateGh: "Аутентифицировать gh CLI",
  ...
  executionRuns: {
    ...
    details: {
      ...
      settingsActions: {
        ...
        detailSearchPlaceholder: "Искать поверхности",
...
settingsSession: {
	    sessionList: {
	        ...
	        orderingTitle: 'Параметры списка сеансов',
	        orderingSubtitle: 'Выберите, как группировать и показывать сеансы.',
	        orderingOptions: {
    ...
    messageSending: {
      ...
      sessionCreation: {
        ...
        rememberLastEngineSelectionsTitle: "Запоминать последние параметры движка",
        rememberLastEngineSelectionsEnabledSubtitle:
          "Новые сессии повторно используют последнюю модель, режим и параметры движка для каждого сервера и движка.",
        rememberLastEngineSelectionsDisabledSubtitle:
          "Новые сессии начинаются с настроек движка по умолчанию, если черновик или ярлык не задает выбор.",
    ...
    renameDescription:
      ...
      replacementRepair: {
        ...
        replaceWithMachineSubtitle: ({ machine }: { machine: string }) =>
          `Использовать ${machine} как замену этой машины.`,
        chooseReplacementSubtitle:
          "Выберите машину, которая заменила эту.",
        pickerTitle: "Выбрать заменяющую машину",
        pickerCandidatesTitle: "Доступные машины",
        ...
        undoConfirmBody:
          "Эта машина снова появится как цель запуска, если будет доступна.",
        undoAction: "Отменить",
