...
const memoryEmbeddingsTranslationExtension = memoryEmbeddingsTranslationExtensions.es;
  ...
  settingsFeatures: {
    ...
    voiceSubtitle: "Activar funciones de voz",
      ...
      expChannelBridgesSubtitle:
        "Conecta Telegram y otros canales de chat a sesiones de Happier (experimental)",
