...
export const es: TranslationStructure = {
    settingsKeyboard: {
        ...
        entrySubtitle: 'Descubre y controla los atajos de la app',
        generalGroupTitle: 'Controles de teclado',
        generalGroupFooter: 'Las preferencias de atajos se guardan localmente en este dispositivo.',
        enableShortcutsTitle: 'Activar atajos unificados',
        enableShortcutsSubtitle: 'Usa el nuevo registro de comandos de teclado para los atajos de la app.',
        singleKeyTitle: 'Atajos de una sola tecla',
        singleKeySubtitle: 'Permite atajos como ? cuando no hay una entrada de texto enfocada.',
        conflictsTitle: ({ count }: { count: number }) => `${count} conflicto${count === 1 ? '' : 's'} de atajo detectado${count === 1 ? '' : 's'}`,
        conflictsSubtitle: ({ count }: { count: number }) => `${count} comando${count === 1 ? ' necesita' : 's necesitan'} revisión antes de que todos los atajos puedan estar activos.`,
        ...
        noDefaultShortcut: 'Sin atajo predeterminado',
        ...
        resetCommandAccessibility: ({ command }: { command: string }) => `Restablecer el atajo de ${command}`,
        commands: {
            composerAbortConfirm: 'Confirmar cancelación',
            composerFocus: 'Enfocar redactor',
            composerSendImmediate: 'Enviar inmediatamente',
            commandPaletteOpen: 'Abrir paleta de comandos',
            modeCycle: 'Cambiar de modo',
            permissionCycle: 'Cambiar permisos',
            ...
            settingsOpen: 'Abrir configuración',
            transcriptMessageNext: 'Siguiente mensaje de la transcripción',
            transcriptMessagePrevious: 'Mensaje anterior de la transcripción',
            transcriptScrollBottom: 'Desplazar transcripción al final',
            transcriptScrollPageDown: 'Desplazar transcripción una página abajo',
            transcriptScrollPageUp: 'Desplazar transcripción una página arriba',
            transcriptScrollTop: 'Desplazar transcripción al inicio',
        },
    },
  tabs: {
  ...
  settingsAppearance: {
    ...
    settingsNavSidebarDescription:
      "Muestra la barra lateral de ajustes en las sesiones (web/tablet)",
  ...
  settingsFeatures: {
    ...
    expSessionsFoldersSubtitle: "Organiza las sesiones sincronizadas de la barra lateral en carpetas de espacio de trabajo",
    ...
    reviewFindings: {
      ...
      errors: {
        ...
        pendingMessages: {
          ...
          nonSteerableNotice: "El turno actual no puede aceptar steering después de este cambio de modo. Se ejecutará después, o usa Enviar ahora para interrumpir.",
          actions: {
            up: "Arriba",
            down: "Abajo",
          edit: "Editar",
  ...
  sessionsList: {
    ...
    newFolderDefaultName: 'Carpeta',
    folderNamePlaceholder: 'Nombre de la carpeta',
    workspaceRoot: 'Raíz del espacio de trabajo',
    moveToFolder: 'Mover a carpeta',
    failedToMoveSessionToFolder: 'No se pudo mover la sesión a esa carpeta.',
    newSessionInFolder: 'Nueva sesión en la carpeta',
    addSubfolder: 'Agregar subcarpeta',
    renameFolder: 'Renombrar carpeta',
    deleteFolder: 'Eliminar carpeta',
    addSubfolderPromptTitle: 'Agregar subcarpeta',
    renameFolderPromptTitle: 'Renombrar carpeta',
    deleteFolderPromptTitle: '¿Eliminar carpeta?',
    deleteFolderPromptDescription: 'Las sesiones de esta carpeta se moverán a la carpeta principal o a la raíz del espacio de trabajo.',
  },
  ...
  externalSessions: {
    ...
    openInSplitRight: "Abrir en división derecha",
    openInSplitDown: "Abrir en división inferior",
  ...
  files: {
    ...
    fileEditor: {
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        sessionMedia: {
          ...
          unavailableImageA11y: ({ name }: { name: string }) => `Imagen no disponible: ${name}`,
          previewUnavailableA11y: "Vista previa no disponible",
        },
    ...
    fileActions: {
      ...
      selectEntireFileForCommit: "Seleccionar todo el archivo",
      rangeSelection: "Rango",
    ...
    sourceControlOperations: {
      ...
      update: {
        ...
        publishRepository: {
          ...
          originConflictRemediation: "Elige cómo gestionar el origin existente antes de publicar.",
          commitRequired: "Confirma los cambios pendientes antes de publicar.",
          unsafeUrl: "Happier bloqueó una URL de seguimiento no segura.",
          auth: {
            connectedAccountReady: "La conexión de GitHub está lista.",
            providerCliReady: "gh CLI está autenticado.",
          },
          remediation: {
            connectGitHub: "Conectar GitHub",
            installGh: "Instalar gh CLI",
            useManagedGh: "Usar gh CLI gestionado",
            authenticateGh: "Autenticar gh CLI",
...
settingsSession: {
	      sessionList: {
	          ...
	          orderingTitle: 'Opciones de la lista de sesiones',
	          orderingSubtitle: 'Elige cómo se agrupan y se muestran las sesiones.',
	          orderingOptions: {
	          ...
	          folderTreeView: 'Árbol de carpetas',
      ...
      sessionCreation: {
        ...
        rememberLastEngineSelectionsTitle: "Recordar las últimas selecciones de motor",
        rememberLastEngineSelectionsEnabledSubtitle:
          "Las nuevas sesiones reutilizan el último modelo, modo y opciones de motor para cada servidor y motor.",
        rememberLastEngineSelectionsDisabledSubtitle:
          "Las nuevas sesiones empiezan con los valores predeterminados del motor salvo que un borrador o acceso directo aporte selecciones.",
    ...
    renameDescription:
      ...
      replacementRepair: {
        ...
        chooseReplacementSubtitle:
          "Elige la máquina que reemplazó a esta.",
        pickerTitle: "Elegir máquina de reemplazo",
        pickerCandidatesTitle: "Máquinas disponibles",
