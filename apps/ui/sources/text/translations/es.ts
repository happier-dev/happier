...
export const es: TranslationStructure = {
  ...
  connect: {
    ...
    restoreWithSecretKeyInstead: "Iniciar sesión con clave secreta en su lugar",
  ...
  settingsPlugins: {
    ...
    reloadSubtitle: "Recarga este plugin y actualiza sus descriptores proyectados.",
  ...
  settings: {
    ...
    machineSetupCurrentMachineTitle: "Configura este ordenador",
    ...
    machineSetupRemoteSshKeyFileAuthLabel: "Usar clave privada",
    machineSetupRemoteSshPasswordAuthLabel: "Usar contraseña",
    machineSetupRemoteSshIdentityFileLabel: "Ruta de la clave privada",
    ...
    localTailscale: {
      ...
      installSubtitle: 'Instala Tailscale y vuelve aquí.',
      loginTitle: 'Inicio de sesión requerido',
      loginSubtitle: 'Completa el inicio de sesión en Tailscale y vuelve aquí.',
    ...
    findings: {
      ...
      serverMismatch: {
        ...
        steps: {
          ...
          switchUiServer: "Mantén la UI apuntando al servidor que quieres usar y vuelve a conectar el servicio en segundo plano para que siga ese servidor.",
          restartDaemon: "Reinicia el servicio en segundo plano después de haberlo reconfigurado para el servidor correcto y vuelve a intentarlo.",
        },
      },
  ...
  settingsFeatures: {
    ...
    voiceSubtitle: "Activar funciones de voz",
      ...
      expVoiceDaemonInferenceSubtitle:
        "Habilitar superficies locales de TTS/STT neuronal en el daemon (requiere Agente de voz)",
    ...
    machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
      ...
      machineOfflineCannotResume:
        ...
        detailsPanel: {
            ...
            emptyHint: "Abre un archivo, diff o terminal desde otra pestaña.",
  ...
  files: {
    ...
    agentReportedTurnChanges: ({ count }: { count: number }) =>
      `Último turno informado por el agente (${count})`,
    checkpointTurnChanges: ({ count }: { count: number }) =>
      `Último turno del checkpoint (${count})`,
    ...
    agentReportedTurnDescription:
      "Archivos informados por el agente/runtime para el turno completado más reciente.",
    ...
    checkpointAttributionShared:
      "El contenido del checkpoint es exacto para el intervalo del repositorio. La atribución es limitada porque este worktree era compartido.",
    checkpointAttributionUnknown:
      "El contenido del checkpoint es exacto para el intervalo del repositorio. La atribución del actor es desconocida.",
    checkpointUnavailable:
      "La evidencia del checkpoint no está disponible para este turno.",
...
settingsSession: {
      sessionList: {
          ...
          orderingTitle: 'Ordenación',
          orderingSubtitle: 'Elige cómo se ordenan las sesiones en la lista',
          orderingOptions: {
    ...
    local: {
      ...
      kokoro: {
        ...
        assetPack: {
          ...
          subtitleWeb: "Selecciona el paquete de modelo del daemon. Kokoro identifica la familia del modelo, no un runtime del navegador.",
        },
        model: {
          title: "Modelo Kokoro",
          subtitleNative:
            "Descarga los archivos necesarios para habilitar síntesis en el dispositivo.",
          subtitleWeb: "Gestionado por el servicio de paquetes de modelo del daemon de voz.",
        },
        modelStatus: {
        ...
        voice: {
          ...
          subtitleWeb: "Elige la voz de Kokoro enviada al daemon para las respuestas.",
        ...
        web: {
          ...
          clearCache: {
            confirmTitle: "¿Eliminar los archivos de modelo del daemon?",
            confirmBody:
              "Esto elimina los archivos descargados del modelo y de las voces del daemon para este paquete.",
          ...
          cache: {
            title: "Archivos de modelo del daemon",
            subtitle: "Gestiona los archivos de modelo del daemon descargados para este paquete.",
          },
        },
      },
      localNeuralStt: {
      ...
      ttsProviderSubtitle:
        "Elige TTS del dispositivo, un endpoint compatible con OpenAI o TTS neural local con daemon",
      daemonInference: {
        execution: {
  ...
  changelog: {
    ...
    onboardingShowcase: {
      title: "Te damos la bienvenida a Happier",
      subtitle: "Sesiones de programación que te siguen a todas partes.",
      cards: {
        welcome: {
          title: "Diseñado para el ritmo",
        ...
        cockpit: {
            title: "Tu centro de mando móvil",
            body: "Una vista móvil enfocada para agentes activos, con acceso en un toque a chat, archivos, Git, terminal y detalles.",
            alt: "Imagen abstracta de marcador para el centro de mando.",
        ...
        reviewComments: {
            title: "Revisa y arregla código fácilmente",
            body: "Deja comentarios en líneas exactas de archivos o diffs, elige qué incluir y envía contexto estructurado a un agente.",
            alt: "Imagen abstracta de marcador para comentarios de revisión.",
        ...
        pets: {
            title: "Conoce a Pets",
            body: "Un pequeño compañero que te ayuda a mantener el foco entre sesiones. ¿Útil? Quizá. ¿Encantador? Sin duda.",
            alt: "Imagen abstracta de marcador para el compañero pet.",
