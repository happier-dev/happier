...
settingsSession: {
  ...
  setupOnboarding: {
          ...
          relayDiagramThisComputerLabel: 'Este equipo',
          recommendedBadge: 'Recomendado',
          relayCloudTitle: 'Happier Cloud',
          relayCloudSubtitle: 'Relay alojado — la forma más fácil de empezar',
          relayOnThisMacTitle: 'En este Mac',
          relayOnThisMacSubtitle: 'Ejecuta el relay localmente en este Mac y añade Tailscale para acceso desde el teléfono',
          relayCustomUrlTitle: 'Mi propia URL de relay',
          ...
          webDesktopOnlyBody: 'Abre la app de escritorio para configurar este ordenador. La app web puede mostrar el estado, pero no puede instalar ni configurar el servicio en segundo plano.',
	          ...
	          preAuthBody: 'Tu teléfono envía mensajes a través de un Relay a tus ordenadores. Elige dónde vive el Relay: puedes cambiarlo más tarde.',
