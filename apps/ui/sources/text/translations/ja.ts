...
settingsSession: {
  ...
  setupOnboarding: {
          ...
          recommendedBadge: 'おすすめ',
	          ...
	          relayOnRemoteComputerTitle: 'リモートのコンピューターで',
          ...
          webDesktopOnlyDesktopAppTitle: 'またはデスクトップアプリを入手',
          webDesktopOnlyDesktopAppSubtitle: 'このコンピューターに Happier をインストールして Relay のホストとバックグラウンドサービスをセットアップします。',
          ...
          webDesktopOnlySetupCommandTitle: 'このコンピューターをセットアップ',
