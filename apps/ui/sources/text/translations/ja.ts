...
const settingsSessionHandoffTranslationExtensions = {
  ja: {
    ...
    directTargetMode: {
      ...
      convertToPersistedSubtitle: 'トランスクリプトを取り込み、Happier 管理のセッションとして続けます。',
    },
  },
} as const;
...
export const ja: TranslationStructure = {
  ...
  connect: {
    ...
    restoreWithSecretKeyInstead: "代わりに秘密鍵でログイン",
  ...
  settingsPlugins: {
    ...
    generationLabel: "世代",
    reloadAction: "再読み込み",
    reloadSubtitle: "このプラグインを再読み込みし、投影された記述子を更新します。",
  ...
  settings: {
    ...
    addMachine: "マシンを追加",
    machineSetupCurrentMachineTitle: "このコンピューターをセットアップ",
    ...
    machineSetupRemoteSshKeyFileAuthLabel: "秘密鍵を使う",
    machineSetupRemoteSshPasswordAuthLabel: "パスワードを使う",
    machineSetupRemoteSshIdentityFileLabel: "秘密鍵のパス",
...
localTailscale: {
  ...
  settingsDesktop: {
    ...
    startOnLoginSubtitle: 'このコンピュータにサインインしたときに Happier を自動的に起動します。',
    overlay: {
  ...
  settingsPets: {
    ...
    disabledSubtitle: 'このデバイスで Blink を使うにはペット実験機能を有効にしてください。',
  ...
  settingsAppearance: {
    ...
    showLineNumbersInDiffs: "コードビューに行番号を表示",
    showLineNumbersInDiffsDescription: "差分、ファイルプレビュー、エディターに行番号を表示",
    showLineNumbersInToolViews: "ツールビューに行番号を表示",
    showLineNumbersInToolViewsDescription: "ツールビューの差分に行番号を表示",
    wrapLinesInDiffs: "コードビューで行を折り返し",
    wrapLinesInDiffsDescription:
      "差分、ファイルプレビュー、エディターで水平スクロールの代わりに長い行を折り返す",
  ...
  settingsFeatures: {
    ...
    expLiveActivitiesSubtitle: "iOS の Live Activities と Dynamic Island 表示を有効化",
    expHomeScreenWidgets: "ホーム画面ウィジェット",
    expHomeScreenWidgetsSubtitle: "iOS のホーム画面ウィジェット表示を有効化",
    voice: "音声",
    ...
    expVoiceDaemonInferenceSubtitle:
      "デーモン上のローカルなニューラルTTS/STTを有効化（音声エージェントが必要）",
  ...
  session: {
    ...
    machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
      ...
      detailsPanel: {
        ...
        emptyHint: "別のタブからファイル、差分、またはターミナルを開いてください。",
...
settingsSession: {
    sessionList: {
        ...
        orderingTitle: '並び順',
        orderingSubtitle: '一覧でのセッションの並び方を選択します',
        orderingOptions: {
            custom: 'カスタム',
            created: '作成日時',
            updated: '更新日時',
    ...
    mobileWorkspaceExperience: {
        ...
        options: {
            cockpitTitle: 'コックピット',
            cockpitSubtitle: '下部タブバーでチャット、ファイル、Git、タブ、ターミナルを切り替えます。',
            classicTitle: 'クラシック',
            classicSubtitle: '従来の単一画面モバイルレイアウトを使用します。',
        },
    },
    input: {
        title: '入力',
    ...
    local: {
      ...
      kokoro: {
        ...
        assetPack: {
          ...
          subtitleWeb: "daemon のモデルパックを選択します。Kokoro はモデルファミリー名であり、ブラウザー runtime ではありません。",
        },
        model: {
          title: "Kokoro モデル",
          subtitleNative:
          ...
          subtitleWeb:
            "voice-home daemon のモデルパックサービスで管理されます。",
        },
        modelStatus: {
          downloading: "ダウンロード中…",
        ...
        voice: {
          ...
          titleWeb: "Kokoro の音声",
          subtitleWeb: "返信用に daemon へ送る Kokoro 音声を選択します。",
        ...
        web: {
          warmingUp: "準備中…",
          clearCache: {
            confirmTitle: "daemon のモデルファイルを削除しますか？",
            confirmBody:
              "このパック用にダウンロード済みの daemon モデルと音声ファイルを削除します。",
            confirmButton: "消去",
          },
          cacheDetail: {
            modelFiles: "モデルファイル",
          ...
          cache: {
            title: "daemon モデルファイル",
            subtitle:
              "このパック用にダウンロード済みの daemon モデルファイルを管理します。",
          },
        },
      },
      localNeuralStt: {
      ...
      ttsProviderSubtitle:
        "デバイスTTS、OpenAI互換エンドポイント、または daemon 対応ローカルニューラルTTSを選択",
      daemonInference: {
        execution: {
          title: "ローカルニューラル実行",
