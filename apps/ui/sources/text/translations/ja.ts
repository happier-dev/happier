...
export const ja: TranslationStructure = {
    settingsKeyboard: {
        title: 'キーボードショートカット',
        entrySubtitle: 'アプリのショートカットを確認して管理',
        generalGroupTitle: 'キーボード操作',
        generalGroupFooter: 'ショートカット設定はこのデバイスにローカル保存されます。',
        enableShortcutsTitle: '統合ショートカットを有効にする',
        enableShortcutsSubtitle: 'アプリのショートカットに新しいキーボードコマンドレジストリを使用します。',
        singleKeyTitle: '単一キーのショートカット',
        singleKeySubtitle: 'テキスト入力にフォーカスがないとき、? などのショートカットを許可します。',
        conflictsTitle: ({ count }: { count: number }) => `${count} 件のショートカット競合が検出されました`,
        conflictsSubtitle: ({ count }: { count: number }) => `すべてのショートカットを有効にする前に、${count} 件のコマンドを確認してください。`,
        ...
        noDefaultShortcut: '既定のショートカットなし',
        ...
        resetCommandAccessibility: ({ command }: { command: string }) => `${command} のショートカットをリセット`,
        commands: {
            composerAbortConfirm: '中止を確認',
            composerFocus: '入力欄にフォーカス',
            composerSendImmediate: 'すぐに送信',
            commandPaletteOpen: 'コマンドパレットを開く',
            modeCycle: 'モードを切り替え',
            permissionCycle: '権限を切り替え',
            ...
            settingsOpen: '設定を開く',
            transcriptMessageNext: '次のトランスクリプトメッセージ',
            transcriptMessagePrevious: '前のトランスクリプトメッセージ',
            transcriptScrollBottom: 'トランスクリプトの末尾へスクロール',
            transcriptScrollPageDown: 'トランスクリプトを1ページ下へスクロール',
            transcriptScrollPageUp: 'トランスクリプトを1ページ上へスクロール',
            transcriptScrollTop: 'トランスクリプトの先頭へスクロール',
        },
    },
  tabs: {
...
localTailscale: {
  ...
  settingsFeatures: {
    ...
    expSessionsFoldersSubtitle: "同期済みサイドバーセッションをワークスペースのフォルダーで整理",
      ...
      pendingMessages: {
        ...
        badgeLabel: ({ count }: { count: number }) =>
          count > 0 ? `保留中 (+${count})` : "保留中",
	        ...
	        nonSteerableNotice: "このモード変更後、現在のターンはステアリングを受け付けられません。次に実行されます。すぐ送信するには「今すぐ送信」で中断してください。",
	        actions: {
          up: "上へ",
          down: "下へ",
          edit: "編集",
  ...
  commandPalette: {
    ...
    noCommandsFound: "コマンドが見つかりません",
        ...
        shortcutsHelpNewSession: '新しいセッション',
        commands: {
  ...
  sessionsList: {
    ...
    addFolder: 'フォルダーを追加',
    newFolderDefaultName: 'フォルダー',
    folderNamePlaceholder: 'フォルダー名',
    workspaceRoot: 'ワークスペースのルート',
    moveToFolder: 'フォルダーへ移動',
    failedToMoveSessionToFolder: 'セッションをそのフォルダーに移動できませんでした。',
    newSessionInFolder: 'フォルダー内に新しいセッション',
    addSubfolder: 'サブフォルダーを追加',
    renameFolder: 'フォルダー名を変更',
    deleteFolder: 'フォルダーを削除',
    addSubfolderPromptTitle: 'サブフォルダーを追加',
    renameFolderPromptTitle: 'フォルダー名を変更',
    deleteFolderPromptTitle: 'フォルダーを削除しますか？',
    deleteFolderPromptDescription: 'このフォルダー内のセッションは親フォルダーまたはワークスペースのルートに移動します。',
  },
  ...
  externalSessions: {
    ...
    openInSplitRight: "右の分割で開く",
    openInSplitDown: "下の分割で開く",
  ...
  files: {
    ...
    stagedChanges: ({ count }: { count: number }) =>
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        sessionMedia: {
          ...
          unavailableImageA11y: ({ name }: { name: string }) => `画像を利用できません: ${name}`,
          previewUnavailableA11y: "プレビューを利用できません",
        },
    ...
    fileActions: {
      ...
      selectEntireFileForCommit: "ファイル全体を選択",
      rangeSelection: "範囲",
      stageFile: "ファイルをステージ",
    ...
    sourceControlOperations: {
      ...
      update: {
        ...
        publishRepository: {
          ...
          originConflictRemediation: "公開前に既存の origin をどう扱うか選択してください。",
          commitRequired: "公開前に保留中の変更をコミットしてください。",
          unsafeUrl: "Happier が安全でないフォローアップ URL をブロックしました。",
          auth: {
            connectedAccountReady: "GitHub 接続の準備ができています。",
            providerCliReady: "gh CLI は認証済みです。",
          },
          remediation: {
            connectGitHub: "GitHub を接続",
            installGh: "gh CLI をインストール",
            useManagedGh: "管理対象の gh CLI を使用",
            authenticateGh: "gh CLI を認証",
            openBrowser: "ブラウザで開く",
          },
          errors: {
...
settingsSession: {
	    sessionList: {
	        ...
	        orderingTitle: 'セッションリストのオプション',
	        orderingSubtitle: 'セッションのグループ化と表示方法を選択します。',
	        orderingOptions: {
	            custom: 'カスタム順',
	            created: '作成日時',
	            updated: '更新日時',
    ...
    messageSending: {
      ...
      sessionCreation: {
        ...
        rememberLastEngineSelectionsTitle: "最後のエンジン選択を記憶",
        rememberLastEngineSelectionsEnabledSubtitle:
          "新しいセッションは、サーバーとエンジンごとに最後のモデル、モード、エンジンオプションを再利用します。",
        rememberLastEngineSelectionsDisabledSubtitle:
          "下書きやショートカットで指定されない限り、新しいセッションはエンジンの既定値から開始します。",
    ...
    renameDescription:
      ...
      replacementRepair: {
        ...
        chooseReplacementSubtitle:
          "このマシンを置き換えたマシンを選択します。",
        pickerTitle: "置き換え先マシンを選択",
        pickerCandidatesTitle: "利用可能なマシン",
