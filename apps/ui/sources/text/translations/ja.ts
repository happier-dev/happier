...
const settingsAppearanceTranslationExtension = {
  themeProfiles: {
    ...
    activeFooter: 'インターフェースで使用されるテーマを選択します。テーマ画面からカスタムテーマを管理します。',
    builtInGroup: '組み込みのテーマ',
    builtInFooter: '組み込みテーマは読み取り専用です。ローカルでカスタマイズするには、1 つを複製します。',
    customGroup: 'カスタムテーマ',
    customFooter: 'テーマをタップしてアクティブにするか、行アクションを使用してテーマを編集、複製、または削除します。',
    defaultTheme: 'デフォルトのテーマ',
    defaultThemeSubtitle: 'カスタム プロファイルなしで Happier テーマ カラーを使用する',
    active: 'アクティブ',
    customProfileSubtitle: 'カスタムローカルテーマプロファイル',
    tapToActivate: 'タップして有効化します',
    actionsGroup: 'テーマアクション',
    createProfile: 'テーマの作成',
    createProfileSubtitle: '任意の組み込みテーマまたはカスタム テーマから開始する',
    importProfile: 'テーマのインポート',
    importProfileSubtitle: 'JSONを貼り付けるか、Happierのテーマプロファイルファイルを選択してください',
    exportProfile: 'テーマのエクスポート',
    exportProfileSubtitle: 'このテーマを JSON としてエクスポートします',
    presetsGroup: '内蔵プリセット',
    presetsFooter: '組み込みプロファイルは読み取り専用です。カスタマイズするには、クローンを作成します。',
    presets: {
    ...
    readOnlyPreset: '読み取り専用プリセット',
    clonePreset: 'プリセットのクローンを作成する',
    cloneProfile: 'プロファイルのクローンを作成する',
    duplicateTheme: 'テーマが重複しています',
    editProfile: 'プロフィールの編集',
    newProfileName: ({ count }: { count: number }) => `カスタムテーマ ${count}`,
    cloneName: ({ name }: { name: string }) => `${name} のコピー`,
    detailsGroup: '詳細',
    presetGroup: 'プリセット',
    presetSource: 'プリセット',
    presetSourceSubtitle: '開始点として使用するテーマを選択します',
    assetAppearance: 'アセットの外観',
    assetAppearanceSubtitle: 'このテーマで明るいアプリ アセットを使用するか暗いアプリ アセットを使用するかを選択します。',
    replacePresetTitle: '現在の色を置き換えますか?',
    replacePresetSubtitle: 'プリセットを変更すると、現在のドラフトカラーが置き換えられます。保存されていないカラー編集は破棄されます。',
    profileName: 'プロファイル名',
    editorModeGroup: 'テーマモード',
    editorModeFooter: 'このテーマは、プリセットによって選択されたカラー モードを編集します。',
    editorMode: 'バリアント',
    lightMode: 'ライト',
    darkMode: '暗い',
    previewTitle: 'テーマのプレビュー',
    previewSubtitle: 'サーフェス、テキスト、コントロール、状態、および構文色のローカル サンドボックス プレビュー。',
    previewButton: '主なアクション',
    previewStatus: '準備完了',
    previewCode: 'const theme = "happier";',
    colorInputPlaceholder: '#RRGGBB, rgba(...), transparent',
    tokenSubtitle: 'パブリック カラー トークン オーバーライド',
    recentColors: '最近の色',
    colorPickerFallback: '色の値を入力するか、最近使用した色を再利用します。',
    invalidColor: 'Use hex, rgb(...), rgba(...), or transparent.',
    invalidProfileName: 'プロファイル名が無効です。',
    profileLimitReached: 'テーマの制限に達しました。',
    contrastWarning: 'このトークン ペアのコントラストは低いです。保存したりリセットしたりすることもできます。',
    resetToken: 'トークンをリセットする',
    resetGroup: 'リセットして無効化する',
    resetMode: 'テーマカラーをリセットする',
    deactivateProfile: 'デフォルトのテーマを使用する',
    ...
    importJson: 'テーマ JSON',
    importJsonPlaceholder: "テーマの JSON をここに貼り付けます",
    importFile: 'ファイルを選択してください',
    importWarnings: ({ count }: { count: number }) => `インポート中に ${count} 件の警告が見つかりました。`,
    importErrors: {
      invalidJson: '貼り付けられたテキストは無効です JSON。',
      unsupportedSchema: 'このテーマ プロファイルのバージョンはサポートされていません。',
      invalidProfile: 'このテーマ プロファイルをインポートできませんでした。',
      tooLarge: 'このテーマ プロファイル JSON は大きすぎます。',
    },
    exportFooter: 'エクスポートされた JSON には、このテーマのすべてのパブリック カラー トークン値が含まれます。',
    exportJson: 'エクスポート JSON',
    copyExportJson: 'コピー JSON',
    downloadExportJson: 'ダウンロード JSON',
    noProfiles: 'カスタムテーマはまだありません',
    groups: {
      background: '背景',
      surface: '表面',
      border: '国境',
...
export const ja = {
    ...
    settingsKeyboard: {
        ...
        setShortcutInvalidTitle: '無効なショートカット',
        ...
        commands: {
            ...
            sessionsRowMoveUp: '選択した行を上に移動します',
            sessionsRowMoveDown: '選択した行を下に移動します',
            sessionsRowMoveToFolder: '選択した行をフォルダーに移動',
            sessionsRowMoveToWorkspaceRoot: '選択した行をワークスペースのルートに移動します',
            sessionsSelectionToggleFocused: '焦点を絞ったセッションを選択してください',
            sessionsSelectionExtendUp: 'セッション選択を上に拡張',
            sessionsSelectionExtendDown: 'セッション選択を下に拡張',
            sessionsSelectionSelectAll: '表示されているセッションをすべて選択します',
            sessionsSelectionClear: 'セッションの選択をクリアする',
            settingsOpen: '設定を開く',
            transcriptSelectionCancel: 'トランスクリプトの選択をキャンセルする',
            transcriptSelectionCopy: '選択したトランスクリプトメッセージをコピーする',
            transcriptSelectionSelectAll: 'すべてのトランスクリプトメッセージを選択します',
            transcriptSelectionSendToSession: '選択したトランスクリプトメッセージをセッションに送信します',
            ...
            splitCanvasFocusDown: "以下のフォーカス分割",
...
localTailscale: {
  ...
  connectedServices: {
    ...
    account: {
      configurationTitle: 'アカウント設定',
      configurationUpdatedTitle: 'アカウント設定を更新しました',
            ...
            claude: {
                ...
                fields: {
                    ...
                    claudeUnifiedTerminalWorkspaceTrust: {
                        title: "ワークスペースの信頼",
                        subtitle: "Claude がワークスペースを信頼するかどうか尋ねたときに、Happier がどのように応答するかを選択します。",
                        options: {
                            ask_every_time: {
                                title: "毎回尋ねる",
                                subtitle: "セッション内で正確なワークスペースの信頼性の質問を表示します。"
                            },
                            always_trust_happier_workspaces: {
                                title: "Happier ワークスペースを常に信頼します",
                                subtitle: "Happier によって開かれたワークスペースについては、現在再取得された Claude プロンプトを信頼してください。"
                            },
                            always_reject_happier_workspaces: {
                                title: "Happier ワークスペースを常に拒否する",
                                subtitle: "Happier によって開かれたワークスペースに対する、現在再取得された Claude プロンプトを拒否します。"
                            }
                        }
                    },
  ...
  errors: {
    ...
    sourceControlUnavailableForSession: "このセッションではソース管理を使用できません。",},
    ...
    forking: {
      ...
      strategy: {
          ...
          unavailable: {
              ...
              nativeProviderBound: "プロバイダーのアカウントに紐づいたセッションは、エージェントが分岐できません。",
  ...
  commandPalette: {
    ...
    noCommandsFound: "コマンドが見つかりません",
        ...
        commands: {
            ...
            sessionFallbackSubtitle: 'セッションに切り替える',
            sessionRequiredTitle: 'セッションが必要です',
            sessionRequiredBody: 'このコマンドでターゲットにできるように、最初にセッションを開きます。',
  ...
  sessionsList: {
    ...
    sessionFallbackLabel: 'セッション',
    moveSheetTitle: ({ item }: { item: string }) => 'Move ' + item,
    moveSheetDestinationLabel: '目的地',
    moveSheetSubmit: '移動',
    moveSheetSearchPlaceholder: 'Search folders...',
    moveSheetEmpty: '利用可能な移動ターゲットがありません',
    moveSheetDestinations: '目的地',
    moveSheetDisabledDescendant: 'それ自体または子フォルダーには移動できません。',
    moveSheetDisabledMaxDepth: 'これはフォルダーの深さの制限を超える可能性があります。',
    moveSheetDisabledCurrent: 'すでにこの場所にあります。',
    moveSheetDisabledUnavailable: 'この宛先は利用できません。',
    dragHandleA11yLabel: 'ハンドルをドラッグします',
    ...
    dragA11yBlockedDescendantCycle: '移動先は移動したフォルダー内です',
    dragA11yBlockedLeafCannotBeParent: 'セッションに他の項目を含めることはできません',
    dragA11yBlockedMaxDepth: 'フォルダーの深さの制限に達しました',
    dragA11yBlockedSamePosition: 'すでにその位置にいる',
    dragA11yBlockedWorkspaceScope: '宛先は別のワークスペースにあります',
    dragA11yBlockedNoTarget: '目的地が選択されていません',
    dragA11yBlockedDirectSession: '直接セッションをフォルダーに移動することはできません',
    dragA11yBlockedFeatureDisabled: 'セッションフォルダーが有効になっていません',
    ...
    selectionCheckboxA11yLabel: 'セッションの選択',
    ...
    stagedChanges: ({ count }: { count: number }) =>
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        sessionMedia: {
          ...
          previewUnavailableA11y: "メディアのプレビューは利用できません",
  ...
  localServices: {
    ...
    publicPreview: {
      ...
      authenticatedMode: 'サインイン済みのアクセス',
      publicMode: 'リンクを知っている全員',
      expiredSubtitle: 'リンクの有効期限切れ',
      expiresInMinutes: ({ count }: { count: number }) => `あと${count}分で期限切れ`,
      expiresInHours: ({ count }: { count: number }) => `あと${count}時間で期限切れ`,
      expiresInDays: ({ count }: { count: number }) => `あと${count}日で期限切れ`,
      modePromptTitle: 'リンクの種類',
      ttlPromptTitle: 'リンクの有効期間',
      ttlPromptMessage: ({ service }: { service: string }) => `「${service}」への公開リンクをどれくらい有効にしますか?`,
      ttlOptionMinutes: ({ count }: { count: number }) => `${count}分`,
      ttlOptionHours: ({ count }: { count: number }) => `${count}時間`,
      ttlOptionDays: ({ count }: { count: number }) => `${count}日`,
  ...
  browserContext: {
    ...
    editor: {
      ...
      attach: '注釈を添付',
      cancel: 'キャンセル',
      captureUnavailable: 'このビューでは注釈のキャプチャを利用できません。',
      selectUnavailable: 'このビューでは要素の選択を利用できません。',
      marked: ({ count }: { count: string }) => `${count} 件をマーク`,
      removeMark: ({ label }: { label: string }) => `${label}を削除`,
      markElement: ({ label }: { label: string }) => `要素 ${label}`,
      markRegion: '範囲',
      markStroke: '描画',
    },
  },
...
settingsSession: {
      ...
      sessionCreation: {
        ...
        wizardPresentationDropdownSubtitle: "完全な選択欄を開くコンパクトな行を表示します。",
          ...
          promptPersonalization: {
              title: '迅速なパーソナライゼーション',
              footer: '新しいエージェント セッションに追加する組み込み命令 Happier を選択します。これにより、エージェントがすでに送信したオプションが非表示になることはありません。',
              askAgentToRenameSessionsTitle: 'セッションタイトルの更新',
              askAgentToRenameSessionsNeverTitle: '決してしない',
              askAgentToRenameSessionsNeverSubtitle: 'エージェントにセッション タイトルの設定を求めないでください。',
              askAgentToRenameSessionsInitialTitle: 'セッション開始時',
              askAgentToRenameSessionsInitialSubtitle: '最初のユーザーメッセージから短いタイトルを設定するようエージェントに促します。',
              askAgentToRenameSessionsOngoingTitle: 'タスクが変わるとき',
              askAgentToRenameSessionsOngoingSubtitle: 'セッションの開始時とタスクが変更されたときに、エージェントにタイトルを設定するよう求めます。',
              askAgentToRenameSessionsInitialSelectedSubtitle: 'エージェントはセッション開始時にタイトルを設定するように求められます。',
              askAgentToRenameSessionsOngoingSelectedSubtitle: 'タスクが変更されると、エージェントはタイトルを更新するように求められます。',
              askAgentToRenameSessionsDisabledSubtitle: 'エージェントはタイトルを設定するように求められません。手動による名前変更は引き続き機能します。',
              askAgentToSuggestReplyOptionsTitle: 'エージェントに返信オプションを提案するよう依頼する',
              askAgentToSuggestReplyOptionsEnabledSubtitle: 'プロンプトでは、必要に応じてクイック返信オプションを提案するようエージェントに求められます。',
              askAgentToSuggestReplyOptionsDisabledSubtitle: 'このプロンプトでは、エージェントにクイック返信オプションを追加するよう求められません。',
          },
      defaultPermissions: {
        title: "デフォルト権限",
        footer:
  ...
  settingsVoice: {
    ...
    realtimeProviders: {
      ...
      ...voiceRealtimeProviderSetupTranslations.ja,
    ...
    externalCredentials: {
      ...voiceExternalCredentialApprovalTranslations.ja,
      apiKeyTitle: "APIキー",
    ...
    local: {
      ...voiceLocalCredentialTranslations.ja,
      title: "ローカル OSS 音声",
      footer:
      ...
      googleCloudTts: {
        ...
        apiKey: {
          machineCredentialRestrictionBody: "保存済みのキーは Android アプリ証明書に制限されているため、選択したマシンでは使用できません。マシンに対応した別の API キーを入力してください。既存の同期値は古いクライアント向けにそのまま維持されます。",
    ...
    privacy: {
      ...
      currentUiContextModeTitle: "現在の UI コンテキスト",
      currentUiContextModeSubtitle:
        "音声が、アクティブな Happier アプリのウィンドウまたはブラウザタブから限定された意味情報を利用できるタイミングを選択します。",
      currentUiContextMode: {
        offTitle: "オフ",
        offSubtitle: "音声は、このクライアントから現在の UI コンテキストもコンテキストに応じたコマンドも受け取りません。",
  ...
  feed: {
   ...
   settingsPlugins: {
    ...
    agentUiDiagnosticsTitle: "エージェントインターフェース診断",
