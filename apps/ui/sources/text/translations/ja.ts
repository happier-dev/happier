...
settingsSession: {
  ...
  setupOnboarding: {
          ...
          relayDiagramThisComputerLabel: 'このMac',
          recommendedBadge: 'おすすめ',
          relayCloudTitle: 'Happier Cloud',
          relayCloudSubtitle: '最も簡単に始められるホスト型Relay',
          relayOnThisMacTitle: 'このMac上で',
          relayOnThisMacSubtitle: 'このMacでRelayをローカルに実行し、スマホアクセス用にTailscaleを追加します',
          relayCustomUrlTitle: '自分のRelay URL',
          ...
          webDesktopOnlyBody: 'このコンピューターをセットアップするにはデスクトップアプリを開いてください。Webアプリは状態を表示できますが、バックグラウンドサービスのインストールや設定はできません。',
	          ...
	          preAuthBody: 'スマホはRelay経由でメッセージを送り、Relayはパソコンへつなぎます。Relayをどこで動かすか選んでください。後から変更できます。',
