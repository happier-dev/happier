...
export const apiTokenSettingsTranslations = {
    ...
    ca: translated({
        settingsApiTokens: {
            ...
            emptyBody: 'Els tokens permeten que els scripts i les eines actuïn com tu. Crea’n un quan una integració necessiti accés al teu compte actual.',
            created: 'Creat',
            lastUsed: 'Últim ús',
    ...
    de: translated({
        settingsApiTokens: {
            ...
            emptyBody: 'Tokens erlauben Skripten und Tools, in deinem Namen zu handeln. Erstelle einen Token, wenn eine Integration Zugriff auf dein aktuelles Konto braucht.',
            created: 'Erstellt',
    ...
    es: translated({
        settingsApiTokens: {
            ...
            emptyBody: 'Los tokens permiten que los scripts y las herramientas actúen como tú. Crea un token cuando una integración necesite acceso a tu Cuenta actual.',
            created: 'Creado',
            lastUsed: 'Último uso',
    ...
    fr: translated({
        settingsApiTokens: {
            ...
            emptyBody: 'Les jetons permettent aux scripts et aux outils d’agir en ton nom. Crée un jeton lorsqu’une intégration a besoin d’accéder à ton compte actuel.',
            created: 'Créé',
    ...
    it: translated({
        settingsApiTokens: {
            ...
            emptyBody: 'I token consentono a script e strumenti di agire per tuo conto. Crea un token quando un’integrazione ha bisogno di accedere al tuo Account attuale.',
            created: 'Creato',
    ...
    ja: translated({
        settingsApiTokens: {
            ...
            emptyBody: 'トークンを使うと、スクリプトやツールがあなたに代わって操作できます。連携が現在のアカウントへのアクセスを必要とするときにトークンを作成してください。',
            created: '作成日',
            lastUsed: '最終使用',
            neverUsed: '未使用',
    ...
    pl: translated({
        settingsApiTokens: {
            ...
            emptyBody: 'Tokeny pozwalają skryptom i narzędziom działać w Twoim imieniu. Utwórz token, gdy integracja potrzebuje dostępu do bieżącego konta.',
            created: 'Utworzono',
    ...
    pt: translated({
        settingsApiTokens: {
            ...
            emptyBody: 'Os tokens permitem que scripts e ferramentas ajam em seu nome. Crie um token quando uma integração precisar de acesso à sua Conta atual.',
            created: 'Criado',
    ...
    ru: translated({
        settingsApiTokens: {
            ...
            emptyBody: 'Токены позволяют скриптам и инструментам действовать от вашего имени. Создайте токен, когда интеграции нужен доступ к текущему аккаунту.',
            created: 'Создан',
    ...
    'zh-Hans': translated({
        settingsApiTokens: {
            ...
            emptyBody: '令牌可让脚本和工具代表你执行操作。当集成需要访问当前帐户时，请创建令牌。',
            created: '创建时间',
            lastUsed: '上次使用',
            neverUsed: '从未使用',
            securityTitle: '安全',
    ...
    'zh-Hant': translated({
        settingsApiTokens: {
            ...
            emptyBody: '權杖可讓指令碼和工具代表你執行操作。當整合需要存取目前帳戶時，請建立權杖。',
            created: '建立時間',
            lastUsed: '上次使用',
            neverUsed: '從未使用',
            securityTitle: '安全性',
