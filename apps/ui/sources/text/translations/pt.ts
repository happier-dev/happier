...
export const pt: TranslationStructure = {
    settingsKeyboard: {
        ...
        entrySubtitle: 'Descubra e controle os atalhos do app',
        generalGroupTitle: 'Controles de teclado',
        generalGroupFooter: 'As preferências de atalhos são salvas localmente neste dispositivo.',
        enableShortcutsTitle: 'Ativar atalhos unificados',
        enableShortcutsSubtitle: 'Use o novo registro de comandos de teclado para os atalhos do app.',
        singleKeyTitle: 'Atalhos de uma tecla',
        singleKeySubtitle: 'Permitir atalhos como ? quando nenhum campo de texto estiver em foco.',
        conflictsTitle: ({ count }: { count: number }) => `${count} conflito${count === 1 ? '' : 's'} de atalho detectado${count === 1 ? '' : 's'}`,
        conflictsSubtitle: ({ count }: { count: number }) => `${count} comando${count === 1 ? ' precisa' : 's precisam'} de revisão antes que todos os atalhos possam ficar ativos.`,
        ...
        noDefaultShortcut: 'Sem atalho padrão',
        ...
        resetCommandAccessibility: ({ command }: { command: string }) => `Redefinir o atalho de ${command}`,
        commands: {
            composerAbortConfirm: 'Confirmar cancelamento',
            ...
            permissionCycle: 'Alternar permissões',
            ...
            transcriptMessageNext: 'Próxima mensagem da transcrição',
            transcriptMessagePrevious: 'Mensagem anterior da transcrição',
            transcriptScrollBottom: 'Rolar transcrição até o fim',
            transcriptScrollPageDown: 'Rolar transcrição uma página para baixo',
            transcriptScrollPageUp: 'Rolar transcrição uma página para cima',
            transcriptScrollTop: 'Rolar transcrição até o início',
        },
    },
  tabs: {
  ...
  settingsAppearance: {
    ...
    settingsNavSidebarDescription:
      "Mostra a barra lateral de configurações nas sessões (web/tablet)",
      ...
      pendingMessages: {
        ...
        badgeLabel: ({ count }: { count: number }) =>
          count > 0 ? `Pendentes (+${count})` : "Pendentes",
	        ...
	        nonSteerableNotice: "O turno atual não pode aceitar steering após esta mudança de modo. Ele será executado em seguida, ou use Enviar agora para interromper.",
	        actions: {
          up: "Para cima",
          down: "Para baixo",
          edit: "Editar",
  ...
  commandPalette: {
    ...
    noCommandsFound: "Nenhum comando encontrado",
        ...
        shortcutsHelpEmpty: 'Nenhum atalho está ativo neste dispositivo.',
  ...
  sessionsList: {
    ...
    deleteFolderPromptDescription: 'As sessões nesta pasta serão movidas para a pasta pai ou para a raiz do espaço de trabalho.',
  },
  ...
  externalSessions: {
    ...
    openInSplitRight: "Abrir na divisão à direita",
    openInSplitDown: "Abrir na divisão abaixo",
  ...
  files: {
    ...
    stagedChanges: ({ count }: { count: number }) =>
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        sessionMedia: {
          ...
          unavailableImageA11y: ({ name }: { name: string }) => `Imagem indisponível: ${name}`,
          previewUnavailableA11y: "Pré-visualização indisponível",
        },
    ...
    fileActions: {
      ...
      selectEntireFileForCommit: "Selecionar arquivo inteiro",
      rangeSelection: "Intervalo",
    ...
    sourceControlOperations: {
      ...
      update: {
        ...
        publishRepository: {
          ...
          originConflictRemediation: "Escolha como lidar com o origin existente antes de publicar.",
          commitRequired: "Faça commit das alterações pendentes antes de publicar.",
          unsafeUrl: "O Happier bloqueou uma URL de acompanhamento insegura.",
          auth: {
            connectedAccountReady: "A conexão do GitHub está pronta.",
            providerCliReady: "gh CLI está autenticado.",
          },
          remediation: {
            connectGitHub: "Conectar GitHub",
            installGh: "Instalar gh CLI",
            useManagedGh: "Usar gh CLI gerenciado",
  ...
  executionRuns: {
    ...
    details: {
      ...
      timestamps: {
        ...
        invalidActionSubtitle: 'Esta ação não está mais disponível nesta compilação.',
...
settingsSession: {
	      sessionList: {
	          ...
	          orderingTitle: 'Opções da lista de sessões',
	          orderingSubtitle: 'Escolha como as sessões são agrupadas e exibidas.',
	          orderingOptions: {
	          ...
	          folderTreeView: 'Árvore de pastas',
      ...
      sessionCreation: {
        ...
        rememberLastEngineSelectionsTitle: "Lembrar as últimas seleções de mecanismo",
        rememberLastEngineSelectionsEnabledSubtitle:
          "Novas sessões reutilizam o último modelo, modo e opções de mecanismo para cada servidor e mecanismo.",
        rememberLastEngineSelectionsDisabledSubtitle:
          "Novas sessões começam com os padrões do mecanismo, exceto quando um rascunho ou atalho fornece seleções.",
    ...
    renameDescription:
      ...
      replacementRepair: {
        ...
        chooseReplacementSubtitle:
          "Escolha a máquina que substituiu esta.",
        pickerTitle: "Escolher máquina substituta",
        pickerCandidatesTitle: "Máquinas disponíveis",
