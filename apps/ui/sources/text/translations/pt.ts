...
const settingsAppearanceTranslationExtension = {
  ...
  settingsNavSidebarDescription: 'Mostrar a barra lateral de navegação de configurações no desktop e tablet',
  mobileWorkspaceExperience: 'Modo de espaço de trabalho móvel',
  mobileWorkspaceExperienceDescription: 'Escolha como sessões e projetos abrem no celular',
...
const settingsSessionHandoffTranslationExtensions = {
  pt: {
    ...
    directTargetMode: {
      ...
      convertToPersistedSubtitle: 'Importe a transcricao e continue como uma sessao gerenciada pelo Happier.',
    },
  },
} as const;
...
export const pt: TranslationStructure = {
  ...
  connect: {
    ...
    restoreWithSecretKeyInstead: "Entrar com chave secreta em vez disso",
  ...
  settings: {
    ...
    machineSetupCurrentMachineTitle: "Configurar este computador",
    ...
    machineSetupRemoteSshKeyFileAuthLabel: "Usar chave privada",
    machineSetupRemoteSshPasswordAuthLabel: "Usar senha",
    machineSetupRemoteSshIdentityFileLabel: "Caminho da chave privada",
    ...
    findings: {
      ...
      serverMismatch: {
        ...
        steps: {
          ...
          switchUiServer: "Mantenha a UI apontando para o servidor que você quer usar e reconecte o serviço em segundo plano para que ele siga esse servidor.",
          restartDaemon: "Reinicie o serviço em segundo plano depois de reconfigurá-lo para o servidor correto e tente novamente.",
        },
      },
  ...
  settingsDesktop: {
    ...
    startOnLoginSubtitle: 'Inicie o Happier automaticamente quando você fizer login neste computador.',
    overlay: {
  ...
  settingsPets: {
    ...
    disabledSubtitle: 'Ative o experimento Mascotes para usar Blink neste dispositivo.',
  ...
  settingsAppearance: {
    ...
    showLineNumbersInDiffs: "Mostrar números de linha nas visualizações de código",
    showLineNumbersInDiffsDescription:
      "Exibir números de linha em diffs, pré-visualizações de arquivos e editores",
    ...
    wrapLinesInDiffsDescription:
      "Quebrar linhas longas em vez de rolagem horizontal em diffs, pré-visualizações de arquivos e editores",
  ...
  settingsFeatures: {
    ...
    voiceSubtitle: "Ativar recursos de voz",
      ...
      expVoiceDaemonInferenceSubtitle:
        "Ativar superfícies locais de TTS/STT neural no daemon (requer Agente de voz)",
  ...
  session: {
    ...
    machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
      ...
      detailsPanel: {
        ...
        emptyHint: "Abra um arquivo, diff ou terminal em outra aba.",
        ...
        closeA11y: "Fechar detalhes",
          ...
          enterFocusModeA11y: 'Entrar no modo foco do painel',
          exitFocusModeA11y: 'Sair do modo foco do painel',
      },
  ...
  files: {
    ...
    agentReportedTurnChanges: ({ count }: { count: number }) =>
      `Último turno reportado pelo agente (${count})`,
    checkpointTurnChanges: ({ count }: { count: number }) =>
      `Último turno do checkpoint (${count})`,
    ...
    agentReportedTurnDescription:
      'Arquivos reportados pelo agente/runtime para o turno concluído mais recente.',
    ...
    checkpointAttributionShared:
      'O conteúdo do checkpoint é exato para o intervalo do repositório. A atribuição é limitada porque este worktree era compartilhado.',
    checkpointAttributionUnknown:
      'O conteúdo do checkpoint é exato para o intervalo do repositório. A atribuição do ator é desconhecida.',
    checkpointUnavailable:
      'A evidência do checkpoint está indisponível para este turno.',
...
settingsSession: {
      sessionList: {
          ...
          orderingTitle: 'Ordenação',
          orderingSubtitle: 'Escolha como as sessões são ordenadas na lista',
          orderingOptions: {
      ...
      sessionCreation: {
          ...
          rememberLastProjectSelectionsEnabledSubtitle: 'Os atalhos do projeto reutilizam a máquina, pasta, motor, modelo e opções da sessão mais recente.',
          rememberLastProjectSelectionsDisabledSubtitle: 'Os atalhos do projeto só preselecionam a máquina e a pasta do projeto.',
      },
      mobileWorkspaceExperience: {
          title: 'Área de trabalho móvel',
          subtitle: 'Escolha o layout padrão da sessão móvel.',
          options: {
              cockpitTitle: 'Painel de controle',
              cockpitSubtitle: 'Use a barra de abas inferior para chat, arquivos, Git, abas e terminal.',
              classicTitle: 'Clássico',
              classicSubtitle: 'Use o layout móvel antigo de tela única.',
          },
      },
      input: {
          title: 'Entrada',
    ...
    local: {
      ...
      kokoro: {
        ...
        assetPack: {
          ...
          subtitleWeb: "Selecione o pacote de modelo do daemon. Kokoro identifica a família do modelo, não um runtime do navegador.",
        },
        model: {
          title: "Modelo Kokoro",
          subtitleNative:
            "Baixe os arquivos necessários para habilitar a síntese no dispositivo.",
          subtitleWeb: "Gerenciado pelo serviço de pacotes de modelo do daemon de voz.",
        },
        modelStatus: {
        ...
        voice: {
          ...
          subtitleWeb: "Escolha a voz do Kokoro enviada ao daemon para as respostas.",
        ...
        web: {
          ...
          clearCache: {
            confirmTitle: "Remover arquivos de modelo do daemon?",
            confirmBody:
              "Isso remove os arquivos baixados do modelo e das vozes do daemon para este pacote.",
          ...
          cache: {
            title: "Arquivos de modelo do daemon",
            subtitle: "Gerencie os arquivos de modelo do daemon baixados para este pacote.",
          },
        },
      },
      localNeuralStt: {
      ...
      ttsProviderSubtitle:
        "Escolha TTS do dispositivo, um endpoint compatível com OpenAI ou TTS neural local com daemon",
      daemonInference: {
        execution: {
