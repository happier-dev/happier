...
settingsSession: {
  ...
  setupOnboarding: {
          ...
          recommendedBadge: 'Recomendado',
	          ...
	          relayOnRemoteComputerTitle: 'Em um computador remoto',
          ...
          webDesktopOnlyDesktopAppTitle: 'Ou obtenha o app de desktop',
          webDesktopOnlyDesktopAppSubtitle: 'Instale o Happier neste computador para hospedar um Relay e configurar o serviço em segundo plano.',
          ...
          webDesktopOnlySetupCommandTitle: 'Configurar este computador',
	    ...
	    currentRelayTitle: 'Relay atual',
	    selectedRelayFooterLabel: 'Relay atual',
	    selectedRelayFooterLine: ({ relay }: { relay: string }) => `Relay ativo: ${relay}`,
