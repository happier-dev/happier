...
export const en = {
    ...
    automations: {
        ...
        list: {
            ...
            moreTriggers: ({ count }: { count: number }) => `+${count} more`,
        ...
        form: {
            ...
            confirm: {
                ...
                observationSocket: 'Events arrive through the provider’s own live connection. Gaps between sessions are not replayed.',
            ...
            trigger: {
                ...
                observationSocket: 'Live connection',
        ...
        detail: {
            ...
            event: {
                ...
                transportSocket: 'Live connection',
                ...
                disclosureSocket: 'Events arrive through the provider’s own live connection. Gaps between sessions are not replayed.',
    ...
    voiceAssistant: {
        ...
        dictationErrors: {
            ...
            transcriptionCredentialsRequired: 'Dictation needs credentials for the selected speech provider. Review its setup, then try again.',
            transcriptionMachineUnavailable: 'The Dictation machine or local speech model is unavailable. Reconnect or review the selected model, then try again.',
            transcriptionTransferFailed: 'Happier could not send the recording to the Dictation machine. Check the connection, then try again.',
            transcriptionFailed: 'The selected speech provider could not transcribe this recording. Try again or review its setup.',
    ...
    localServices: {
        ...
        publicPreview: {
            ...
            authenticatedMode: 'Signed-in access',
            publicMode: 'Anyone with the link',
            expiredSubtitle: 'Link expired',
            expiresInMinutes: ({ count }: { count: number }) => `Expires in ${count}m`,
            expiresInHours: ({ count }: { count: number }) => `Expires in ${count}h`,
            expiresInDays: ({ count }: { count: number }) => `Expires in ${count}d`,
            modePromptTitle: 'Link type',
            ttlPromptTitle: 'Link lifetime',
            ttlPromptMessage: ({ service }: { service: string }) => `How long should the public link to "${service}" stay valid?`,
            ttlOptionMinutes: ({ count }: { count: number }) => `${count} minutes`,
            ttlOptionHours: ({ count }: { count: number }) => `${count} hours`,
            ttlOptionDays: ({ count }: { count: number }) => `${count} days`,
...
settingsSession: {
    ...
    settingsVoice: {
        ...
        history: {
            ...
            loadOlderSubtitle: 'Read-only: decrypt the previous page of Voice History on this device.',
    ...
    settingsAccount: {
        ...
        history: {
            ...
            footer: 'Restores your account preferences from a saved snapshot. Application data, secrets, and credentials stay at their current values.',
            loading: 'Loading history…',
            empty: 'No saved snapshots yet',
            unavailable: 'History is unavailable',
            entryTitle: ({ version }: { version: string }) => `Restore version ${version}`,
            entrySubtitle: ({ recordedAt }: { recordedAt: string }) => `Saved ${recordedAt}`,
            restoreConfirmTitle: 'Restore settings?',
            restoreConfirmBody: 'Your account preferences will be replaced with the values from the selected snapshot.',
            restoreConfirmAction: 'Restore',
            restoredTitle: 'Settings restored',
            restoredBody: 'Your account preferences were restored from the selected snapshot.',
            unchangedBody: 'Your current account preferences already match the selected snapshot.',
            conflictTitle: 'Settings changed',
            conflictBody: ({ currentVersion }: { currentVersion: string }) => `Settings changed while restoring (current version ${currentVersion}). Nothing was written — review the current settings and try again.`,
            outcomeUnknownBody: 'The restore may or may not have completed. Review the current settings before retrying.',
            invalidBody: 'The selected snapshot cannot be restored safely. Nothing was written.',
            unavailableBody: 'The selected snapshot could not be restored. Nothing was written.',
        },
    ...
    machine: {
        ...
        actions: {
            ...
            removeMachineConfirmBody: 'This will revoke access from this machine (including access keys and automation assignments). Dependent Automations pause, waiting Runs that can no longer execute are cancelled, and possibly-started Runs are marked Outcome uncertain. You can reconnect later by signing in again from the CLI.',
        ...
        replacementRepair: {
            ...
            confirmBody: ({ machine }: { machine: string }) => `Future launches and old sessions for this machine will use ${machine}. Dependent Automations pause, waiting Runs that can no longer execute are cancelled, and possibly-started Runs are marked Outcome uncertain.`,
