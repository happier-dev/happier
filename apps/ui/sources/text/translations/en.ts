...
export const en = {
    ...
    settingsPlugins: {
      ...
      subtitle: "Browse curated plugin descriptors without executing them in the UI.",
...
settingsSession: {
    ...
    setupOnboarding: {
        ...
        preAuthContinueHint: 'When you continue, Happier will take you back to sign in against the selected server and then return here to finish setup.',
        currentRelayTitle: 'Current server',
        selectedRelayFooterLabel: 'Current server',
        selectedRelayFooterLine: ({ relay }: { relay: string }) => `Active server: ${relay}`,
        currentRelayDescription: ({ relayUrl }: { relayUrl: string }) => `Active server: ${relayUrl}`,
        ...
        continueToAuth: 'Continue with selected server',
        continueWithLocalRelayAction: 'Continue with this local Relay',
        confirmSwitchRelayTitle: 'Switch to this server?',
        confirmSwitchRelaySubtitle: 'This will make the selected server active on this device.',
        confirmSwitchRelayKeepTitle: 'Keep current server',
        confirmSwitchRelayKeepSubtitle: 'Continue without switching servers right now',
        confirmSwitchRelaySwitchTitle: 'Switch to this server',
        confirmSwitchRelaySwitchSubtitle: 'You may need to sign in again on the new server',
        confirmSwitchRelayWarning: 'You can change your server later in Settings → Server.',
        postAuthTitle: 'Finish setting up this computer',
        postAuthBody: 'You are signed in. Continue with the local setup flow to make this computer ready for the selected server.',
        ...
        thisComputerStages: {
            ...
            registerComputerSubtitle: 'Connect this computer to your account on the selected server.',
        ...
        resumeIntentBody: 'Sign in or create an account to continue setting up this computer for the selected server.',
