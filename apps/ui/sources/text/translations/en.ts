...
export const en = {
    ...
    connect: {
        ...
        restoreWithSecretKeyInstead: 'Login with secret key instead',
    ...
    settings: {
        ...
        remoteHostsSetupAsMachineTitle: 'Set up as Happier machine',
        remoteHostsSetupAsMachineFailed: 'Could not set up this host as a Happier machine.',
        ...
        remoteHostsSshTunnelStopTitle: 'Stop local SSH tunnel',
        remoteHostsUseAsRelayHostTitle: 'Use as relay host',
        remoteHostsUseAsRelayHostSubtitle: 'Configure relay access on this SSH host.',
        remoteHostsConfigureAccessTitle: 'Configure access',
        remoteHostsConfigureAccessSubtitle: 'Choose how this remote host is reachable.',
        remoteHostsOpenDetailsTitle: 'Host details',
        remoteHostsRelayAccessGroupTitle: 'Remote access',
        remoteHostsRelayAccessActiveTitle: ({ host }: { host: string }) => `Configuring access for ${host}`,
        remoteHostsRelayAccessActiveSubtitle: 'Relay access commands run on the remote host over SSH. This does not create an SSH tunnel.',
        remoteHostsMissingServerUrl: 'Select a server before setting up a remote machine.',
        remoteHostsRelayAccessIdentityFileRequired: 'Relay access on this host requires a local SSH identity file.',
        ...
        remoteHostsReplaceHostKeyAction: 'Replace host key',
        remoteHostsHostKeyCurrentFingerprintLabel: 'Current trusted fingerprint',
        ...
        sshConfiguredHostPickerSubtitle: 'Prefill from your local SSH config or known_hosts.',
        sshConfiguredHostPickerRefreshingSubtitle: 'Refreshing suggestions; showing the last results.',
        sshConfiguredHostPickerSourceSshConfig: 'SSH config',
        sshConfiguredHostPickerSourceKnownHosts: 'known_hosts',
        sshConfiguredHostPickerUnsupportedTitle: 'Enter SSH details manually',
        sshConfiguredHostPickerUnsupportedSubtitle: 'Local SSH discovery is only available from the desktop app.',
        sshConfiguredHostPickerLoadingTitle: 'Finding SSH hosts…',
        sshConfiguredHostPickerLoadingSubtitle: 'Checking local SSH config and known_hosts through the desktop bridge.',
        sshConfiguredHostPickerEmptyTitle: 'No suggested SSH hosts',
        sshConfiguredHostPickerEmptySubtitle: 'Enter the SSH details manually or refresh after updating your SSH config.',
        sshConfiguredHostPickerErrorTitle: 'Could not load SSH suggestions',
        sshConfiguredHostPickerRefreshTitle: 'Refresh SSH suggestions',
        sshConfiguredHostPickerRefreshingTitle: 'Refreshing SSH suggestions',
        features: 'Features',
        social: 'Social',
        account: 'Account',
    ...
    diagnosis: {
        ...
        findings: {
            ...
            serverMismatch: {
                title: 'Server mismatch (app vs background service)',
                ...
                steps: {
                    ...
                    switchUiServer: 'Reconnect the background service so it targets the same server as the app.',
                    restartDaemon: 'Restart the background service after reconnecting it, then retry.',
                },
            },
            ...
            accountMismatch: {
                ...
                subtitle: ({ ui, machine }: { ui: string; machine: string }) => `App: ${ui} • Background service: ${machine}`,
                steps: {
                    signInSameAccount: 'Make sure the app and background service are signed in to the same account on the same server.',
                    cliReauth: 'In CLI: sign out, then authenticate again for the correct server.',
                },
            },
    ...
    connectedServices: {
        ...
        detail: {
            ...
            connectPersonalAccessTokenSubtitle: 'Paste a fine-grained personal access token',
            connectApiTokenTitle: 'Connect API token',
            connectApiTokenSubtitle: 'Paste a provider API token or app password',
            openTokenSetupTitle: 'Open token setup',
            openTokenSetupSubtitle: 'Open the provider setup page',
            openPersonalAccessTokenSetupTitle: 'Create personal access token',
            openPersonalAccessTokenSetupSubtitle: 'Open GitHub fine-grained token setup',
            ...
            prompts: {
                ...
                personalAccessTokenBody: 'Paste your fine-grained GitHub personal access token.',
                personalAccessTokenPlaceholder: 'github_pat_…',
                apiTokenTitle: 'API token',
                apiTokenBody: 'Paste your provider API token or app password.',
    ...
    settingsSourceControl: {
        ...
        remoteConfirmation: {
            ...
            confirmBeforePulling: {
                title: 'Confirm before pulling',
                subtitle: 'Ask before downloading and merging remote changes.',
            },
            confirmBeforePushing: {
                title: 'Confirm before pushing',
                subtitle: 'Ask before uploading local commits to the remote.',
            },
            options: {
                always: {
    ...
    settingsPets: {
        ...
        disabledSubtitle: 'Enable the Pets experiment to use Blink on this device.',
    ...
    settingsNotifications: {
        activitySurfaces: {
            ...
            liveActivities: {
                ...
                remoteUpdates: {
                    ...
                    footer: 'Selected-server diagnostics for updating Live Activities after the app is no longer foregrounded.',
                    effectiveModeTitle: 'Effective delivery',
                    effectiveMode: {
                        hosted_happier_relay: 'Hosted relay',
                        direct_apns: 'Direct APNs',
                        background_wake_best_effort: 'Background wake',
                        local_only: 'Local runtime only',
                        disabled: 'Disabled',
                    },
                    details: {
                        available: 'Available',
                        ...
                        selected: 'Selected',
                        fallback: 'Fallback',
                        preferred_unavailable: 'Local only',
                        local_only: 'Local only',
                        disabled: 'Disabled',
                        runtimeOnly: 'Runtime only',
                    },
                    hostedRelayTitle: 'Hosted Happier relay',
                    hostedRelayAvailableSubtitle: 'Hosted relay is configured for this selected server.',
                    hostedRelayDisabledSubtitle: 'Hosted relay is disabled for this self-hosted server.',
                    hostedRelayBlockedSubtitle: 'Hosted relay identity and provider support are not implemented yet.',
                    hostedRelayUnavailableSubtitle: 'Hosted relay is not available from this selected server.',
                    directApnsTitle: 'Direct APNs',
                    directApnsConfiguredSubtitle: 'Direct APNs credentials are configured without exposing credential material.',
                    directApnsMissingCredentialsSubtitle: 'Direct APNs is missing server-side credential configuration.',
                    directApnsUnavailableSubtitle: 'Direct APNs is unavailable for this selected server.',
                    backgroundWakeTitle: 'Background wake',
                    backgroundWakeBestEffortSubtitle: 'Background wake can try to refresh, but iOS may defer or drop it.',
                    backgroundWakeDisabledSubtitle: 'Background wake fallback is disabled on this selected server.',
                    localOnlyTitle: 'Local-only updates',
                    localOnlyRuntimeSubtitle: 'Local-only updates work while the app runtime can execute; they do not promise killed-app updates.',
                },
            },
            widgets: {
        ...
        quietHours: {
            title: 'Quiet hours',
            footer: 'Account quiet hours apply everywhere by default. Device overrides only affect this device.',
            accountOffTitle: 'No account quiet hours',
            accountOffSubtitle: 'Deliver account notifications at any time',
            accountNightlyTitle: 'Every night, 10 PM to 7 AM',
            accountNightlySubtitle: 'Silence or suppress attention channels during the night',
            deviceAccountTitle: 'This device follows account hours',
            deviceAccountSubtitle: 'Use the synced account quiet-hours policy',
            deviceDisabledTitle: 'Disable quiet hours on this device',
            deviceDisabledSubtitle: 'Let this device deliver even while account quiet hours are active',
            deviceCustomNightlyTitle: 'This device uses nightly quiet hours',
            deviceCustomNightlySubtitle: 'Override account hours with 10 PM to 7 AM on this device',
        },
        sounds: {
            title: 'Sounds',
            footer: 'Account sound defaults sync everywhere. This device can mute local sounds.',
            accountHappierTitle: 'Happier sounds',
            accountHappierSubtitle: 'Use a softer tone for updates and a brighter tone when attention is needed',
            accountDefaultTitle: 'System default',
            accountDefaultSubtitle: 'Use the platform notification sound',
            accountSilentTitle: 'Silent',
            accountSilentSubtitle: 'Deliver notifications without sound',
            deviceEnabledTitle: 'Play sounds on this device',
            deviceEnabledSubtitle: 'Device override for local notification sounds',
            previewTitle: 'Preview sound',
            previewSubtitle: 'Send a local preview notification on this device',
            previewNotificationTitle: 'Notification sound preview',
            previewNotificationBody: 'This is how the current notification sound will behave.',
        },
        push: {
        ...
        foregroundBehavior: {
            ...
            accountDescription: 'Use the account-level in-app notification behavior on this device',
            full: 'Full',
    ...
    settingsFeatures: {
        ...
        expLiveActivitiesSubtitle: 'Enable iOS Live Activities and Dynamic Island surfaces',
        expHomeScreenWidgets: 'Home screen widgets',
        expHomeScreenWidgetsSubtitle: 'Enable iOS home screen widget surfaces',
        voice: 'Voice',
        ...
        expVoiceDaemonInference: 'Daemon voice inference',
        expVoiceDaemonInferenceSubtitle: 'Enable daemon-local neural TTS/STT surfaces (requires Voice agent)',
    ...
    session: {
        ...
        detailsPanel: {
            ...
            emptyHint: 'Open a file, diff, or terminal from another tab.',
    ...
    server: {
        ...
        relayDrift: {
            bannerDifferentRelayTitle: 'Your background service is connected to a different server',
            ...
            bannerNeedsAuthTitle: 'Your background service needs to sign in to this server',
            ...
            bannerNotConfiguredTitle: 'Your background service is not connected to this server yet',
            ...
            bannerNotInstalledTitle: 'Your background service is not installed for this server',
            ...
            repairAction: 'Reconnect background service to this server',
            progressTitle: 'Connecting background service to this server',
            progressStepPrepare: 'Prepare background service',
            progressStepConfigureRelay: 'Update server connection',
    ...
    tools: {
        ...
        files: {
            ...
            agentReportedTurnChanges: ({ count }: { count: number }) => `Agent-reported last turn (${count})`,
            checkpointTurnChanges: ({ count }: { count: number }) => `Checkpoint last turn (${count})`,
            ...
            agentReportedTurnDescription: 'Files reported by the agent/runtime for the most recent completed turn.',
            ...
            checkpointAttributionShared: 'Checkpoint content is exact for the repository interval. Attribution is limited because this worktree was shared.',
            checkpointAttributionUnknown: 'Checkpoint content is exact for the repository interval. Actor attribution is unknown.',
            checkpointUnavailable: 'Checkpoint evidence is unavailable for this turn.',
...
settingsSession: {
          sessionList: {
              ...
              orderingSubtitle: 'Choose how sessions are ordered in the list',
              orderingOptions: {
                  custom: 'Custom',
                  created: 'Created',
                  updated: 'Updated',
          ...
          mobileWorkspaceExperience: {
              ...
              subtitle: 'Choose the default mobile session layout.',
              options: {
                  cockpitTitle: 'Cockpit',
                  cockpitSubtitle: 'Use the bottom tab bar for chat, files, source control, tabs, and terminal.',
                  classicTitle: 'Classic',
                  classicSubtitle: 'Use the older single-screen mobile session layout.',
              },
          },
          input: {
              title: 'Input',
        ...
        subAgentGuidanceEntry: {
          ...
          handoff: {
              ...
              directTargetMode: {
                  ...
                  convertToPersistedSubtitle: 'Import the transcript and continue as a Happier-managed session.',
              },
          },
          ...
          defaultStorage: {
              ...
              footer: 'Choose whether new sessions start as Happier-managed sessions or direct provider-backed sessions.',
              globalTitle: 'Global default',
              persistedSubtitle: 'Store new sessions in Happier and keep them available across your devices by default.',
        ...
        local: {
            ...
            kokoro: {
                ...
                assetPack: {
                    ...
                    subtitleWeb: 'Select the daemon model pack. Kokoro identifies the model family, not a browser runtime.',
                },
                model: {
                    title: 'Kokoro model',
                    subtitleNative: 'Download required files to enable on-device synthesis.',
                    subtitleWeb: 'Managed by the voice-home daemon model-pack service.',
                },
                modelStatus: {
                ...
                voice: {
                    ...
                    subtitleWeb: 'Choose the Kokoro voice sent to the daemon for replies.',
                ...
                web: {
                    ...
                    clearCache: {
                        confirmTitle: 'Clear daemon model files?',
                        confirmBody: 'This removes downloaded daemon model and voice files for this pack.',
                        confirmButton: 'Clear',
                    },
                    cacheDetail: {
                    ...
                    cache: {
                        title: 'Daemon model files',
                        subtitle: 'Manage downloaded daemon model files for this pack.',
                    },
                },
            },
            localNeuralStt: {
            ...
            ttsProviderSubtitle: 'Choose device TTS, an OpenAI-compatible endpoint, or daemon-backed local neural TTS',
    ...
    defaultStorage: {
      title: 'Default session storage',
      footer: 'Overrides the account-level default Happier/direct session mode for new sessions when this profile is selected.',
      accountDefaultSubtitle: ({ label }: { label: string }) => `Account default: ${label}`,
      useAccountDefault: 'Use account default',
      currently: ({ label }: { label: string }) => `Currently: ${label}`,
    },
