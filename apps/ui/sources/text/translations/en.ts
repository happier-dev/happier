...
export const en = {
    ...
    settingsProviders: {
        ...
        entrySubtitle: 'Configure provider-specific options',
        footer: 'Configure provider-specific options. These settings may affect session behavior.',
        providerSubtitle: 'Provider-specific settings',
    ...
    settingsFeatures: {
        ...
        expGitOperationsSubtitle: 'Enable experimental Git write operations (stage/commit/push/pull). Read-only file browsing is stable.',
    ...
    server: {
        ...
        cannotRenameOfficial: 'The official server cannot be renamed.',
        renameServer: 'Rename server',
        renameServerPrompt: 'Enter a new name for this server.',
        serverNamePlaceholder: 'Server name',
        cannotRemoveOfficial: 'The official server cannot be removed.',
    ...
    settingsVoice: {
        ...
        local: {
            ...
            conversationModeSubtitle: 'Direct-to-session, or mediator with explicit commit',
            mediatorBackend: 'Mediator backend',
            ...
            mediatorAgentSource: 'Mediator agent source',
            ...
            mediatorAgentIdSubtitle: 'Which agent backend to use for the mediator (when not using session)',
            mediatorPermissionPolicy: 'Mediator permissions',
            mediatorPermissionPolicySubtitle: 'Restrict tool usage while mediating',
            mediatorPermissionReadOnly: 'Read-only',
            mediatorPermissionNoTools: 'No tools',
            mediatorVerbosity: 'Mediator verbosity',
            mediatorVerbositySubtitle: 'How verbose the mediator should be',
            mediatorVerbosityShort: 'Short',
            mediatorVerbosityBalanced: 'Balanced',
            mediatorIdleTtl: 'Mediator idle TTL',
            mediatorIdleTtlSubtitle: 'Auto-stop mediator after inactivity (60–3600s)',
            mediatorIdleTtlTitle: 'Mediator idle TTL (seconds)',
            ...
            mediatorChatModelSource: 'Mediator chat model source',
            ...
            mediatorCommitModelSource: 'Mediator commit model source',
