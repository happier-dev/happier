...
settingsSession: {
  ...
  settingsVoice: {
    history: {
      ...
      exportSubtitle: 'Carica la cronologia rimanente entro i limiti e salvala come JSON.',
    ...
    setupCheck: {
      ...
      footer: 'Il controllo legge solo le impostazioni salvate e i dati locali di preparazione. Non apre il microfono, non avvia la Voce, non invia audio e non contatta il provider.',
      check: 'Controlla configurazione',
    ...
    realtimeProviders: {
      codex: {
        ...
        privacyDisclosure: "L'audio e la conversazione Codex Live vengono inviati da questo dispositivo a OpenAI tramite WebRTC. La sessione Codex selezionata viene eseguita sulla macchina selezionata. OpenAI può ricevere un contesto di avvio e di sessione limitato e i risultati Codex delegati, così la conversazione può continuare e le risposte possono essere pronunciate. Il server e il relay di Happier non trasportano l'audio Codex Live; il daemon/app-server di Happier gestisce comunque segnalazione, ciclo di vita della sessione, delega, strumenti e controllo delle autorizzazioni. Possono intervenire relay di rete gestiti dal provider.",
      },
    },
    ui: {
  ...
  terminalEmbedded: {
    ...
    settings: {
      ...
      rendererAutoDescription: "Usa il renderer accessibile xterm.js a meno che il renderer nativo non sia completamente idoneo.",
      ...
      rendererNativeExperimental: "Nativo (sperimentale)",
      rendererNativeExperimentalDescription: "Preferisci Ghostty su iOS o Termux su Android quando tutti i gate nativi sono superati.",
    },
    quickKeys: {
      esc: "ESC",
      tab: "TAB",
  ...
  feed: {
    ...
    pluginChangeConfirmBody: ({ action, name }: { action: string; name: string }) => `Conferma «${action}» per ${name}.`,
