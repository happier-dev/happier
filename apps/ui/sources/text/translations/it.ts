...
const settingsSessionHandoffTranslationExtensions = {
  it: {
    ...
    directTargetMode: {
      ...
      convertToPersistedSubtitle: 'Importa la trascrizione e continua come sessione gestita da Happier.',
    },
  },
} as const;
...
export const it: TranslationStructure = {
  ...
  connect: {
    ...
    restoreWithSecretKeyInstead: "Accedi con chiave segreta invece",
  ...
  settings: {
    ...
    machineSetupCurrentMachineTitle: "Configura questo computer",
    ...
    machineSetupRemoteSshKeyFileAuthLabel: "Usa chiave privata",
    machineSetupRemoteSshPasswordAuthLabel: "Usa password",
    machineSetupRemoteSshIdentityFileLabel: "Percorso della chiave privata",
    ...
    localTailscale: {
      ...
      openInstallAction: 'Apri download di Tailscale',
      openLoginAction: 'Apri accesso a Tailscale',
    ...
    findings: {
      ...
      serverMismatch: {
        ...
        steps: {
          ...
          switchUiServer: "Mantieni la UI puntata al server che vuoi usare, poi ricollega il servizio in background in modo che segua quel server.",
          restartDaemon: "Riavvia il servizio in background dopo averlo riconfigurato per il server corretto, poi riprova.",
        },
      },
  ...
  settingsPets: {
    ...
    disabledSubtitle: 'Attiva l’esperimento Mascotte per usare Blink su questo dispositivo.',
  ...
  settingsAppearance: {
    ...
    showLineNumbersInDiffs: "Mostra numeri di riga nelle viste codice",
    showLineNumbersInDiffsDescription:
      "Mostra i numeri di riga nei diff, nelle anteprime file e negli editor",
    ...
    wrapLinesInDiffs: "A capo nelle viste codice",
    wrapLinesInDiffsDescription:
      "A capo delle righe lunghe invece dello scorrimento orizzontale nei diff, nelle anteprime file e negli editor",
    ...
    machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
      ...
      machineOfflineCannotResume:
        ...
        detailsPanel: {
          ...
          emptyHint: "Apri un file, un diff o un terminale da un'altra scheda.",
...
settingsSession: {
      sessionList: {
          ...
          orderingTitle: 'Ordinamento',
          orderingSubtitle: 'Scegli come ordinare le sessioni nell’elenco',
          orderingOptions: {
              custom: 'Personalizzato',
              created: 'Creato',
              updated: 'Aggiornato',
      ...
      mobileWorkspaceExperience: {
          ...
          options: {
              ...
              cockpitSubtitle: 'Usa la barra delle schede in basso per chat, file, Git, schede e terminale.',
              classicTitle: 'Classico',
              classicSubtitle: 'Usa il layout mobile precedente a schermata singola.',
          },
      },
      input: {
          title: 'Immissione',
  ...
  changelog: {
    ...
    onboardingShowcase: {
      ...
      subtitle: "Sessioni di programmazione che ti seguono ovunque.",
      cards: {
        welcome: {
          title: "Pensato per il ritmo",
        ...
        cockpit: {
            title: "Il tuo centro di comando mobile",
            body: "Una vista mobile concentrata per agenti attivi, con accesso in un tocco a chat, file, Git, terminale e dettagli.",
            alt: "Immagine astratta segnaposto del centro di comando.",
        ...
        reviewComments: {
            title: "Rivedi e correggi codice facilmente",
            body: "Lascia commenti su righe precise di file o diff, scegli cosa includere e invia contesto strutturato a un agente.",
            alt: "Immagine astratta segnaposto per commenti di review.",
        ...
        sourceControl: {
            ...
            alt: "Immagine astratta segnaposto per source control.",
        ...
        pets: {
            ...
            alt: "Immagine astratta segnaposto del compagno pet.",
  ...
  setupOnboarding: {
          ...
          relayDiagramPhoneLabel: 'Telefono',
          relayDiagramRelayLabel: 'Relè',
          relayDiagramThisComputerLabel: 'Questo computer',
          ...
          webDesktopOnlyRelayInstallTitle: 'Ospita un Relay su questo computer',
	          webDesktopOnlyRelayInstallSubtitle: 'Questo installa e avvia l’host del Relay. Poi incolla qui l’URL del Relay mostrato.',
