...
settingsSession: {
  ...
  setupOnboarding: {
          ...
          recommendedBadge: 'Consigliato',
	          ...
	          relayOnRemoteComputerTitle: 'Su un computer remoto',
          ...
          webDesktopOnlyDesktopAppTitle: 'Oppure scarica l’app desktop',
          webDesktopOnlyDesktopAppSubtitle: 'Installa Happier su questo computer per ospitare un Relay e configurare il servizio in background.',
          ...
          webDesktopOnlySetupCommandTitle: 'Configura questo computer',
	    ...
	    currentRelayTitle: 'Relay attivo',
	    selectedRelayFooterLabel: 'Relay attivo',
	    selectedRelayFooterLine: ({ relay }: { relay: string }) => `Relay attivo: ${relay}`,
