...
export const it: TranslationStructure = {
    settingsKeyboard: {
        ...
        entrySubtitle: 'Scopri e controlla le scorciatoie dell\'app',
        generalGroupTitle: 'Controlli da tastiera',
        generalGroupFooter: 'Le preferenze delle scorciatoie sono salvate localmente su questo dispositivo.',
        enableShortcutsTitle: 'Abilita scorciatoie unificate',
        enableShortcutsSubtitle: 'Usa il nuovo registro dei comandi da tastiera per le scorciatoie dell\'app.',
        singleKeyTitle: 'Scorciatoie a tasto singolo',
        singleKeySubtitle: 'Consenti scorciatoie come ? quando nessun input di testo è attivo.',
        conflictsTitle: ({ count }: { count: number }) => `${count} conflitto${count === 1 ? '' : 'i'} di scorciatoia rilevato${count === 1 ? '' : 'i'}`,
        conflictsSubtitle: ({ count }: { count: number }) => `${count} comando${count === 1 ? ' richiede' : 'i richiedono'} revisione prima che tutte le scorciatoie possano essere attive.`,
        ...
        resetCommandAccessibility: ({ command }: { command: string }) => `Reimposta la scorciatoia di ${command}`,
        commands: {
            composerAbortConfirm: 'Conferma interruzione',
            composerFocus: 'Metti a fuoco il compositore',
            composerSendImmediate: 'Invia subito',
            commandPaletteOpen: 'Apri tavolozza comandi',
            modeCycle: 'Cambia modalità',
            permissionCycle: 'Cambia permessi',
            shortcutsHelpOpen: 'Apri guida alle scorciatoie',
            ...
            transcriptMessageNext: 'Messaggio successivo della trascrizione',
            transcriptMessagePrevious: 'Messaggio precedente della trascrizione',
            transcriptScrollBottom: 'Scorri la trascrizione in fondo',
            transcriptScrollPageDown: 'Scorri la trascrizione di una pagina giù',
            transcriptScrollPageUp: 'Scorri la trascrizione di una pagina su',
            transcriptScrollTop: 'Scorri la trascrizione in alto',
        },
    },
  tabs: {
  ...
  settingsAppearance: {
    ...
    settingsNavSidebarDescription:
      "Mostra la barra laterale delle impostazioni nelle sessioni (web/tablet)",
        ...
        pendingMessages: {
          ...
          badgeLabel: ({ count }: { count: number }) =>
            count > 0 ? `In sospeso (+${count})` : "In sospeso",
	          ...
	          nonSteerableNotice: "Il turno corrente non può accettare steering dopo questo cambio di modalità. Verrà eseguito dopo, oppure usa Invia ora per interrompere.",
	          actions: {
            up: "Su",
            down: "Giù",
          edit: "Modifica",
  ...
  commandPalette: {
    ...
    noCommandsFound: "Nessun comando trovato",
        ...
        shortcutsHelpCommandPalette: 'Apri tavolozza comandi',
        shortcutsHelpHelp: 'Apri scorciatoie da tastiera',
  ...
  sessionsList: {
    ...
    deleteFolderPromptTitle: 'Eliminare cartella?',
    deleteFolderPromptDescription: 'Le sessioni in questa cartella verranno spostate nella cartella padre o nella radice dell’area di lavoro.',
  },
  ...
  externalSessions: {
    ...
    openInSplitRight: "Apri nella divisione a destra",
    openInSplitDown: "Apri nella divisione in basso",
    revealInCurrentSplit: "Mostra nella divisione corrente",
  ...
  files: {
    ...
    fileEditor: {
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        sessionMedia: {
          ...
          unavailableImageA11y: ({ name }: { name: string }) => `Immagine non disponibile: ${name}`,
          previewUnavailableA11y: "Anteprima non disponibile",
        },
    ...
    fileActions: {
      ...
      selectEntireFileForCommit: "Seleziona l'intero file",
      rangeSelection: "Intervallo",
    ...
    sourceControlOperations: {
      ...
      update: {
        ...
        publishRepository: {
          ...
          originConflictRemediation: "Scegli come gestire l'origin esistente prima della pubblicazione.",
          commitRequired: "Esegui il commit delle modifiche in sospeso prima di pubblicare.",
          unsafeUrl: "Happier ha bloccato un URL di follow-up non sicuro.",
          auth: {
            connectedAccountReady: "La connessione GitHub è pronta.",
            providerCliReady: "gh CLI è autenticato.",
          },
          remediation: {
            connectGitHub: "Connetti GitHub",
            installGh: "Installa gh CLI",
            useManagedGh: "Usa gh CLI gestito",
            authenticateGh: "Autentica gh CLI",
...
settingsSession: {
	      sessionList: {
	          ...
	          orderingTitle: 'Opzioni elenco sessioni',
	          orderingSubtitle: 'Scegli come raggruppare e mostrare le sessioni.',
	          orderingOptions: {
	          ...
	          folderTreeView: 'Albero delle cartelle',
      ...
      sessionCreation: {
        ...
        rememberLastEngineSelectionsTitle: "Ricorda le ultime selezioni del motore",
        rememberLastEngineSelectionsEnabledSubtitle:
          "Le nuove sessioni riutilizzano l’ultimo modello, modalità e opzioni del motore per ogni server e motore.",
        rememberLastEngineSelectionsDisabledSubtitle:
          "Le nuove sessioni partono dai valori predefiniti del motore salvo selezioni fornite da una bozza o scorciatoia.",
  ...
  review: {
    ...
    renameDescription:
      ...
      replacementRepair: {
        ...
        chooseReplacementSubtitle:
          "Scegli la macchina che ha sostituito questa.",
        pickerTitle: "Scegli macchina sostitutiva",
        pickerCandidatesTitle: "Macchine disponibili",
        confirmTitle: "Segnare la macchina come sostituita?",
        confirmBody: ({ machine }: { machine: string }) =>
          `I futuri avvii e le vecchie sessioni di questa macchina useranno ${machine}.`,
        ...
        undoConfirmBody:
          "Questa macchina apparirà di nuovo come destinazione di avvio se è disponibile.",
        undoAction: "Annulla",
