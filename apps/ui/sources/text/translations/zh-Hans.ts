...
export const zhHans: TranslationStructure = {
    settingsKeyboard: {
        title: '键盘快捷键',
        entrySubtitle: '查看并控制应用快捷键',
        generalGroupTitle: '键盘控制',
        generalGroupFooter: '快捷键偏好设置会保存在此设备本地。',
        enableShortcutsTitle: '启用统一快捷键',
        enableShortcutsSubtitle: '使用新的键盘命令注册表管理应用快捷键。',
        singleKeyTitle: '单键快捷键',
        singleKeySubtitle: '当文本输入未聚焦时，允许使用 ? 等快捷键。',
        conflictsTitle: ({ count }: { count: number }) => `检测到 ${count} 个快捷键冲突`,
        conflictsSubtitle: ({ count }: { count: number }) => `需要检查 ${count} 个命令后，才能启用所有快捷键。`,
        ...
        commands: {
            ...
            settingsOpen: '打开设置',
            transcriptMessageNext: '下一条转录消息',
            transcriptMessagePrevious: '上一条转录消息',
            transcriptScrollBottom: '滚动转录到底部',
            transcriptScrollPageDown: '转录向下滚动一页',
            transcriptScrollPageUp: '转录向上滚动一页',
            transcriptScrollTop: '滚动转录到顶部',
        },
    },
  tabs: {
  ...
  settingsAppearance: {
    ...
    settingsNavSidebarDescription: "在会话中显示设置侧边栏（Web/平板）",
      ...
      pendingMessages: {
        ...
        badgeLabel: ({ count }: { count: number }) =>
          count > 0 ? `待发送 (+${count})` : "待发送",
	        ...
	        nonSteerableNotice: "当前回合在此次模式变更后无法接受 steering。它会在下一轮运行，或使用立即发送来中断。",
	        actions: {
          up: "上移",
          down: "下移",
          edit: "编辑",
  ...
  sessionsList: {
    ...
    addFolder: '添加文件夹',
    newFolderDefaultName: '文件夹',
    folderNamePlaceholder: '文件夹名称',
    workspaceRoot: '工作区根目录',
    moveToFolder: '移动到文件夹',
    failedToMoveSessionToFolder: '无法将会话移动到该文件夹。',
    ...
    deleteFolderPromptDescription: '此文件夹中的会话将移至父文件夹或工作区根目录。',
  },
  ...
  files: {
    ...
    stagedChanges: ({ count }: { count: number }) => `已暂存的更改 (${count})`,
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        sessionMedia: {
          ...
          unavailableImageA11y: ({ name }: { name: string }) => `图片不可用：${name}`,
          previewUnavailableA11y: "预览不可用",
        },
    ...
    fileActions: {
      ...
      selectEntireFileForCommit: "选择整个文件",
      rangeSelection: "范围",
      stageFile: "暂存文件",
    ...
    sourceControlOperations: {
      ...
      update: {
        ...
        publishRepository: {
          ...
          originConflictRemediation: "发布前请选择如何处理现有 origin。",
          commitRequired: "发布前请先提交待处理更改。",
          unsafeUrl: "Happier 已阻止不安全的后续 URL。",
          auth: {
            connectedAccountReady: "GitHub 连接已就绪。",
            providerCliReady: "gh CLI 已通过身份验证。",
          },
          remediation: {
            connectGitHub: "连接 GitHub",
            installGh: "安装 gh CLI",
            useManagedGh: "使用托管 gh CLI",
            authenticateGh: "验证 gh CLI",
            openBrowser: "在浏览器中打开",
          },
          errors: {
  ...
  executionRuns: {
    ...
    details: {
      ...
      settingsActions: {
        ...
        detailSearchPlaceholder: "搜索表面",
        noResults: "没有操作匹配你当前的搜索。",
        noTargetsMatch: "没有表面匹配当前搜索。",
        noDescription: "暂时没有可用说明。",
        requireApproval: "需要批准",
        invalidActionTitle: "未找到操作",
        invalidActionSubtitle: "此操作在当前版本中不再可用。",
...
settingsSession: {
	    sessionList: {
	        ...
	        orderingTitle: '会话列表选项',
	        orderingSubtitle: '选择会话的分组和显示方式。',
	        orderingOptions: {
	            custom: '自定义顺序',
	            created: '创建时间',
	            updated: '更新时间',
    ...
    sessionCreation: {
      ...
      rememberLastProjectSelectionsDisabledSubtitle:
        "项目快捷方式只预选项目机器和文件夹。",
      rememberLastEngineSelectionsTitle: "记住上次引擎选择",
      rememberLastEngineSelectionsEnabledSubtitle:
        "新会话会按服务器和引擎复用上次的模型、模式和引擎选项。",
      rememberLastEngineSelectionsDisabledSubtitle:
        "除非草稿或快捷方式提供选择，否则新会话会从引擎默认值开始。",
  ...
  review: {
    ...
    renameDescription: "为此设备设置自定义名称。留空则使用默认主机名。",
      ...
      replacementRepair: {
        ...
        chooseReplacementSubtitle: "选择替换此设备的设备。",
        pickerTitle: "选择替换设备",
        pickerCandidatesTitle: "可用设备",
        confirmTitle: "将设备标记为已替换？",
        confirmBody: ({ machine }: { machine: string }) =>
          `此设备未来的启动和旧会话将使用 ${machine}。`,
        confirmAction: "替换",
        undo: "撤销替换",
