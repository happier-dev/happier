...
export const zhHans: TranslationStructure = {
  ...
  connect: {
    ...
    restoreWithSecretKeyInstead: "改用密钥登录",
  ...
  settings: {
    ...
    addMachine: "添加设备",
    machineSetupCurrentMachineTitle: "设置这台电脑",
    ...
    machineSetupRemoteSshKeyFileAuthLabel: "使用私钥",
    machineSetupRemoteSshPasswordAuthLabel: "使用密码",
    machineSetupRemoteSshIdentityFileLabel: "私钥路径",
    ...
    localRelayRuntime: {
      ...
      statusNotInstalled: '此电脑尚未安装',
      statusStopped: '已安装，但当前未运行',
      statusRunningHealthy: '正在运行并正常响应',
  ...
  settingsProviders: {
    ...
    setup: {
        selectionFooter: '选择一个或多个提供方，然后在所选机器上逐个完成设置。',
        startTitle: '设置提供方',
        startDescription: '将所选提供方加入队列，并在一个统一的流程中完成安装和登录。',
        queueTitle: '提供方设置队列',
        queueDescription: ({ provider }: { provider: string }) => `Finish ${provider}, then continue to the next provider in the queue.`,
        activeDescription: '设置队列中的当前提供方',
        activeStatus: '进行中',
        completedStatus: '已完成',
        skippedStatus: '已跳过',
        skipAction: '跳过此提供方',
        completedTitle: '提供方设置完成',
        completedDescription: '你已完成所选提供方队列。',
    },
    cliSourcePreference: {
      title: "CLI 来源偏好",
  ...
  settingsAppearance: {
    ...
    mobileWorkspaceExperience: "移动工作区模式",
    mobileWorkspaceExperienceDescription: "选择在手机上打开会话和项目的方式",
  ...
  settingsFeatures: {
    ...
    expLiveActivitiesSubtitle: "启用 iOS 的 Live Activities 和 Dynamic Island 表面",
    expHomeScreenWidgets: "主屏幕小组件",
    expHomeScreenWidgetsSubtitle: "启用 iOS 主屏幕小组件表面",
    voice: "语音",
    voiceSubtitle: "启用语音功能",
    expVoiceAgent: "语音代理",
    expVoiceAgentSubtitle: "启用基于守护进程的语音代理界面（需要执行运行）",
    expVoiceDaemonInference: "守护进程语音推理",
    expVoiceDaemonInferenceSubtitle: "启用守护进程本地神经 TTS/STT 界面（需要语音代理）",
    ...
    local: {
      ...
      kokoro: {
        ...
        assetPack: {
          ...
          subtitleWeb: "选择 daemon 模型包。Kokoro 表示模型家族，不是浏览器运行时。",
        },
        model: {
          title: "Kokoro 模型",
          subtitleNative: "下载所需文件以启用设备端合成。",
          subtitleWeb: "由语音主页 daemon 的模型包服务管理。",
        },
        modelStatus: {
          downloading: "下载中…",
        ...
        voice: {
          ...
          titleWeb: "Kokoro 语音",
          subtitleWeb: "选择发送给 daemon 用于回复的 Kokoro 语音。",
        ...
        web: {
          warmingUp: "预热中…",
          clearCache: {
            confirmTitle: "移除 daemon 模型文件？",
            confirmBody:
              "这会移除此包已下载的 daemon 模型和语音文件。",
            confirmButton: "清除",
          },
          cacheDetail: {
            modelFiles: "模型文件",
      ...
      ttsProvider: "TTS 提供方",
      ttsProviderSubtitle:
        "选择设备 TTS、OpenAI 兼容端点或 daemon 支持的本地神经 TTS",
      daemonInference: {
        execution: {
          title: "本地神经执行",
