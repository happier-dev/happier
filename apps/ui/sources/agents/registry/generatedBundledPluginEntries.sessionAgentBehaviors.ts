...
export type BundledSessionAgentBehaviorDescriptor = Readonly<{
    agentId: CanonicalAgentId;
    descriptor: Readonly<Record<string, unknown>>;
}>;

export const BUNDLED_CANONICAL_AGENT_SESSION_BEHAVIOR_DESCRIPTORS: Readonly<
    Partial<Record<CanonicalAgentId, BundledSessionAgentBehaviorDescriptor>>
> = Object.freeze({
...
export const BUNDLED_CANONICAL_AGENT_SESSION_BEHAVIORS: Readonly<
