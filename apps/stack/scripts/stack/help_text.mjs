const STACK_HELP_USAGE_LINES = [
  ...
  'hstack stack install <name> [--repo=default|dev|<owner/...>|<path>] [--port=NNN] [--desktop=install|build|none] [--no-desktop] [--service=user|system|none] [--runtime-mode=require|prefer] [--force-rebuild] [--no-restart] [--dry-run] [--json]',
