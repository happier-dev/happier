...
test('ensureServerLightSchemaReady builds source server internal workspace dependencies before migration', async (t) => {
  ...
  await writeFile(
    ...
    [
      ...
      "  fs.writeFileSync(path.join(process.cwd(), 'dist', 'index.js'), 'export const ok = true;\\n', 'utf-8');",
      "  fs.writeFileSync(path.join(process.cwd(), 'dist', 'index.d.ts'), 'export declare const ok: boolean;\\n', 'utf-8');",
