...
import ns_comparison from '../i18n/generated/slices/ru/comparison.json';
import ns_faq from '../i18n/generated/slices/ru/faq.json';
import ns_features from '../i18n/generated/slices/ru/features.json';
import ns_navigation from '../i18n/generated/slices/ru/navigation.json';
import ns_pageProse from '../i18n/generated/slices/ru/pageProse.json';
import ns_providers from '../i18n/generated/slices/ru/providers.json';


// Registered here, not discovered by a glob: this entry is the only place
// that knows the page is ru, which keeps the other nine locales out of
...
registerOverlay('ru', Object.assign({}, ns_comparison, ns_faq, ns_features, ns_navigation, ns_pageProse, ns_providers));
