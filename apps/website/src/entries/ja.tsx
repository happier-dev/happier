...
import ns_comparison from '../i18n/generated/slices/ja/comparison.json';
import ns_faq from '../i18n/generated/slices/ja/faq.json';
import ns_features from '../i18n/generated/slices/ja/features.json';
import ns_navigation from '../i18n/generated/slices/ja/navigation.json';
import ns_pageProse from '../i18n/generated/slices/ja/pageProse.json';
import ns_providers from '../i18n/generated/slices/ja/providers.json';


// Registered here, not discovered by a glob: this entry is the only place
// that knows the page is ja, which keeps the other nine locales out of
...
registerOverlay('ja', Object.assign({}, ns_comparison, ns_faq, ns_features, ns_navigation, ns_pageProse, ns_providers));
