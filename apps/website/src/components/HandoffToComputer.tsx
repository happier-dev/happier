...
export function HandoffToComputer() {
    ...
    return (
        ...
        >
            <p className="text-[15px] font-semibold leading-[1.35]" style={{ color: 'var(--fg)' }}>
                Happier runs where your code runs.
            </p>
            <p className="mt-1.5 text-[13.5px] leading-[1.55]" style={{ color: 'var(--muted)' }}>
                Start on the computer with your repos on it — then this phone becomes a
                screen for it. Send yourself the one-line setup command.
            </p>
