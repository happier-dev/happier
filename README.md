...
<h1 align="center">
  Mobile and Web Client for Claude Code, Codex, Gemini, OpenCode, Augment Code, Kimi, Qwen Code
</h1>

<h4 align="center">
Use Claude Code, Codex, Gemini, OpenCode, Augment Code, Kimi, Qwen Code from anywhere with end-to-end encryption.
</h4>
...
- **Session Sharing:** friends + public share links
- **Agents:** centralized agent catalog (app + CLI)
- **OpenCode**, **Auggie** (Augment Code), **Kimi**, **Qwen Code** support
...
```
npx --yes happy-stacks@latest setup --profile=selfhost --happy-repo=leeroybrun/happier
```
