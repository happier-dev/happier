...
export const it: TranslationStructure = {
    ...
    settingsAppearance: {
        ...
        showDiffsInToolViews: 'Mostra diff nelle viste strumenti',
        showDiffsInToolViewsDescription: 'Mostra i diff dentro le schede risultato degli strumenti (Modifica/Scrivi/Diff)',
    ...
    newSession: {
        ...
        resume: {
            title: 'Riprendi',
            subtitleClaude: 'Riprendi da un ID sessione Claude esistente',
            subtitleCodex: 'Riprendi da un ID sessione Codex esistente',
            placeholderClaude: 'Incolla ID sessione Claude…',
            placeholderCodex: 'Incolla ID sessione Codex…',
            paste: 'Incolla',
            clear: 'Cancella',
            rowPrefix: 'Riprendi:',
            rowNone: 'Riprendi sessione (opzionale)',
            pickerTitle: 'Riprendi sessione',
            save: 'Fatto',
            clearAndRemove: 'Cancella ripresa',
            helpText: 'Copia un ID di sessione precedente per continuare la conversazione. Puoi trovare gli ID sessione nelle informazioni della sessione.',
        },
    },
    ...
    sessionInfo: {
        ...
        copyClaudeResumeCommand: 'Copia comando di ripresa Claude',
        copyCodexResumeCommand: 'Copia comando di ripresa Codex',
        resumeCommandCopied: 'Comando di ripresa copiato negli appunti',
        failedToCopyResumeCommand: 'Impossibile copiare il comando di ripresa',
        ...
        renameSessionSubtitle: 'Cambia il nome visualizzato per questa sessione',
    ...
    tools: {
        ...
        diffHidden: 'La visualizzazione dei diff è disabilitata nelle impostazioni',
