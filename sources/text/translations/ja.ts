...
export const ja: TranslationStructure = {
    ...
    settingsAppearance: {
        ...
        showDiffsInToolViews: 'ツールビューで差分を表示',
        showDiffsInToolViewsDescription: 'ツール結果カード内に差分を表示（編集/書き込み/差分ビュー）',
    ...
    newSession: {
        ...
        resume: {
            title: '再開',
            subtitleClaude: '既存の Claude セッションID から再開',
            subtitleCodex: '既存の Codex セッションID から再開',
            placeholderClaude: 'Claude セッションIDを貼り付け…',
            placeholderCodex: 'Codex セッションIDを貼り付け…',
            paste: '貼り付け',
            clear: 'クリア',
            rowPrefix: '再開:',
            rowNone: 'セッションを再開（任意）',
            ...
            save: '完了',
            clearAndRemove: '再開をクリア',
            helpText: '過去のセッションIDをコピーして会話を続けられます。セッションIDはセッション情報画面で確認できます。',
        },
    },
    ...
    sessionInfo: {
        ...
        copyClaudeResumeCommand: 'Claude 再開コマンドをコピー',
        copyCodexResumeCommand: 'Codex 再開コマンドをコピー',
        resumeCommandCopied: '再開コマンドをコピーしました',
        failedToCopyResumeCommand: '再開コマンドのコピーに失敗しました',
        ...
        renameSessionSubtitle: 'このセッションの表示名を変更',
