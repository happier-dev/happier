...
Before adopting a contribution or service family, read `node_modules/@happier-dev/plugin-sdk/capability-matrix.json`. It is the sole availability authority: a `deferred` row is conformance-only reference material, not a supported product lifecycle.
