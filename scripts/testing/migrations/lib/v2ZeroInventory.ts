...
export const V2_ZERO_INVENTORY_CATEGORY_SPECS: readonly V2ZeroInventoryCategorySpec[] = Object.freeze([
  createCategorySpec({
    ...
    matchAnyOf: [
      ...
      { filePathIncludes: 'apps/cli/src/extensions/registry/createResolvedContributionRegistry.ts' },
      { filePathIncludes: 'apps/cli/src/extensions/registry/resolveBuiltInContributions.ts' },
      { filePathIncludes: 'apps/cli/src/extensions/registry/resolvePluginContributions.ts' },
  ...
  createCategorySpec({
    ...
    matchAnyOf: [
      ...
      { filePathIncludes: 'packages/protocol/src/extensions/hookEventEnvelopeV1.ts' },
      { filePathIncludes: 'packages/protocol/src/extensions/hookRegistrationV1.ts' },
      { filePathIncludes: 'apps/cli/src/extensions/hooks/execution/dispatchPluginHookEvent.ts' },
      { filePathIncludes: 'apps/cli/src/extensions/runtime/resolvePluginHookHandlerRegistry.ts' },
      { filePathIncludes: 'apps/cli/src/extensions/runtime/resolveExecutablePluginRuntimeRegistry.ts' },
      { filePathIncludes: 'apps/cli/src/extensions/plugins/manifest/validatePluginManifest.ts' },
  ...
  createCategorySpec({
    ...
    matchAnyOf: [
      ...
      { filePathIncludes: 'apps/cli/src/extensions/registry/types.ts' },
      { filePathIncludes: 'apps/cli/src/extensions/registry/createResolvedContributionRegistry.ts' },
      { filePathIncludes: 'apps/ui/sources/agents/registry/registryCore.ts' },
      { filePathIncludes: 'apps/ui/sources/agents/registry/registryUiBehavior.ts' },
      { filePathIncludes: 'apps/ui/sources/agents/providers/registry/providerSettingsRegistry.ts' },
  ...
  createCategorySpec({
    ...
    matchAnyOf: [
      ...
      { filePathIncludes: 'packages/agents/src/sessionControls/agentRuntimeDescriptor.ts' },
      { filePathIncludes: 'packages/agents/src/sessionControls/runtimeDescriptorTypes.ts' },
      { filePathIncludes: 'packages/agents/src/sessionControls/providerSessionBackends.ts' },
  ...
  createCategorySpec({
    ...
    matchAnyOf: [
      { filePathIncludes: 'apps/cli/src/extensions/plugins/manifest/' },
      { filePathIncludes: 'apps/cli/src/extensions/plugins/install/' },
      { filePathIncludes: 'apps/cli/src/extensions/plugins/loader/' },
      { filePathIncludes: 'apps/cli/src/extensions/plugins/catalog/' },
      { filePathIncludes: 'apps/cli/src/extensions/plugins/store/' },
      { filePathIncludes: 'apps/cli/src/extensions/plugins/' },
      { filePathIncludes: 'apps/cli/src/extensions/runtime/' },
      { filePathIncludes: 'apps/cli/src/extensions/registry/' },
      { filePathIncludes: 'apps/cli/src/extensions/hooks/' },
    ],
  }),
  createCategorySpec({
    ...
    matchAnyOf: [
      ...
      { filePathIncludes: 'apps/cli/src/extensions/registry/resolveBuiltInContributions.ts' },
      { filePathIncludes: 'apps/cli/src/extensions/registry/resolvePluginContributions.ts' },
      { filePathIncludes: 'packages/protocol/src/extensions/backendDefinitionV1.ts' },
      { filePathIncludes: 'packages/protocol/src/extensions/contractsV1.test.ts' },
