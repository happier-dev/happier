...
const profile = normalizeMobileReleaseProfile(requestedProfile);
if (!profile) fail(`Unknown Expo submit profile: ${requestedProfile || '<empty>'}`);
...
const appEnvironment = resolveMobileAppEnvironmentConfig(environment);
const appJson = {
  expo: {
