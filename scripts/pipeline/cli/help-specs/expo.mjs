...
export const COMMAND_HELP_EXPO = {
  'ui-mobile-release': {
    ...
    options: [
      ...
      '--testflight-distribution-mode <inline|deferred> (default: inline). Deferred leaves Apple processing/group attachment to the canonical recovery workflow.',
    ...
    bullets: [
      ...
      'Hosted release workflows defer that external distribution step so Apple processing does not hold the release critical path; the existing TestFlight recovery workflow reconciles the exact submitted build.',
