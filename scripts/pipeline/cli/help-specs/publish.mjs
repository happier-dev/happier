...
export const COMMAND_HELP_PUBLISH = {
  'publish-cli-binaries': {
    ...
    options: [
      ...
      '--prepared-artifacts             Publish the complete native matrix already staged in the CLI artifacts directory.',
      '--resolve-version-only           Resolve the exact rolling version without building or publishing.',
      '--github-output <path>            Write the resolved version for a GitHub Actions matrix handoff.',
