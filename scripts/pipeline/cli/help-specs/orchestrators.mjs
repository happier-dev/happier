...
export const COMMAND_HELP_ORCHESTRATORS = {
  ...
  release: {
    ...
    bullets: [
      ...
      'Materialize and commit CHANGELOG and version changes before resolving the exact source SHA; hosted dispatch never mutates versions.',
      ...
      'Use --dry-run first; then dispatch the same exact candidate.',
    ],
    examples: [
      ...
      'node scripts/pipeline/run.mjs release --confirm "release dev to preview" --repository happier-dev/happier --deploy-environment preview --operation-id <operation-id> --release-notes-id <release-id> --source-sha <approved-candidate-sha>',
      'node scripts/pipeline/run.mjs release --confirm "release dev to preview" --repository happier-dev/happier --deploy-environment preview --operation-id <operation-id> --release-notes-id <release-id> --source-sha <approved-candidate-sha> --resume-run-id <completed-run-id>',
    ],
  },
